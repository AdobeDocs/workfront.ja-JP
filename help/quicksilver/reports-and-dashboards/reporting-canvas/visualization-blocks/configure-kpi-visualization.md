---
title: レポートキャンバスでの KPI のビジュアライゼーションの設定
description: レポートキャンバスでの KPI のビジュアライゼーションの設定
hidefromtoc: true
hide: true
...
# レポートキャンバスでの KPI のビジュアライゼーションの設定
...
1. まず、[レポートキャンバスでのビジュアライゼーションブロックの追加または編集](../../../reports-and-dashboards/reporting-canvas/visualization-blocks/add-or-edit-report-visualization.md)の説明に従って、**KPI** ビジュアライゼーションタイプを持つビジュアライゼーションブロックをレポートに追加します。
