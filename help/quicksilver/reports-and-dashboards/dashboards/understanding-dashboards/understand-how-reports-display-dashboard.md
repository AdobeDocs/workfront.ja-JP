...
ダッシュボードに追加されたレポートの表示方法を管理できます。 ダッシュボードの作成または編集中に、レポートをダッシュボードに配置できる領域を指定する7つのレイアウトオプションのいずれかを選択できます。 ダッシュボードのレイアウトの選択肢は慎重に検討してください。AI アシスタントなどの特定のパネルや列が多すぎると、使用可能な表示スペースに影響を与え、ダッシュボードを表示しにくくなる可能性があります。
...
特定のレイアウトオプションには、デフォルトで表示されるレポート列の数を制限するレポート配置エリアがあります。 [!UICONTROL **列設定**]&#x200B;の&#x200B;[!UICONTROL **詳細オプション**]&#x200B;をクリックして、レポートを作成または編集する際に、ダッシュボードのこれらの領域に表示するレポート列を手動で選択できます。 ダッシュボードにレポートのすべての列を表示する場合は、レポートの各列に対してを指定するか、すべてのレポート列をデフォルトで表示する領域にレポートを配置します。
