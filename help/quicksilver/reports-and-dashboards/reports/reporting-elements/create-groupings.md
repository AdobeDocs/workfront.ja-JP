...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>フィルター、ビュー、グループへのアクセスを編集</p> <p>レポート、ダッシュボード、カレンダーへのアクセスを編集して、レポートのグループ化を作成します</p>
   </td> 
  </tr> 
  <tr> 
...
1. [**グループ化のプレビュー**]領域で、[**グループ化の追加**]をクリックして、レポートの情報をどのように整理するかを定義します。 レポート内のグループ化の表示についてプレビューを次に示します。
