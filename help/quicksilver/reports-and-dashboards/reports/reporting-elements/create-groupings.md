...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>フィルター、ビュー、グループへのアクセスを編集</p> <p>レポート、ダッシュボード、カレンダーへのアクセス権を編集して、レポートにグループ化を作成する</p>
   </td> 
  </tr> 
  <tr> 
...
1. **+新しいグループ化**&#x200B;をクリックします。
グループ化ローンチを作成するためのインターフェイスビルダー。

1. **グループ化プレビュー**&#x200B;領域で、**グループ化を追加**&#x200B;をクリックして、レポート内の情報の整理方法を定義します。 レポート内のグループ化の表示についてプレビューを次に示します。
