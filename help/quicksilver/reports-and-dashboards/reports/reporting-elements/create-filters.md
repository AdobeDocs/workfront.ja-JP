 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 
    ...
    <p>「標準」または「プラン」を選択してレポートのフィルタを変更します。</p>
   </td>
  </tr> 
  <tr> 
...
1. **フィルター**&#x200B;のアイコン![フィルターアイコン](assets/filter-nwepng.png)をクリックし、**その他**&#x200B;のアイコン![その他のアイコン](assets/more-icon.png)をクリックしてから、**[レガシーフィルターに戻る]**&#x200B;をクリックします。
...
1. フィルターの一覧の上部にある&#x200B;**+新規フィルター**&#x200B;をクリックします。
