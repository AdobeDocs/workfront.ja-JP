...
<table style="table-layout:auto">
    ...
    <tr>
        ...
        <td>アジャイル手法を使用してプロジェクトを管理するには、プロジェクトの「タスク」セクションのタスクのリストまたはプロジェクトの「イシュー」セクションのイシューのリストにボードビューを適用できます。 詳しくは、<a href="/help/quicksilver/manage-work/projects/manage-projects/manage-projects-in-agile-view.md">掲示板ビューでのアジャイルプロジェクトの管理</a>を参照してください。</td>
    </tr>
    <tr>
...
<tr>
        ...
        <td>拡張ビューは、拡張リストに基づいています。 これらはWorkfrontの一部の地域で利用できます。 これらのリストは、リスト項目を表示するための表形式を使用し、標準的なビューやリストとは異なるルックアンドフィールを備えています。 ビューの管理も強化され、フィルタリング、グループ化、列の管理、検索が行われます。 詳しくは、<a href="/help/quicksilver/workfront-basics/navigate-workfront/use-lists/enhanced-lists.md">拡張リストの使用</a>を参照してください</td>
       </tr>    
</table>
