...
1. 次のフィルターリストを確認します。
   ...
   <td>他のユーザーが作成して自分と共有したフィルター、またはシステム全体で共有されているフィルター。
   <p><b>メモ</b></p>
   <p>コントリビューター、依頼者、または外部ライセンスを持つユーザーは、システム全体で共有されているフィルター、ビュー、またはグループを表示できません。 オーディエンスが利用できるようにするには、システム全体の可視性に頼るのではなく、ユーザー、役職、チーム、グループ、企業を通じて、オーディエンスと直接コンテンツを共有する必要があります。 これは、フィルター、ビュー、またはグループ化がレイアウトテンプレートに含まれている場合でも適用されます。</p>
...
1. 誰と共有するかに応じて、以下のいずれかの操作を完了します。
   ...
   **個々のユーザー、チーム、役割、グループ、または会社と共有するには：**&#x200B;指定されたフィールドで、共有するユーザー、チーム、役割、グループ、会社、またはビジネスプロファイルの名前を入力し始め、ドロップダウンリストに表示される名前をクリックします。\
