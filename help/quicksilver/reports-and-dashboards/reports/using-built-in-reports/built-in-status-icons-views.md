...
* 費用は請求可能または払い戻し可能
* タスクがクリティカルパス上にある
* ユーザーが会社やチームに所属している、または個人として別のタイムゾーンに位置している
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td>プロジェクトの条件が目標上（緑）、トラブル中（赤）、またはリスク中（黄色）であることを示します。<br> プロジェクトの条件について詳しくは、<a href="../../../manage-work/projects/manage-projects/project-condition-and-condition-type.md" class="MCXref xref"> プロジェクトの条件と条件タイプの概要</a>を参照してください。</td> 
   <td>プロジェクト</td> 
