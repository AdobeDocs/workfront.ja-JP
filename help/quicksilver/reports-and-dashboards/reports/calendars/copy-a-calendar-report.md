...
## 実稼動環境でのカレンダーレポートのコピー

1. コピーするカレンダーに移動します。
1. **[!UICONTROL カレンダー]** ツールバーの **[!UICONTROL カレンダーアクション]** をクリックし、ドロップダウンリストから **[!UICONTROL コピー]** を選択します。
カレンダーのコピーが開きます。

   ![カレンダーレポートをコピー](assets/copy-calendar-report.png)
...
1. （オプション） **詳細** メニューをクリックしてから **編集** をクリックして、カレンダーの名前を変更します。
