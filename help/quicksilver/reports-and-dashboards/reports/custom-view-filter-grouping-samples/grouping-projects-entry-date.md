...
title: 'グループ化：プロジェクト — 入力日別'
description: このカスタムプロジェクトグループでは、入口日の値でグループ化されたプロジェクトを表示できます。
...
このカスタムプロジェクトグループでは、入口日の値でグループ化されたプロジェクトを表示できます。

各グループは、次の範囲の入力日を持つプロジェクトを表示します。
