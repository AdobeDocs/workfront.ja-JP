...
title: レポート：タスクとイシューの組み合わせ表示とグループ化
...
この作業項目レポートには、ユーザーが1つのレポートで作業を承認したタスクとイシューの両方が表示されます。 これは、カスタムグループ化と組み合わせる場合に最適です。
...
>[!TIP]
>
>  作業項目ビューには、割り当てられたユーザーが受け入れたタスクとイシューのみが表示されます。 このレポートには、作業リクエストまたはチームリクエスト リストからユーザーの作業中リストに移動されていない作業項目は表示されません。
...
1. **列プレビュー**&#x200B;領域で、表示されている列のヘッダーのみをクリックします。 これは&#x200B;**Ext Ref**&#x200B;列です。
...
1. （オプションおよび条件付き）グループ化を追加する場合は、**テキストモードに切り替え**&#x200B;をクリックします。
