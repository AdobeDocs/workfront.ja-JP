...
title: レポート：タスクと懸案事項のビューとグループ化の組み合わせ
...
この作業項目レポートは、ユーザーが1つのレポートで作業を承認したタスクと懸案事項の両方を表示します。 これは、カスタムグループ化と組み合わせる場合に最適です。
...
>[!TIP]
>
>  作業項目ビューには、割り当てられたユーザーによって承認されたタスクと懸案事項のみが表示されます。 このレポートには、[作業要求]リストまたは[チーム要求]リストからユーザーの[作業中]リストに移動されていない作業項目は表示されません。
...
1. 右上隅の&#x200B;**メインメニュー**&#x200B;アイコン![メインメニューアイコン](assets/main-menu-icon.png)をクリックするか、左上隅の&#x200B;**メインメニュー**&#x200B;アイコン![メインメニューの線](assets/lines-main-menu.png)をクリックします（利用可能な場合）。**レポート**&#x200B;をクリックします。

1. ドロップダウンメニューから&#x200B;**新しいレポート** > **その他** > **作業項目**&#x200B;をクリックします。

1. [**列のプレビュー**]エリアで、表示されている唯一の列のヘッダーをクリックします。 これは&#x200B;**Ext Ref**&#x200B;列です。
1. 「**テキスト モードに切り替える**」をクリックします。
1. テキストモード領域にマウスを合わせ、**テキストモードの編集**&#x200B;をクリックします。
...
1. （オプションおよび条件付き）グループを追加する場合は、**[テキストモードに切り替え]**&#x200B;をクリックします。
...
1. 「**保存して閉じる**」をクリックします。
1. （オプション）レポートの名前を更新し、[**適用**]をクリックします。
