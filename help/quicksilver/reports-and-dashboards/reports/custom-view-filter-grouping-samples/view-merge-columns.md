...
1. オブジェクトのリストに移動します。
1. **表示**&#x200B;ドロップダウンから、表示を選択し、**編集**&#x200B;アイコン![編集アイコン](assets/edit-icon.png)をクリックして表示を編集します。
1. 結合する最初の列に移動し、**[テキストモードに切り替え]** > **[テキストモードの編集]**&#x200B;をクリックします。
1. 結合する最初の列に次のテキストを追加します。
   ...
   **例：**&#x200B;次は、リストの2番目の列から始まる、3つの個別の列を含むマージされた列のテキストモードコードです。 マージされた値はプロジェクト名、計画開始日、およびプロジェクト所有者名であり、3つの値の間に区切りはありません。
...
1. **テキストモードに切り替え** > **テキストモードの編集**&#x200B;をクリックし、手順1で追加した中央の列に次のコードを追加します。
...
1. 最初の列をクリックして、**テキストモードに切り替え** > **テキストモードを編集**&#x200B;をクリックし、次のテキストを列に追加します。
   ...
   **例：**&#x200B;次は、プロジェクト名、計画開始日、およびプロジェクト所有者の名前を改行で含む共有列のテキストモードコードです。 共有列は、プロジェクトビューの 2 番目の列です。
   ...
   ![改行付きの共有列](assets/shared-column-with-line-breaks-350x199.png)
