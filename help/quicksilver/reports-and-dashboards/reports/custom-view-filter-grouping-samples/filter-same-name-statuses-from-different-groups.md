...
3 文字のキー *NST* を使用して、タスクステータスをグループ A に割り当て、「*新しいステータス*」という名前を付けることができます。 グループ Bに別のタスクステータスが割り当てられている可能性があります。このステータスには、3文字のキー&#x200B;*NES*&#x200B;が付いた&#x200B;*新しいステータス*&#x200B;という名前も付いています。 2 つのステータスの名前は同じにすることができますが、3 文字のコードは常に一意です。
