...
title: グループ化：タスクのパーセント分類2
description: このカスタムタスクのグループ化では、完了率の値の範囲でグループ化されたタスクを表示できます。 内訳は、10% ポイント増分の完了率を示しています：1-10%、11-20%など。
author: Courtney
...
このカスタムタスクのグループ化では、完了率の値の範囲でグループ化されたタスクを表示できます。 内訳は、10% ポイント増分の完了率を示しています：1-10%、11-20%など。
