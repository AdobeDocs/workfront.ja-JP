...
このカスタムのタスクのグループ化では、タスクを完了率の値の範囲でグループ化して表示できます。内訳には、10 パーセントポイント増分でパーセント完了値が表示されます（例：1 ～ 10%、11 ～ 20%）。

次のグループ化では、プロジェクトを完了率の値で整理して、いずれかのグループに分類しています。
