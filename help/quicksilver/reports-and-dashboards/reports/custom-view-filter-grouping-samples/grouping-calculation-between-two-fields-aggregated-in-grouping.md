...
title: グループ化：グループ内の複数の計算値の集計結果を表示します
...
1. 「**グループ化**」タブで、「**グループ化を追加**」をクリックし、「**グループ化**」フィールドに「**プロジェクト名**」と入力し、リストに表示されたら「**プロジェクト/名前**」を選択します。
...
1. [**この列の集計方法**]フィールドで、[**合計**]を選択します。
1. 追加した列の&#x200B;**[テキストモードに切り替える]**&#x200B;をクリックし、**[テキストモードの編集]**&#x200B;をクリックします。
