...
1. 「**レポートのアクション**」、「**コピー**」の順にクリックします。
   ...
   元のレポートのコピーが作成され、デフォルト名は&#x200B;_[元のレポートの名前]_ _（コピー）_&#x200B;です。 例えば、レポート「Q4完了タスク」のコピーは、「Q4完了タスク（コピー）」という名前になります。

1. （オプション）レポートの名前を変更するには、**レポートアクション**&#x200B;をクリックし、**編集**&#x200B;をクリックします。 左上隅のテキストボックスに新しい名前を入力し、完了したら&#x200B;**保存+閉じる**&#x200B;をクリックします。
...
1. （オプション）元のレポートに対する管理権限を持っていて、元のレポートが不要になった場合は、元のレポートを削除して、Workfront 内の不要な重複レポートを削除できます。
   ...
   1. 「**はい、削除**」をクリックして、レポートを削除することを確認します。

## レポートの新しいバージョンを作成 {#create-a-new-version-of-a-report}

ビルトインレポートのコピーを作成する場合は、次の操作を行います。
...
1. 「**新規レポートとして保存**」をクリックします。
   ...
   ![新しいレポートとして保存](assets/unshimmed-save-as-new-report.png)
