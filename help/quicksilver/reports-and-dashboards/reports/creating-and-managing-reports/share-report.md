...
* 作成したレポートを、他の個人、チーム、グループ、担当業務や会社と共有できます。また、自分が作成し、自分と共有された他のユーザーのレポートを共有することもできます。
* レポートは、組織全体で共有したり、公開したりできます。 レポートを公開すると、他のユーザーと共有できる URL が生成されます。
...
* 自動的に、共有されたレポートを含むダッシュボードから表示権限を継承する。 オブジェクトに対する継承された権限の表示について詳しくは、[オブジェクトの継承された権限を表示](../../../workfront-basics/grant-and-request-access-to-objects/view-inherited-permissions-on-objects.md)を参照してください。
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     <tr> 
      ...
      <td> <p>受信者アクセスを許可して、<strong> レポート </strong> エリアでレポートを表示および実行できるようにします。</p> <p>右側の <strong> 詳細設定 </strong> アイコンをクリックして、そのユーザーまたはユーザーがシステム内の任意のユーザーと <strong> 共有 </strong> できるかどうかを指定します。</p> </td> 
     </tr> 
     <tr> 
      <td role="rowheader">管理</td> 
      <td> <p>受信者にレポートへの完全な編集アクセス権を許可します。</p> <p>右側の <strong> 詳細設定 </strong> アイコンをクリックして、ユーザーがシステムからレポートを <strong> 削除 </strong> したり、システム内の任意のユーザーとレポートを <strong> 共有 </strong> したりできるようにするかどうかを指定できます。</p> </td> 
     </tr> 
    </tbody> 
   </table>
...
1. （任意）共有ボックスの **招待されたユーザーのみがアクセスできる** ドロップダウンメニューをクリックして、次のいずれかのオプションを選択します。
   ...
   * **招待されたユーザーのみがアクセスできます**：レポートへのアクセス権を付与されたユーザーのみがレポートを表示できるように、このオプションを選択します。
