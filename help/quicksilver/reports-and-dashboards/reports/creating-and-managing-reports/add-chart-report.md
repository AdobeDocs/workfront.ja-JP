...
1. **左（Y）軸** フィールドで、グラフのY軸に含める値を選択し、**によって要約** フィールドで情報を要約する方法を選択します。

1. （オプション）「**カスタムカラー**」をクリックして、各列に好みの色を割り当てます。\
   グラフのカラーのカスタマイズについて詳しくは、[グラフのカラーのカスタマイズ](#customize-chart-colors)を参照してください。

1. 「**下（X）軸**」フィールドで、グラフに含めるグループ化を選択します。

1. （オプション）「**3Dで表示**」をクリックして、チャートを3次元表示で表示します。
...
1. （オプション）「**組み合わせチャート**」をクリックして、チャートに追加の値を含めるとともに、情報の要約を行う方法を指定します。\
   次のオプションを考慮してください。
...
1. **下軸（X）軸** フィールドで、グラフのX軸に含める値を選択し、**によって要約** フィールドで情報を要約する方法を選択します。

1. （オプション）「**カスタムカラー**」をクリックして、バーの色をカスタマイズします。\
   グラフのカラーのカスタマイズについて詳しくは、[グラフのカラーのカスタマイズ](#customize-chart-colors)を参照してください。
...
1. （オプション）「**バーをグループ化**」をクリックして、バーをグループ化する方法を定義します。\
   次のオプションから選択します。
...
1. 「**値**」フィールドで、レポートに表示する値を選択し、「**によって要約**」フィールドで情報を要約する方法を選択します。\
   「**ウェッジ**」フィールドで、グラフに含めるグループ化を選択します。グループ化は、グラフのウェッジで表されます。

1. （オプション）「**カスタムカラー**」をクリックして、グラフのくさびの色をカスタマイズします。\
   グラフのカラーのカスタマイズについて詳しくは、[グラフのカラーのカスタマイズ](#customize-chart-colors)を参照してください。
...
1. （オプション）「**行をグループ化**」をクリックして、グラフの追加のグループ化を選択します。\
   （オプション）「**カスタムカラー**」をクリックして、新しいグループ化のカラーをカスタマイズします。\
   グラフのカラーのカスタマイズについて詳しくは、[グラフのカラーのカスタマイズ](#customize-chart-colors)を参照してください。

1. （オプション）「**組み合わせチャート**」をクリックして、行を追加の値で組み合わせます。\
   次のオプションを考慮してください。

   * グラフに含める値と、情報の要約方法を選択します。
   * グラフの右側にデータをプロットするには、「**セカンダリ軸にプロット**」フィールドをクリックします。
...
1. 「**値**」フィールドで、レポートに表示する値を選択し、「**によって要約**」フィールドで情報を要約する方法を選択します。 「**レコード数**」を選択すると、表示される値はレポートのオブジェクトになります。
...
1. （オプション）「**値範囲**」フィールドで、値の範囲と、それらの値を表す色を指定して、ゲージチャートに表示します。
...
1. 「**左（Y）軸**」フィールドで、グラフの Y 軸に含める値を選択します。値はレポートのビューから取得されます。「**によって要約**」フィールドで、情報を要約する方法を指定します。
...
1. 「**バブルの色**」フィールドでバブルの色を使用するフィールドを選択します。
   ...
   **バブル色**&#x200B;は、レポートで定義するグループ化にできますが、このオプションは、**バブル** フィールドで、タスクレポートの&#x200B;**プロジェクト名**、プロジェクトレポートの&#x200B;**プログラム名**&#x200B;など、レポートのオブジェクトに関連する親オブジェクトの&#x200B;**名前**&#x200B;を含むグループ化を選択した場合にのみ使用できます。
...
1. 次のいずれかのオプションを選択することを検討してください。
   ...
   * **カラーを追加**：選択したフィールドの可能な値にカスタムカラーを追加します。
   * **すべてを削除**：上記で指定したすべてのフィールド値と色を削除するには、このオプションを選択します。
   * **値なし**：このフィールドとカスタムカラーを選択して、「値なし」項目をグループ化したグラフ列を表示します。 これらの項目は、グループ化で選択したフィールドのオプションでグループ化できません。
   * **その他のすべての値**：このフィールドとカスタムカラーを選択すると、上記でオプションが定義されていない他のすべてのグラフ要素が表示されます。

     >[!NOTE]
     >
     >最近編集したカラーは、**カスタムカラー** ボタンの右側に表示されます。 カラーにマウスポインターを置くと、そのカラーに関連付けられているフィールドの名前が表示されます。 また、**カスタムカラー**&#x200B;を再度開かずに、カラーをクリックして編集することもできます。

1. カラーを選択するには：
カラーピッカー内をクリックして、カラーを選択します。
または
カラーの16進数カラー値を指定します。

1. カスタムカラーダイアログボックス以外の場所をクリックして閉じます。 選択した色が自動的に保存されます。
...
1. レポートの「グラフ」タブで、「**書き出し**」をクリックして、グラフを.pdfに書き出します。\
...
1. グラフの種類の右側にある「x」ボタンをクリックして、グラフを削除します。
