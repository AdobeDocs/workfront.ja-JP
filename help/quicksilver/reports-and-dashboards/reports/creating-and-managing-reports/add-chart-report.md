...
1. 内 **バブルの色** [ 吹き出しの色 ] フィールドで、吹き出しの色で表すフィールドを選択します。

   ![](assets/qs-bubble-chart-350x103.png)


   この **バブルの色** は、レポートで定義したグループにすることができますが、 **名前** 列に、 **バブル** フィールドに入力します。

   例えば、 **タスク名** タスクレポートで、 **タスクステータス** を **バブルの色** フィールドに入力します。

   ![](assets/bubbles-field-correct-can-select-bubbles-color-example.png)

   ただし、 **タスクステータス** の **バブル** フィールドに値を入力する場合、 **バブルの色** フィールドに入力します。 また、 **プロジェクト名** の **バブルの色** フィールド (「 **タスク名** の **バブル** フィールドに入力します。
