...
1. 「**新規フォルダー**」アイコンをクリックします。\
   ![新しいフォルダアイコン](assets/nwe-new-folder-350x346.png)
...
1. レポートを選択して、リストの上部にあるフォルダーアイコン![フォルダーアイコン](assets/folder-icon.png)をクリックします。

1. レポートを追加するフォルダーを選択します。

   ![レポートの移動先のフォルダーを選択してください](assets/choose-folder.png)
