...
1. （任意） **軸を非表示** をオンに切り替えます。
1. （オプション） **参照線の値** を入力して、グラフのターゲットまたはしきい値を設定します。
...
1. （任意）「**円グラフ**」セクションで、「**セグメントラベルを表示** を切り替えて、セグメントラベルを表示します。
1. （任意） **合計を表示** を切り替えて、グラフの中央に合計を表示します。 有効にすると、中央のラベルを表示して値の形式を選択するための追加オプションが表示されます。
...
1. （オプション）「凡例」セクションで、「凡例を表示 **を切り替えて** グラフの凡例を表示します。
