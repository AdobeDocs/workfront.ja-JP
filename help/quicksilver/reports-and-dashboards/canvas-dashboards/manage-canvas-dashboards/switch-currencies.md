...
<li>カンバスチャート、KPIおよび表レポートでの計画通貨フィールドの使用 </li>
</ul>
<p><b>メモ</b></p>
「計画通貨」フィールドで為替レートが定義されていない通貨を使用している場合、次の場合にCanvas ダッシュボードにエラーメッセージが表示されることがあります。
</td>
<td>
<ul>
...
<p>「計画通貨」フィールドで為替レートが定義されていない通貨を使用している場合、次の場合にCanvas ダッシュボードにエラーメッセージが表示されることがあります。</p>
</td>
<td><ul>
