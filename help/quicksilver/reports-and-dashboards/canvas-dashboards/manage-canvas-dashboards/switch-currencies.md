...
<li>実稼動環境で、カンバスチャート、KPIおよびテーブル レポート <span class="preview">の計画通貨フィールドを使用します。 これは、プレビュー環境で使用できます。</span></li>
</ul>

<p><b>メモ</b></p>
<span class="preview">計画通貨フィールドで為替レートが定義されていない通貨を使用している場合、次の場合にCanvas ダッシュボードにエラーメッセージが表示されることがあります。</span>
...
<p><span class="preview">「計画通貨」フィールドで為替レートが定義されていない通貨を使用している場合、次の場合にCanvas ダッシュボードにエラーメッセージが表示されることがあります。</span></p>
