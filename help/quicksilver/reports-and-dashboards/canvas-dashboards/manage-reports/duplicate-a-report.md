...
title: キャンバスダッシュボードでのレポートの複製
description: キャンバスダッシュボードでレポートを複製できます。
...
KPI、テーブル、またはグラフ レポートを作成後、キャンバス ダッシュボードに複製できます。 複製したら、必要に応じてレポートを編集してから保存できます。
...
1. （オプション）左側のタブを使用して、設定に対して必要な調整を行います。
