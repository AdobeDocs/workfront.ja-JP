...
title: カテゴリ
description: Category オブジェクトで使用可能なフィールドの表。説明と値タイプが含まれます。
author: Becky
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;String&quot;}">文字列</td> 
   <td data-sheets-value="{&quot;1&quot;:2,&quot;2&quot;:&quot;User Editable Field inteded to be used a link to an external object&quot;}">外部オブジェクトへのリンクを使用するユーザー編集可能フィールド</td> 
   <td> </td> 
   <td> <p><span class="dtEdit">編集可能</span> </p> </td> 
  </tr> 
  <tr> 
