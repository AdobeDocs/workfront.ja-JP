        ...
        <ul>
          <li>
            ...
            <p>追加された可能な値は次のとおりです。</p>
             <ul>
              <li>
                <p><code>REMOVE_CUSTOMFORM</code> （カスタムデータから削除）</p>
              </li>
              <li>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <ul>
          <li>
            <p>次のフィールドがフラグ <code>RESTRICTABLE</code>を追加しました：
            </p>
             <ul>
              <li>actualBenefit</li>
          ...
          <li><p><b>予定期間</b></p> <p>フラグ <code>DYNAMIC</code>、<code>LAZY_READ</code>および <code>READ_ONLY</code></li>
          <li><p><b>resourcePlannerBudgetedHours</b></p> <p>フラグを追加しました <code>CURRENCY</code></li>
          <li><p><b>costType</b></p> <p>使用可能な値<code>URH</code> （ユーザーおよび役割の時間単位）を追加しました </li>
          <li><p><b>revenueType</b></p> <p>使用可能な値<code>URH</code> （User and Role Hourly）、<code>URC</code> （User and Role Hourly w/Cap）、および<code>URF</code> （User and Role Hourly Plus Fixed）を追加しました</li>
        </ul>
      </td>
    </tr>
    <tr>
...
割り当てオブジェクトがフラグ `ATTRIBUTE_ATTACHABLE`と`DOMAIN_EXTENDABLE`を追加しました。
...
OpTask オブジェクトはDOMAIN_EXTENDABLE フラグを追加しました
          ...
          <li>
            ...
            <p>追加された可能な値は次のとおりです。</p>
             <ul>
              ...
              <li>
                <p><code>MULTINTRNL</code> （複数選択の内部ルックアップ）</p>
              </li>
              <li>
...
Program オブジェクトがフラグ `DOMAIN_EXTENDABLE`を追加しました。
...
Rate オブジェクトがフラグ `ATTRIBUTE_ATTACHABLE`を追加しました。
          ...
          <li>
            <p><b>displayType</b>
             ...
             <ul>
              ...
              <li><p><code>MULTINTRNL</code> （複数選択の内部ルックアップ）</p></li>
...
Task オブジェクトがフラグ `DOMAIN_EXTENDABLE`を追加しました。
    ...
    <tr>
      ...
      <td>
        <ul>
          ...
          <li><p><b>costType</b></p> <p>追加された可能な値は次のとおりです。<ul><li><code>URH</code> （ユーザーと役割の時間単位）</li></ul></li>
          <li><p><b>revenueType</b></p> <p>追加された可能な値は次のとおりです。<ul><li><code>URH</code> （ユーザーと役割の時間単位）</li><li><code>URC</code> （キャップ付きのユーザーと役割の時間単位）</li><li><code>URF</code> （ユーザーと役割の時間単位プラス固定）</li></ul></li>
        </ul>
      </td>
    </tr>
  </tbody>
