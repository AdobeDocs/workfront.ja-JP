  ...
  <tbody>
    <tr>
      ...
      <td>
        <ul>
          <li>
            <p><code>APDISAB</code> （タイムライン計算でのJava アプレットの使用の無効化）
            </p>
            <p>追加済み</p>
              </li>
            </ul>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <ul>
          <li>
            <p><b>getTerejectionCommenttemporaryCloudURL</b>
            </p>
        ...
        <ul>
          ...
          <li>
            ...
            <p>次の値を追加しました。</p>
             <ul>
              <li>
                <p><code>SNGLROLLUP</code> （単数行ロールアップ）</p>
              </li></ul>
         <li>
            <p><b>isActive</b>
            </p>
...
Team オブジェクトはフラグ `DATA_EXTENDIBLE`と`SHARABLE`を追加しました。
...
TemplateAssignment オブジェクトがフラグ `ATTRIBUTE_ATTACHABLE`を追加しました。
