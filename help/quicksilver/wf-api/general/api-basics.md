...
<pre>PUT /attask/api/v15.0/project/4c7...?updates= <br>{<br>     名前：「新しいプロジェクト名」、<br>     ステータス：「CUR」、<br>     ... <br>}</pre>

### ネストされた更新の作成

一部のオブジェクトには、非公開で所有するコレクションを更新できます。 例えば、次の例は、特定のタスクの既存の割り当てを上書きする方法を示しています。
<pre>PUT /attask/api/v15.0/task/4c7...?updates= <br>&lbrace;<br>    割り当て：[<br>        { <br>            assignedToID: "2222...54d0, <br>            assignmentPercent: 50.0 <br>        },{ <br>            roleID: "1111...54d0"<br>        } <br>    ] <br></pre>
