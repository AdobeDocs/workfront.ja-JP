...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td>オブジェクト権限</td> 
   <td> <p>タイムシートに対する表示権限またはそれ以上の権限</p> </td> 
  </tr> 
 </tbody> 
</table>
...
1. 「**承認用に送信**」をクリックして、タイムシート承認プロセスを開始します。
   ...
   **承認用に送信** ボタンは、**承認**、**却下**、**呼び出し** ボタンに置き換えられます。 タイムシートのステータスが&#x200B;**送信済み**&#x200B;に変わります。
   ...
   タイムシートが承認用に送信されると、承認者は&#x200B;**ホーム**&#x200B;領域の&#x200B;**マイ承認** ウィジェットにリストされているタイムシートを表示します。 次のようなことが起こる可能性があります。

   * 承認された場合、「**リコール**」ボタンが「**再度開く**」に変わり、タイムシートのステータスが&#x200B;**開く**&#x200B;に更新されます。
   * 拒否すると、**承認用に送信** ボタンが&#x200B;**リコール** ボタンに置き換わり、タイムシートのステータスが&#x200B;**拒否**&#x200B;に更新されます。
