...
1. タイムシートの&#x200B;**日付範囲**&#x200B;をクリックして開きます。
   ...
   各タイムシートには自分が時間を記録したすべてのタスク、イシューおよびプロジェクトが表示されます。 また、タイムシートには、タイムシートの時間枠内の日付で割り当てられた最大45個のタスクとイシューが表示されますが、まだ時間が記録されていない可能性があります。 タイムシートに表示する45の最近更新された項目が選択されます。
