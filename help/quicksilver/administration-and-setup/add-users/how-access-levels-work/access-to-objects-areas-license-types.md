...
title: ライセンスによるオブジェクトとエリアへのアクセス
...
<table style="table-layout:auto">
    ...
    <tr>
        <td><span class="preview">担当業務</span></td>
        <td>編集</td>
        <td>表示</td>
        <td>表示</td>
        <td>アクセスなし</td>
    ...
    <tr>
        <td><span class="preview">評価カード</span></td>
        <td>編集</td>
        <td>表示</td>
        <td>アクセスなし</td>
        <td>アクセスなし</td>
...
ライトライセンスを持つ&#42;&#42;人のユーザーは、編集アクセスが有効になっている場合にのみ、プロジェクトレベルで時間を記録できます。 プロジェクトを作成、編集、削除、共有することはできません。 ライトユーザーのプロジェクトのデフォルトのアクセスレベルは「表示」です。
...
>
>* コントリビューターユーザーと外部ユーザーは、システム全体で共有されているコンテンツを表示できません。  明示的に共有する必要があります。
