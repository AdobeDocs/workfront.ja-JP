...
## Adobe Workfront の新しいビルトインのアクセスレベル {#built-in-access}

Workfront には、5 つの新しいビルトインのアクセスレベルが用意されています。
...
カスタムのアクセスレベルが必要な場合は、ビルトインのアクセスレベルをコピーし、様々な Workfront オブジェクトのタイプに対して許可するアクセスの量を調整できます。カスタムアクセスレベルの作成について詳しくは、[カスタムアクセスレベルの作成または変更](../../../administration-and-setup/add-users/configure-and-grant-access/create-modify-access-levels.md)を参照してください。
...
標準ライセンスに付属しているこのビルトインのアクセスレベルは、Adobe Workfront システムの管理を担当するユーザー向けに設計されています。このビルトインのアクセスレベルは変更できません。
...
>[!NOTE]
>
>標準のビルトインのアクセスレベルのカスタムバージョンを作成し、様々な Workfront のオブジェクトタイプに許可するアクセスの量を調整できます。カスタムアクセスレベルの作成について詳しくは、[カスタムアクセスレベルの作成または変更](../../../administration-and-setup/add-users/configure-and-grant-access/create-modify-access-levels.md)を参照してください。
...
* プロジェクト、タスク、イシューを承認
* ダッシュボードとレポートの表示
* プロジェクト、タスク、イシューの時間を追跡し、タイムシートを承認できます
* イシューの作成と管理
...
* 編集アクセスが有効になっている場合にのみ、プロジェクトレベルで時間を記録できます。 プロジェクトを作成、編集、削除、共有することはできません。
* イシューとドキュメントに関するカスタムフォームのみを更新できます。

>[!NOTE]
>
>ライトのビルトインのアクセスレベルのカスタムバージョンを作成し、様々な Workfront のオブジェクトタイプに許可するアクセスの量を調整できます。カスタムアクセスレベルの作成について詳しくは、[カスタムアクセスレベルの作成または変更](../../../administration-and-setup/add-users/configure-and-grant-access/create-modify-access-levels.md)を参照してください。
...
このビルトインのアクセスレベルを持つユーザー：

* リクエストを行い、それらのリクエストを更新できる
* ドキュメントをアップロードして承認できる
* プロジェクト、タスク、イシューを承認できる

  >[!NOTE]
  >
  >コントリビューターは承認に参加できますが、承認プロセスを表示または管理する「承認」タブにはアクセスできません。
...
>[!NOTE]
>
>投稿者のビルトインのアクセスレベルのカスタムバージョンを作成し、様々な Workfront のオブジェクトタイプに許可するアクセスの量を調整できます。カスタムアクセスレベルの作成について詳しくは、[カスタムアクセスレベルを作成または変更](../../../administration-and-setup/add-users/configure-and-grant-access/create-modify-access-levels.md)を参照してください。
