...
>* 標準ライセンスまたはプラン ライセンスを持つユーザーは、チーム エリアからチームの設定を編集できます。 詳しくは、[チーム設定の編集](../../../people-teams-and-groups/create-and-manage-teams/edit-team-settings.md)を参照してください。
