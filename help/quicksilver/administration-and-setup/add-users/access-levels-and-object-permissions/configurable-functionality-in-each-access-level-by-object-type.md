---
title: 各オブジェクトタイプの機能への従来のアクセスを設定可能
description: この記事では、レガシーアクセスレベルで、各オブジェクトタイプのAdobe Workfront管理者が許可する内容について説明します。 また、レガシーアクセスレベルの各タイプのデフォルト設定についても説明します。
author: Courtney
...
# 各オブジェクトタイプの機能への従来のアクセスを設定可能

この記事では、レガシーアクセスレベルで、各オブジェクトタイプのAdobe Workfront管理者が許可する内容について説明します。 また、レガシーアクセスレベルの各タイプのデフォルト設定についても説明します。
...
各レガシーアクセスレベルで、プロジェクトに対して次のオプションを設定できます。
...
各従来のアクセスレベルで、タスクに対して次のオプションを設定できます。
...
各レガシーアクセスレベルで、問題に関する次のオプションを設定できます。
...
ポートフォリオの各従来のアクセスレベルでは、次のオプションを設定できます。
...
各レガシーアクセスレベルで、プログラムに対して次のオプションを設定できます。
...
レガシーアクセスレベルごとに、レポート、ダッシュボード、カレンダーに対して次のオプションを設定できます。
...
各レガシーアクセスレベルで、フィルター、ビューおよびグループに対して次のオプションを設定できます。
...
レガシーアクセスレベルごとに、ドキュメントに対して次のオプションを設定できます。
...
各従来のアクセスレベルで、ユーザーに対して次のオプションを設定できます。
...
レガシーアクセスレベルごとに、チームに対して次のオプションを設定できます。
...
各レガシーアクセスレベルで、テンプレートに対して次のオプションを設定できます。
...
各レガシーアクセスレベルで、財務データに対して次のオプションを設定できます。
...
各レガシーアクセスレベルで、リソース管理に対して次のオプションを設定できます。
...
すべてのレガシーアクセスレベルのデフォルト設定は、[ アクセスなし ] です。 Workfront管理者は、任意のプランナー、ワーカー、レビュー担当者のアクセスレベルに対して、これを「表示」または「編集」アクセス権に変更できます。
...
デフォルトのレガシーアクセスレベルの 6 つ（および 4 つのライセンスタイプすべて）すべてが、Workfront目標を編集および表示できます。
