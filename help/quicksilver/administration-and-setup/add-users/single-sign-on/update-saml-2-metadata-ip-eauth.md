---
title: 拡張認証を使用する場合は、IDPのSAML 2.0 メタデータを更新します
...
Oktaは、SAML 2.0をサポートするID プロバイダーの例です。 この節では、OktaをID プロバイダーとして使用する方法について説明します。 SAML 2.0 をサポートする別の ID プロバイダーを設定する場合も、同様の手順が必要です。
