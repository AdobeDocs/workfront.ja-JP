...
1. コピーしてカスタマイズするアクセスレベルを選択し、**コピー** アイコン ![ コピーアイコン ](assets/copy-icon.png)をクリックします。

   または

   既存のアクセスレベルを編集する場合は、そのアクセスレベルの左側にあるボックスをクリックしてアクセスレベルを選択し、**編集** アイコン ![編集アイコン ](assets/edit-icon.png)をクリックします。
...
1. 表示されるボックスで、次のいずれかの操作を行って、カスタムアクセスレベルの設定を開始します。
   ...
   <tr> 
      <td role="rowheader">Planning ライセンス・タイプ</td> 
      <td><p>このフィールドは、ワークフローパッケージに加えて、Workfront計画パッケージも購入したお客様にのみ表示されます。</p>
      <p>選択したライセンスによって、このアクセスレベルを持つユーザーが使用できる設定が決まります。 </p>
      <p>次のオプションから選択します。</p>
      <ul><li>標準</li>
      <li>コントリビューター</li>
      <li>なし</li>
     </ul> 
      詳しくは、<a href="/help/quicksilver/planning/access/access-overview.md">Adobe Workfront計画アクセスの概要</a>を参照してください 
      <p><b>重要</b></p>
      <p>プランニングライセンスとワークフローライセンスは連携して、ユーザーにWorkfrontへのアクセス権を付与します。 </p>
      <p>ユーザーには、ワークフローとプランニングのライセンスタイプの間で異なるレベルのライセンスタイプを付与できますが、ワークフローライセンスをプランニングのライセンスよりも低くすることはできません。 </p>
      <p>例えば、ユーザーにWorkflow Standard ライセンスとPlanning Contributor ライセンスを付与できますが、Workflow Contributor ライセンスとPlanning Standard ライセンスを付与することはできません。</p>

   </td> 
     </tr>

   <tr> 
      <td role="rowheader">ワークフローライセンスタイプ</td> 
      <td>ここで選択したライセンスが、作成または編集するアクセスレベルのタイプに最も近く、関連しているライセンスであることを確認します。 選択したライセンスによって、アクセスレベルで使用できる設定が決まります。
   ...
   詳しくは、<a href="/help/quicksilver/administration-and-setup/add-users/how-access-levels-work/licenses-overview.md" class="MCXref xref">新しいライセンスの概要</a>または<a href="/help/quicksilver/administration-and-setup/add-users/access-levels-and-object-permissions/wf-licenses.md">ライセンスの概要</a>を参照してください。
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      ...
      <td>ユーザーが、所属する会社、グループおよびチームとのみ項目を表示、共有できるようにします。<p><strong> メモ </strong>: リクエストユーザーまたはコントリビューターライセンスを持つユーザーは、このオプションが選択されている場合でも、自分が属していない会社を表示できません。</td> 
     </tr> 
     <tr> 
     ...
     <tr>
      <td role="rowheader">ユーザーにブランドへのアクセスを許可</td> 
      <td>WorkfrontでGenStudio ブランドにアクセスして管理できます。 詳しくは、<a href="/help/quicksilver/administration-and-setup/add-users/configure-and-grant-access/grant-access-brands.md" class="MCXref xref"> ブランド権限へのアクセス権の付与</a>を参照してください。</td> 
     </tr>
    </tbody> 
   </table>


1. （オプション）このアクセスレベルのユーザーが特定のフィールドを表示できないように制限するには、「制限されたフィールドを追加」セクションにフィールドを追加します。</span>

   このセクションでは、ネイティブフィールドとカスタムフィールドの両方を検索できます。 制限フィールドは20個までです。

   アクセスレベルがユーザーにプライマリアクセスレベルとして割り当てられている場合、またはビジネスプロファイルを介してユーザーに割り当てられている場合、フィールドは制限されます。 ビジネスプロファイルについて詳しくは、[ ビジネスプロファイルの概要](/help/quicksilver/administration-and-setup/add-users/create-and-manage-users/business-profiles.md)を参照してください。

   制限付きフィールドは、引き続きシステム内のユーザーに表示されますが、空白として表示されるか、実際のデータではなくN/Aが表示されます。
