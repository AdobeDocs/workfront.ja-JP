...
* **プロフィール写真**:「**新規をアップロード**」をクリックして、ユーザーのプロフィール写真を読み込みます。 JPG、GIF、または PNG ファイルをアップロードできます。 ファイルサイズの上限は4 MBです。
...
* **連絡先情報**: ユーザーの電話番号（**電話番号**、**内線**、**携帯番号** フィールド）および住所（**住所**、**都市**、**都道府県**、**郵便番号**、および&#x200B;**国** フィールド）。
