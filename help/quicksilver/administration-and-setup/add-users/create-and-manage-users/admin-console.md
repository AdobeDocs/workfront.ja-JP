...
* Adobe Admin Console 管理者は、自動割り当てルールを設定して、アドビ製品を組織内のユーザーに割り当てるプロセスを自動化できます。この機能を使用するには、組織を Adobe Unified Experience に移行する必要があります。情報と手順について詳しくは、アドビドキュメントの[自動割り当てルールの管理](https://helpx.adobe.com/jp/enterprise/using/automatic-assignment-rules.html)を参照してください。
