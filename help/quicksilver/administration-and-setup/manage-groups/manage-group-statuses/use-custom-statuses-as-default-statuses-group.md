...
description: グループ管理者は、管理するグループまたはサブグループのデフォルトのステータスとしてカスタムステータスを設定できます。
author: Becky
...
![すべての問題タイプが有効](assets/all-4-issue-types-enabled.png)
...
![使用可能なステータスがありません](assets/when-hide-default-status-no-equivalent.png)
