...
>[!IMPORTANT]
>
>グループ管理者は、管理するユーザーよりも高いアクセス権を持っている必要があります。そうでない場合、低いアクセス レベルを表示または変更することはできません。
>このアクセス権を付与する手順については、[&#x200B; カスタムアクセスレベルの作成または変更](../../../administration-and-setup/add-users/configure-and-grant-access/create-modify-access-levels.md)を参照してください。
