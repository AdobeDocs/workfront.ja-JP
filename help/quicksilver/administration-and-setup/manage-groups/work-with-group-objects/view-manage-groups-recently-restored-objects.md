...
グループエリアで管理するグループを表示している場合、最近復元したプロジェクト、タスク、イシュー、ドキュメントおよびテンプレートを次の方法で表示および操作できます。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>復元された項目は、グループまたはそのサブグループのうちのいずれかに関連付ける必要があります。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
1. グループの最近復元された項目を表示および管理する、次のタブのいずれかを開きます。
