...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>新しいテンプレートをグループに関連付ける場合は「グループレベルのプロジェクト環境設定」で、グループに関連付けない場合は「プロジェクトの状況を進捗ステータスに基づいて自動的に設定」で、グループに関連付けない場合は同じシステムレベルのプロジェクト環境設定で設定します。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader"> <p>スケジュールの基点</p> </td> 
   <td> <p>新しいテンプレートをグループに関連付ける場合は、グループレベルのプロジェクト環境設定「スケジュール元」で設定します。グループに関連付けない場合は、同じシステムレベルのプロジェクト環境設定で設定します。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader"> <p>ユーザーの休暇</p> </td> 
   <td> <p>新しいテンプレートをグループに関連付ける場合は、グループレベルのプロジェクト環境設定「ユーザーの休暇」で設定し、そうでない場合は同じシステムレベルのプロジェクト環境設定で設定します。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader"> <p>更新タイプ</p> </td> 
   <td> <p>新しいテンプレートをグループに関連付ける場合は「プロジェクトタイムラインは自動的に再計算されます」というグループレベルのプロジェクト環境設定で設定します。グループを関連付けない場合は、同じシステムレベルのプロジェクト環境設定で設定します。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader"> <p>「アクセス」セクション設定</p> </td> 
   <td> <p>新しいテンプレートをグループに関連付ける場合は、「アクセス」セクションのグループレベルのタスク環境設定、そうでない場合は同じシステムレベルのプロジェクト環境設定で設定します。</p> </td> 
  </tr> 
 </tbody> 
</table>
