...
表示しているグループのメインページを離れることなく、グループをすばやく編集、コピー、削除できます。
...
1. グループを選択し、編集![編集アイコン ](assets/edit-icon.png)、コピー![ コピーアイコン ](assets/copy-icon.png)、または削除![削除アイコン ](assets/delete.png) アイコンをクリックします。
