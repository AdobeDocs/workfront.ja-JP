   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      ...
      <td> 
       <ol> 
        <li>1つ以上のユーザー名を選択し、<strong>編集</strong> <img src="assets/edit-icon.png">をクリックします。</li> 
     ...
     <tr> 
      ...
      <td> 
       <ol> 
        <li>1つ以上のユーザー名を選択し、<strong>書き出し</strong> <img src="assets/export.png">をクリックします。</li> 
     ...
     <tr> 
      ...
      <td> 
       <ol> 
        <li>少なくとも1人のグループメンバーを選択し、ツールバーの「<strong>更新をユーザーに送信</strong>」をクリックします。</li> 
