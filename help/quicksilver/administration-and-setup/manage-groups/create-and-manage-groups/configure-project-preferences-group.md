...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   <td role="rowheader"><b>スケジュールの基点</b></td> 
  ...
  <tr> 
   <td role="rowheader"><b>ユーザーの休暇</b></td> 
  ...
  <tr> 
   <td role="rowheader"> <p><strong>複数のユーザーがタスクに割り当てられている場合は、...</strong>のスケジュールを使用します </p> </td> 
 ...
 <tr> 
   <td role="rowheader"> <p><strong>1人のユーザーがタスクに割り当てられている場合は、...</strong>のスケジュールを使用します </p> </td> 
...
<p>プロジェクト内のタスクに1人のユーザーを割り当て、プロジェクトとユーザーの両方にスケジュールが関連付けられている場合、[!UICONTROL Workfront]は次のスケジュールを使用します。</p> 
    <ul> 
  ...
  <tr data-mc-conditions=""> 
   <td role="rowheader"> <p><b>タイムラインの計算</b></p> </td> 
   <td> 
    <ul> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td> 
   <span class="preview"> プレビュー環境のグループの「プロジェクト環境設定」セクションから「カスタム四半期」領域が削除されました。</span>
   <p>カスタム四半期は通常、暦年の従来の四半期分類と一致しない四半期です。Workfront管理者は、<b>設定</b>領域に複数のカスタム四半期を追加できます。 詳しくは、<a href="../../../administration-and-setup/set-up-workfront/configure-system-defaults/enable-custom-quarters-projects.md" class="MCXref xref" data-mc-variable-override=""> カスタム四半期を有効にする</a>を参照してください。</p>  
   <p><b>重要<b></p>
   <p>グループ管理者としてカスタム四半期の設定を変更することはできません。 <p>Workfront管理者は、グループ管理者が管理できるように、カスタム四半期の環境設定のロックを解除できません。</p> <p>「カスタム四半期」領域は、グループ管理者に対して読み取り専用です。</p>
   </td> 
  </tr> 
 </tbody> 
</table>
