...
description: ' [!DNL Workfront]  の本番環境を複製して、2つの  [!DNL Workfront]  テスト環境を使用できます。 プレビューサンドボックスは、Workfront によって毎週末にアップデートされます。 金曜日にライブ環境に追加されたデータは、次の月曜日までにプレビューサンドボックスに表示されます。 カスタム更新サンドボックスは、個別のテスト環境で、ユーザーが手動で更新します。 カスタム更新サンドボックスを取得するには、追加の費用がかかります。'
author: Becky
