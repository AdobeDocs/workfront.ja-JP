...
title: 時間または日数で時間を記録するようにユーザーを設定
...
[!UICONTROL Standard]または[!UICONTROL Planner] ライセンスを持つユーザーは、時間を[!DNL Adobe Workfront]に記録するか、日に記録するかを設定できます。 [!DNL Workfront] 管理者として、個々のユーザーに対してこの設定を指定することも、組織の複数のユーザー全体に対してこの設定を指定することもできます。 デフォルトでは、ユーザーは時間単位で記録します。
