...
* レビュアー：ブランドまたはブランドのブレインを使用して共同作業者を作成し、その共同作業者をアセットのレビュアーとして割り当てます。
...
1. 共同作業者がレビューにブランドを使用するか、ブランドの脳を使用するかを選択します。
1. （条件付き） AI コラボレーターがブランド ブレインを使用する場合は、使用するテナントを選択します。
