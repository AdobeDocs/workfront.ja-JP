...
title: 自動リマインダーの設定
description: すべてのタスクや問題の期日、遅延、または予定完了日付近に、メール通知をトリガーする自動リマインダーを設定できます。
author: Courtney
...
1. **遅延通知の送信先**&#x200B;領域で、次のいずれかのオプションを選択します。
   ...
   <table>
    ...
    <tr>
        <td>「割り当て先」ユーザー</td>
        <td>（<b>期限リマインダーを</b> エリアに送信します）。 タスクまたはイシューに割り当てられたユーザーに、期日に近づいている作業項目に関する通知を送信する場合は、このオプションを選択します。</td>
        <td></td>
    </tr>
   </table>
...
1. 作業項目の期日の前後の時間を選択して、自動リマインダーを送信する時間を設定します。
   ...
   ![時間の増分](assets/time-increments-for-automatic-reminder.png)
