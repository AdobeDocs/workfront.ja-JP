...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>承認保留中の問題</p> </td> 
   <td> <p>委任された承認者</p> </td> 
   <td> <p>委任された問題の承認について確認する必要があります。</p> <p>別のユーザーにイシューの承認を委任すると、そのユーザーに通知が届きます。 </p> <p>通知は、プロジェクトが「現在」のステータスの場合にのみ送信されます。</p> </td> 
   <td> <p>アクティブ</p> </td> 
  </tr> 
  <tr> 
   <td> <p>プロジェクト</p> </td> 
...
|------------------|--------------------------------------------|-----------|--------------------------------------------------------------|-----------------------|
| タスクとイシュー | タスクとイシューの委任 | 割り当て先 | わたしはタスクおよびイシューを委任します（確認） | Active (Instant only) |
| タスクとイシュー | タスクとイシューの委任の停止 | 割り当て先 | わたしはタスクおよびイシューの委任を停止します（確認） | Active (Instant only) |
| タスクとイシュー | タスクとイシューの委任 | 委任 | 誰かがわたしにタスクおよびイシューを委任します | Active (Instant only) |
| タスクとイシュー | タスクとイシューの委任の停止 | 委任 | 誰かがわたしへのタスクおよびイシューの委任を停止します | Active (Instant only) |
