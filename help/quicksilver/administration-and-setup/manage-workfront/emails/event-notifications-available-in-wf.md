...
>[!NOTE]
>
>デフォルトの状態の列で「アクティブ」の値を持つ通知は、特に明記されていない限り、デフォルトでインスタント通知と日次の通知の両方でアクティブになります。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>ドキュメントリクエスト元のユーザー</p> </td> 
   <td> <p>誰かが私にドキュメントのアップロードをリクエストしました。</p> <p>ドキュメントのアップロード要求を受信すると、ドキュメント要求者にメール通知が送信されます。</p> </td> 
   <td> <p>アクティブ（インスタントのみ）</p> </td> 
  </tr> 
  <tr> 
   <td> <p>ドキュメント</p> </td> 
  ...
  <tr> 
   <td> <p>イシュー</p> </td> 
   <td> <p>イシューの割り当て</p> </td> 
   <td> <p>イシューが割り当てられているユーザー</p> </td> 
   <td> <p>私にイシューが割り当てられました。</p> <p>イシューの担当者は、プロジェクトのステータスが「現在」で、イシューのステータスが「クローズ」でないか、「クローズ」に等しいものの場合にのみ、メール通知を受信します。</p> <p>ライト、コントリビューター、レビューまたはリクエストのライセンスを持つユーザーには、通知は送信されません。</p> </td> 
   <td> <p>非アクティブ</p> </td> 
  </tr> 
  <tr> 
   <td> <p>イシュー</p> </td> 
  ...
  <tr> 
   ...
   <td> <p>承認保留中の問題</p> </td> 
   <td> <p>委任された承認者</p> </td> 
   <td> <p>委任されたイシュー承認を確認する必要があります。</p> <p>別のユーザーにイシューの承認を委任すると、そのユーザーに通知が届きます。 </p> <p>通知は、プロジェクトが「現在」のステータスの場合にのみ送信されます。</p> </td> 
   <td> <p>アクティブ</p> </td> 
  </tr> 
  <tr> 
   <td> <p>プロジェクト</p> </td> 
  ...
  <tr> 
   ...
   <td> <p>私はタスクのプライマリ割り当て先として設定されました。</p> <p>タスク担当者は、タスクのプライマリ担当者にされた場合、担当者が割り当てを行ったユーザーである場合を除き、メール通知を受け取ります。</p> <p>プロジェクトのステータスが「現在」で、タスクが「完了」とマークされていない場合は、通知が送信されます。</p> <p>ライトライセンスやレビューライセンスのユーザーには、通知は届きません。</p> </td> 
   <td> <p>非アクティブ</p> </td> 
  </tr> 
  <tr> 
   <td> <p>タスク</p> </td> 
  ...
  <tr> 
   ...
   <td> <p>私のタイムシートが再開されました。</p> <p>タイムシートの所有者は、タイムシートを再開したユーザーがタイムシートの所有者である場合を除き、タイムシートが再開されるとメール通知を受け取ります。</p> <p>メール通知は、タイムシートのステータスが「開く」の場合にのみ送信されます。</p> <p>ライトライセンスやレビューライセンスのユーザーには、通知は届きません。</p> </td> 
   <td> <p>非アクティブ</p> </td> 
  </tr> 
  <tr> 
   <td> <p>タイムシート</p> </td> 
   <td> <p>タイムシートの却下</p> </td> 
   <td> <p>タイムシートが属するユーザー</p> </td> 
   <td> <p>タイムシートが却下されました。</p> <p>タイムシートの所有者は、タイムシートを却下したユーザーが所有者である場合を除き、タイムシートが却下されるとメール通知を受け取ります。</p> <p>メール通知は、タイムシートのステータスが「却下」の場合にのみ送信されます。</p> <p>ライトライセンスやレビューライセンスのユーザーには、通知は届きません。</p> </td> 
   <td> <p>非アクティブ</p> </td> 
  </tr> 
  <tr> 
   <td> <p>タイムシート</p> </td> 
  ...
  <tr> 
   ...
   <td> <p>作業アイテムがリクエストされたチームのメンバー</p> </td> 
   <td> <p>チームが新規作業リクエストを受けました。</p> <p>チームメンバーは、チームが新しい作業リクエストを受け取ると、メール通知を受け取ります。（リクエストを送信したユーザーは、チームのメンバーである場合は通知を受け取りません）。</p> <p>通知は、作業リクエストが行われた時点でプロジェクトのステータスが「現在」で、作業リクエストのステータスが「新規」の場合にのみ送信されます。</p> <p>ライトライセンスやレビューライセンスのユーザーには、通知は届きません。</p> </td> 
   <td> <p>アクティブ</p> </td> 
  </tr> 
  <tr> 
   <td> <p>割り当て</p> </td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>アクティブ（日単位のみ）</p> </td> 
  </tr> 
  <tr> 
   <td> <p>イシュー</p> </td> 
   <td> <p>クローズしたリクエスト</p> </td> 
   <td> <p>イシューのプライマリ</p> </td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr data-mc-conditions=""> 
   <td>タスク</td> 
   <td>すべての先行タスクの完了</td> 
   <td>依存タスクに割り当てられたチームのメンバー</td> 
   <td> <p>チームのタスクの先行タスクがすべて完了しました。</p> <p>タスクの担当者（チームのすべてのメンバー）がメール通知を受け取ります。</p> <p>ライトライセンスやレビューライセンスのユーザーには、通知は届きません。</p> </td> 
   <td>非アクティブ</td> 
  </tr> 
  <tr> 
   <td> <p>タスク</p> </td> 
   ...
   <td> <p>自分のタスクのすべての先行タスクが完了しました。</p> <p>タスクの担当者がメール通知を受け取ります。</p> <p>ライトライセンスやレビューライセンスのユーザーには、通知は届きません。</p> </td> 
   <td> <p>非アクティブ</p> </td> 
  </tr> 
  <tr> 
   <td> <p>イシュー</p> </td> 
   <td> <p>承認の決定</p> </td> 
   <td> <p>イシューが割り当てられているユーザー</p> </td> 
   <td> <p>自分が解決するイシューが承認または拒否された。</p> <p>イシューの担当者は、承認決定（承認または却下）が下されると、メール通知を受け取ります。</p> <p>ライトライセンスやレビューライセンスのユーザーには、通知は届きません。</p> </td> 
   <td> <p>非アクティブ</p> </td> 
  </tr> 
  <tr> 
   <td> <p>タスク</p> </td> 
   <td> <p>承認の決定</p> </td> 
   <td> <p>タスクが割り当てられているユーザー</p> </td> 
   <td> <p>自分が完了するタスクが承認または拒否された。</p> <p>タスクの担当者は、タスクが承認または却下されると、メール通知を受け取ります。</p> <p>プロジェクトのステータスが「進行中」の場合にのみ通知が送信されます。</p> <p>ライトライセンスやレビューライセンスのユーザーには、通知は届きません。</p> </td> 
   <td> <p>非アクティブ</p> </td> 
  </tr> 
  <tr> 
   <td> <p>イシュー</p> </td> 
   <td> <p>イシューの完了</p> </td> 
   <td> <p>イシューが割り当てられているユーザー</p> </td> 
   <td> <p>自分が割り当てられているイシューが完了した。</p> <p>通知は、プロジェクトのステータスが「現在」または「計画」の場合にのみ送信されます。</p> <p>ライトライセンスやレビューライセンスのユーザーには、通知は届きません。</p> </td> 
   <td> <p>非アクティブ</p> </td> 
  </tr> 
  <tr> 
   <td> <p>イシュー</p> </td> 
  ...
  <tr> 
   <td> <p>イシュー</p> </td> 
   <td> <p>イシューステータスの変更</p> </td> 
   <td> <p>イシューが割り当てられているユーザー</p> </td> 
   <td> <p>自分の作業アイテムの 1 つで状態の変更。</p> <p>イシューのステータスが変更されると、イシューのプライマリ連絡先にメール通知が届きます。ただし、ステータスを変更したユーザーがプライマリ連絡先と同じ場合を除きます。</p> <p>プロジェクトのステータスが「進行中」の場合にのみ通知が送信されます。</p> <p>ライトライセンスやレビューライセンスのユーザーには、通知は届きません。</p> </td> 
   <td> <p>アクティブ（日単位のみ）</p> </td> 
  </tr> 
  <tr> 
   <td> <p>ドキュメント</p> </td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>チームが進行中のプロジェクトがアクティブになる。</p> <p>割り当てられたWorkfront チームのメンバーは、割り当てられたプロジェクトがアクティブになると、メール通知を受け取ります。</p> </td> 
   <td> <p>非アクティブ</p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>未割り当てイシューの追加</p> </td> 
   <td> <p>プロジェクト所有者</p> </td> 
   <td> <p>自分が所有するプロジェクトに未割り当てのイシューが追加された。</p> <p>プロジェクト所有者は、未割り当てのイシューがプロジェクトに追加されるとメール通知を受け取ります。</p> <p>通知は、プロジェクトのステータスが「現在」または「計画」の場合にのみ送信されます。</p> <p>ライトライセンスやレビューライセンスのユーザーには、通知は届きません。</p> </td> 
   <td> <p>非アクティブ</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>プロジェクトユーザーの追加</p> </td> 
   <td> <p>リソース所有者</p> </td> 
   <td> <p>自分のユーザー 1 名がプロジェクトに追加された。</p> <p>マネージャーは、自分の直属の部下の 1 人がプロジェクトに追加されると、メール通知を受信します。</p> <p>ライトライセンスやレビューライセンスのユーザーには、通知は届きません。</p> </td> 
   <td> <p>非アクティブ</p> </td> 
  </tr> 
  <tr> 
   <td> <p>プロジェクト</p> </td> 
   <td> <p>ポートフォリオまたはプログラムへプロジェクトの追加</p> </td> 
   <td> <p>ポートフォリオまたはプログラムの所有者</p> </td> 
...
|------------------|--------------------------------------------|-----------|--------------------------------------------------------------|-----------------------|
| タスクとイシュー | タスクとイシューの委任 | 割り当て先 | わたしはタスクおよびイシューを委任します（確認） | アクティブ（インスタントのみ） |
| タスクとイシュー | タスクとイシューの委任の停止 | 割り当て先 | わたしはタスクおよびイシューの委任を停止します（確認） | アクティブ（インスタントのみ） |
| タスクとイシュー | タスクとイシューの委任 | 委任 | 誰かがわたしにタスクおよびイシューを委任します | アクティブ（インスタントのみ） |
| タスクとイシュー | タスクとイシューの委任の停止 | 委任 | 誰かがわたしへのタスクおよびイシューの委任を停止します | アクティブ（インスタントのみ） |
