...
description: Workfront の管理者は、Workfront の機能、レポート、メール、セキュリティ、為替レート、削除された項目、診断のプルーフを設定できます。
...
* [プルーフ機能の設定](../../administration-and-setup/manage-workfront/configure-proofing/configuring-proofing-functionality.md)
