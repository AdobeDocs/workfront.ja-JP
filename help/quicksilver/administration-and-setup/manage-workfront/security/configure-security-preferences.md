   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      ...
      <tr> 
      <td role="rowheader">Adobe Enterprise Storageを有効にする </td> 
      <td>組織全体または特定のグループに対して、Adobe Enterprise Storageを有効または無効にできます。 Adobe Enterprise Storageについて詳しくは、<a href="/help/quicksilver/administration-and-setup/set-up-workfront/configure-system-defaults/enable-esm.md">組織でAdobe Enterprise Storageを有効にする</a>を参照してください。</td> 
     </tr>
     <tr> 
