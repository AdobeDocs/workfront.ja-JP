...
| 会社 | グループ | 役割 |
|---|---|---|
| Acme, Co <p>Workfront, Inc. <p>_あなたの会社_ <p>XYZ, Inc. | 財務 <p>IT <p>マーケティング <p>販売 | ビジネスアナリスト <p>コントローラークリエイティブ <p>デザイナー <p>リソース管理者 <p>スクラムマスター <p>テクニカルライター <p>Web 開発者 |
...
1. **isNew**&#x200B;列に&#x200B;**TRUE**&#x200B;と入力します。
   ...
   ![会社が新しい](assets/cmpyisnew-350x86.png)
...
1. **setName**&#x200B;列に各顧客の名前を入力します。
   ...
   ![会社ID](assets/companyid-350x78.png)
...
1. **isNew**&#x200B;列に&#x200B;**TRUE**&#x200B;と入力します。
   ...
   ![役割が新しい](assets/roleisnew-350x104.png)

1. 一意の&#x200B;**ID**&#x200B;を入力してください。

   各行にIDを入力する必要があります。 1 で始まる整数は、新しいレコードを作成する際に適切に機能します。

   ![役割が新しい](assets/roleisnew--1--350x104.png)
...
1. ユーザーの会社の詳細を入力します。
   ...
   ![会社ID](assets/companyid--1--350x78.png) ![会社IDを貼り付け](assets/pastecompanyid-350x84.png)
...
1. ユーザーの担当業務の詳細を入力します。
   ...
   ![役割IDをコピー](assets/copyroleid-350x149.png) ![役割IDを貼り付け](assets/pasteroleid-350x95.png)
