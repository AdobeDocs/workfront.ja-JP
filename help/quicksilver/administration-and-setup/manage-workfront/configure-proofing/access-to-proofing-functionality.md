...
プルーフは、Workfrontのすべてのライセンスに対して自動的に含まれます。 ライセンスは、ユーザーが何ができるかを決定します。
...
以前の2017 Workfront パッケージには、Pro、Business、またはEnterprise Workfront プランをお持ちの場合は、作業ライセンスとプラン ライセンスのプルーフが自動的に含まれています。 これらの計画は段階的に廃止されつつある。
