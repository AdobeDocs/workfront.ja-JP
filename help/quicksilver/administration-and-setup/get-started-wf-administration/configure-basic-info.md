...
1. 左側のパネルで、**システム**／**顧客情報**&#x200B;をクリックします。
   ...
   | <span class="preview">**ストレージの概要**</span> | <span class="preview"> ドキュメントストレージの使用状況と割り当ての確認について詳しくは、[ ドキュメントストレージの制限の確認](../../documents/managing-documents/check-document-storage.md)を参照してください。</span> |
