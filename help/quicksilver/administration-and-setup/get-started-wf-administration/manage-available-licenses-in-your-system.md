...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   <td role="rowheader">Workfrontパッケージ</td> 
   <td><p>任意</p></td> 
  </tr> 
  <tr> 
...
>[!NOTE]
>
>次のステートメントは、Select、Prime、およびUltimateパッケージに適用されます。
>
>選択パッケージの場合：
>
>1. システム管理者は、ホームグループの制限を設定できません。
>2. システム管理者は、すべてのホームグループで使用されているライセンスの総数のみを表示できます。
>3. グループ管理者は、ライセンスページにアクセスできません。
>
>PrimeパッケージとUltimateパッケージの場合：
>
>1. システム管理者は、ホームグループを「ライセンス」ページに追加して、それらのグループ内のライセンスの使用状況を表示したり、ライセンス制限を設定したりできます。
>2. グループ管理者は「ライセンス」ページにアクセスし、システム管理者によって「ライセンス」ページに追加された、管理するグループのライセンスの使用状況を表示できます。
>3. グループ管理者は、他のホームグループの情報を表示したり、最大数を追加したりすることはできません。
...
1. 最大値を入力し、Enter キーを押します。
   ...
   ![グループの最大ライセンス数](assets/updated-max.png)
