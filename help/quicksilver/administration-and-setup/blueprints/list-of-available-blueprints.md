...
**オフボーディング | 離脱するユーザーのダッシュボード**

このブループリントには、13 個のレポートを含む単一のダッシュボードが含まれ、Workfront を離脱するユーザーに関連するオブジェクトや割り当てを検索、再割り当て、または管理するのに役立ちます。また、これらのレポートを使用して、新しい役割またはグループに移行するユーザーに対して、作業を再割り当てすることもできます。

[!BADGE 新規]{type=negative}**People Manager ダッシュボード**
...
[!BADGE 新規]{type=negative}**価値の実現 |準拠ワークフローダッシュボードの管理**
...
このブループリントには、Workfront の価値を実現するのに役立つ 7 個のレポートを含む単一のダッシュボードが含まれています。これらのレポートは、レビューと承認の作業の価値を、時間の経過と共に追跡できる測定可能なメリットに変換し、成果を高めるのに役立ちます。
