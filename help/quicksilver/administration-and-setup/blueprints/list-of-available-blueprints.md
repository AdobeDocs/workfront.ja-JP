...
[!BADGE 新登場。]{type=Informative} **[!UICONTROL アクティブなユーザー分析レポート]**
このブループリントには、管理者がユーザー設定を検証し、ミスアライメントを識別し、設定が意図したアプリケーションの使用をサポートしていることを確認するのに役立つダッシュボードが含まれています&#x200B;
...
[!BADGE 新登場。]{type=Informative} **[!UICONTROL ベースラインダッシュボード]**
このブループリントには、より賢く、より迅速にプロジェクトを決定するのに役立つダッシュボードが含まれています。 ベースラインを使用すると、計画された内容と発生した内容を比較でき、問題タスク、範囲のクリープ、プロジェクトのトレンドを一目で特定できます。 ベースラインダッシュボードには、次のレポートが含まれます。ベースライン |件の進行中プロジェクト、ベースライン |完了プロジェクト、ベースライン |件の進行中のタスクとベースライン |件の完了したタスク。
