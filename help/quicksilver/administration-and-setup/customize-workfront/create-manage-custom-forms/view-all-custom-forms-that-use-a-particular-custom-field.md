...
title: 特定のカスタムフィールドまたはウィジェットを使用するすべてのカスタムFormsを表示する
...
すべてのカスタムフィールドのリストでフィールドの使用状況を確認するには：
...
カスタムフォーム内のフィールドの使用状況を確認するには：

{{step-1-to-setup}}

1. 左側のパネルで、「**カスタムフォーム**」をクリックします。
1. カスタムフォームを開いて、ライブラリからフィールドを追加するか、フォーム上の既存のフィールドを選択します。

   フォームデザイナーの右側にある使用状況インジケーターには、このフィールドを使用している他のカスタムフォームの数が表示されます。

1. **関連するFormsを表示**&#x200B;をクリックします。

   フォームのリストで、任意のフォーム名をクリックしてフォームを開き、フィールドの使用方法を確認できます。 各フォームがアクティブか非アクティブかを示すインジケーター。
