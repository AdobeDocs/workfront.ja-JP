...
すべてのカスタムフィールドのリストでフィールドの使用状況を表示するには：
...
カスタムフォーム内のフィールドの使用状況を表示するには：

{{step-1-to-setup}}

1. 左側のパネルで、「**カスタムフォーム**」をクリックします。
1. カスタムフォームを開いてライブラリからフィールドを追加するか、フォーム上の既存のフィールドを選択します。

   フォームデザイナーの右側にある使用状況インジケーターは、このフィールドを使用する他のカスタムフォームの数を示します。

1. **関連するFormsを表示** をクリックします。

   フォームのリストで任意のフォーム名をクリックしてフォームを開き、フィールドの使用方法を確認できます。 インジケーターは、各フォームがアクティブか非アクティブかを示します。
