   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     <tr> 
      ...
      <td> <p>オブジェクトでカスタムフォームを表示し、入力する機能。</p> <p><b> メモ </b>:Light およびコントリビューターライセンス（またはワーク、レビュー、リクエストのライセンス）を持つユーザーの場合、これは利用可能な最も高いオプションです。</p> <p>「<strong>詳細設定</strong>」をクリックして、次のことを許可するかどうかを指定します。</p> 
       <ul> 
