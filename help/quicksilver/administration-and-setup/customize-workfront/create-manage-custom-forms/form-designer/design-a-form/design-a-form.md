    ...
    <tbody> 
     ...
     <tr>
      ...
      <td><p>参照フィールドのフィルターを追加して、ユーザーがフィールドを使用するときに選択できる項目のリストを制限します。 </p> <p>例えば、以下の条件を満たすユーザー名のみを選択できるようにフィールドを制限することができます。</p> 
       ...
       <p>テキストモードの構文を使用して、選択した参照フィールドのフィルターを定義する必要があります。 テキストモードを使用したフィルターの作成について詳しくは、<a href="/help/quicksilver/reports-and-dashboards/reports/text-mode/edit-text-mode-in-filter.md">テキストモードを使用したフィルターの編集</a>を参照してください。</p>
       <p><b>メモ</b>：
       <ul> 
