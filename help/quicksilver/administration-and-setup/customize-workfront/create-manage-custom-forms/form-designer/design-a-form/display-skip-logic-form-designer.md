...
1. 「**適用**」をクリックします。
   ...
   >[!NOTE]
   >
   >実稼動環境では、フォームデザイナーのプレビューモードでは、高度な表示ロジックはサポートされていません。
   >
...
1. 「**適用**」をクリックします。
   ...
   >[!NOTE]
   >
   >実稼動環境では、フォームデザイナーのプレビューモードでは、デフォルトの値ロジックはサポートされていません。
   >
   ><span class="preview"> プレビュー環境では、すべてのロジックの種類をプレビューモードで使用できます。</span>
...
1. 「**適用**」をクリックします。
   ...
   >[!NOTE]
   >
   >実稼動環境では、フォームデザイナーのプレビューモードでは検証ロジックはサポートされていません。
   >
   ><span class="preview"> プレビュー環境では、すべてのロジックの種類をプレビューモードで使用できます。</span>
...
1. 「**適用**」をクリックします。
   ...
   >[!NOTE]
   >
   >実稼動環境では、フォームデザイナーのプレビューモードでは書式設定ロジックはサポートされていません。
   >
   ><span class="preview"> プレビュー環境では、すべてのロジックの種類をプレビューモードで使用できます。</span>
...
1. 「**適用**」をクリックします。
   ...
   >[!NOTE]
   >
   >実稼動環境では、フォームデザイナーのプレビューモードでは編集可能ロジックはサポートされていません。
   >
   ><span class="preview"> プレビュー環境では、すべてのロジックの種類をプレビューモードで使用できます。</span>
