...
## リストのフィルター、表示、グループ化コントロールのカスタマイズ


>[!NOTE]
>
>レイアウトテンプレートにビュー、フィルター、またはグループ化を追加すると、レイアウトのみが制御され、アクセス権は付与されません。 ユーザーは引き続き各項目への表示アクセスを必要とします。
>
>コントリビューター、依頼者、および外部ライセンスのユーザーは、システム全体で共有されているアイテムを表示できないため、それらのアイテムに対するビューを明示的に共有する必要があります。 詳しくは、[フィルター、ビュー、またはグループ化の共有](/help/quicksilver/reports-and-dashboards/reports/reporting-elements/share-filter-view-grouping.md)を参照してください。
