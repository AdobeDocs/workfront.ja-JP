...
>
>Adobe Workfront統合エクスペリエンスをオンボーディングした後、メインメニューに別のオプションが表示される場合があります。 詳しくは、[Workfront向けAdobe Unified Experience](/help/quicksilver/workfront-basics/navigate-workfront/workfront-navigation/adobe-unified-experience.md)を参照してください。
