...
1. グループ名を選択します。
グループのメンバーが表示されるようになりました。<br><img src="assets/membersofthegroupdisplay-350x117.png" alt="Screenshot_2018-04-06_15-07-06.png" style="width: 350;height: 117;">
1. （オプション）ドロップダウンメニューを使用して、個々のメンバーの&#x200B;**プルーフの役割**&#x200B;または&#x200B;**メールアラート**を変更します。
詳しくは、<a href="../../../workfront-proof/wp-work-proofsfiles/share-proofs-and-files/manage-proof-roles.md" class="MCXref xref"> プルーフの役割の管理[!DNL Workfront Proof]</a>および<a href="../../../workfront-proof/wp-emailsntfctns/email-alerts/config-email-notification-settings-wp.md" class="MCXref xref"> メール通知設定の設定[!DNL Workfront Proof]</a>を参照してください。
