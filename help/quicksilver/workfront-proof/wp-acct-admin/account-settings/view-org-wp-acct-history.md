...
1. アカウントの変更の完全なリストを表示するには、「**[!UICONTROL 使用状況の統計]**」セクションの「**完全なリスト**」をクリックします。
アクティビティログページが表示されます。詳細については、[ アクティビティ監査記録の概要](../../../workfront-proof/wp-work-proofsfiles/basic-features/activity-audit-trail.md)を参照してください。 [!DNL Workfront Proof] 
