...
プルーフビューアの「**[!UICONTROL 印刷]**」アイコンをクリックすると、プルーフのサムネールやフルビュー画像を含むプルーフのコメントの概要を印刷できます。

![PV_print_all_comm.png](assets/pv-print-all-comm-350x158.png)

プルーフビューアにアクセスするには、プルーフの詳細ページで「**プルーフに移動**」ボタンをクリックします。

### プルーフの詳細ページ {#the-proof-details-page}

プルーフの詳細ページの「**[!UICONTROL 印刷]**」アイコンをクリックすると、プルーフのコメントの概要を印刷できます。

![proof_details_page.png](assets/proof-details-page-350x231.png)

特定のプルーフのプルーフの詳細ページにアクセスするには、リストビューからプルーフの名前をクリックします。
...
サムネールビューには、各コメントのスレッド全体が順番に表示されます。 また、コメントを並べ替えたり、マークアップを追加した各コメントのサムネールを表示することもできます。

サムネールビューを印刷するには、ページの右上隅にある&#x200B;**[!UICONTROL プリンター]** アイコンをクリックし、次のいずれかを選択します。
...
ページ全体のビューには、各ページが順番に表示され、そのページのコメントと、コメントの場所を示すピンが表示されます。

ページ全体のビューを印刷するには、ページの右上隅にある&#x200B;**[!UICONTROL プリンター]** アイコンをクリックします。
...
1. 「**詳細**」ボタンをクリックし、「**Excelに書き出し**」を選択します。

   ![Excelに書き出し](assets/export-to-excel.png)

## PDF への書き出し

PDF ファイルに書き出すと、すべてのコメントがPDF リーダーに表示されます。 コメントに複数のマークアップが関連付けられている場合、コメントはコメントリストに複数回表示されます（マークアップごとに 1 回）。

>[!IMPORTANT]
>
>「PDFに書き出し」機能は、静的ファイルに対してのみ使用できます。

マークアップとコメントを含むプルーフをPDFに書き出すには：

1. 画面の左側で、**[!UICONTROL ビュー]**&#x200B;をクリックします。
1. 特定のプルーフに沿って&#x200B;**[!UICONTROL 詳細]** ボタンをクリックし、「**[!UICONTROL コメントを印刷]**」を選択します。

1. ページの右上隅にある「**PDFに書き出し**」ボタンをクリックします。 PDFのダウンロードが開始され、完了後に電子メールで通知されます。
