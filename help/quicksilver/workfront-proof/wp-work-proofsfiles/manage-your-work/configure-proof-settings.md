...
* **[!UICONTROL 購読者の役割]** – これは、プルーフに自分自身を購読するすべてのレビュー担当者に割り当てられるデフォルトのプルーフの役割です。
* **[!UICONTROL 購読者の電子メールアラート設定]** – これは、プルーフを購読するすべてのレビュー担当者に割り当てられるデフォルトの電子メールアラートです。
* **[!UICONTROL プルーフへのアクセスは、]**&#x200B;に必要な電子メールリンクを介して行われます。プルーフにアクセスするには、電子メールのリンクをクリックする必要があります\
