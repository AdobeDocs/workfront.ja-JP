...
* 管理と設定 {#administration-and-setup}
   ...
   * ユーザー管理 {#add-users}
      ...
      * 新しいアクセスレベルの仕組み {#access-levels}
         ...
         * [アクセスレベルの要件 ( Workfrontドキュメント )](/help/quicksilver/administration-and-setup/add-users/access-levels-and-object-permissions/access-level-requirements-in-documentation.md)
   ...
   * Adobe Workfrontを管理 {#manage-wf}
      ...
      * キックスタート {#kick-starts}
         ...
         * [キック開始のシナリオ：複数オプションのカスタムフィールドをWorkfrontに読み込む](administration-and-setup/manage-workfront/using-kick-starts/kick-starts-scenario-multiple-option-custom-field-import.md)
   ...
   * グループの管理 {#manage-groups}
      ...
      * グループステータスの管理 {#group-statuses}
         ...
         * [カスタムステータスをグループのデフォルトとして使用する](administration-and-setup/manage-groups/manage-group-statuses/use-custom-statuses-as-default-statuses-group.md)
   ...
   * 統合の設定 {#configure-integrations}
      ...
      * [Experience Manager Assets as a Cloud Service統合の設定](administration-and-setup/configure-integrations/configure-aacs-integration.md)
      ...
      * [Adobe Workfront for Outlook を有効にする](administration-and-setup/configure-integrations/enable-workfront-for-outlook.md)
   ...
   * 管理と設定に関するヒント、テクニックおよびトラブルシューティング {#admin-setup-tips}
      ...
      * [履歴データを取得中](administration-and-setup/tips-tricks-and-troubleshooting/how-to-get-data-out-of-wf.md)
      ...
      * [未認証の電子メールが許可されませんでした](administration-and-setup/tips-tricks-and-troubleshooting/unauthenticated-email-not-accepted-domains-dmarc-policy.md)
...
* Adobe Workfrontの基本 {#basics}
   ...
   * Adobe Workfrontに移動 {#navigate}
      ...
      * Adobe Workfrontのリスト {#lists-in-adobe-workfront}
         ...
         * [Adobe Workfrontでのリストの概要](workfront-basics/navigate-workfront/use-lists/view-items-in-a-list.md)
   ...
   * ホーム {#home}
      ...
      * 新規ホーム {#new-home}
         ...
         * [新しいホームを使い始める](workfront-basics/using-home/new-home/get-started-with-new-home.md)
         * [新しいホームでウィジェットを追加、編集、または削除する](workfront-basics/using-home/new-home/add-edit-remove-widgets-in-new-home.md)
      * ホーム領域を使用する {#use-home-area}
         * [ホーム領域を使用する](workfront-basics/using-home/using-the-home-area/use-the-home-area.md)
         ...
         * [[ ホームカレンダー ] ビューを使用する](workfront-basics/using-home/using-the-home-area/use-home-calendar-view.md)
         * [ホームカレンダーの表示](workfront-basics/using-home/using-the-home-area/view-home-calendar.md)
         * [マイアップデート領域を使用する](workfront-basics/using-home/using-the-home-area/my-updates-area.md)
   ...
   * モバイルアプリ {#mobile-apps}
      ...
      * Adobe Workfront View を使用 {#use-workfront-view}
         ...
         * [Adobe Workfront View の基本を学ぶ](workfront-basics/mobile-apps/using-workfront-view/get-started-with-workfront-view.md)
         * [Adobe Workfront View でのプロジェクトの表示](workfront-basics/mobile-apps/using-workfront-view/display-projects-in-wokrfont-view.md)
         ...
         * [Adobe Workfront View での更新の追加](workfront-basics/mobile-apps/using-workfront-view/add-updates-in-workfront-view.md)
      * Adobe Workfront Mobile アプリのヒント、テクニックおよびトラブルシューティング {#tips-tricks-for-mobile-apps}
         ...
         * [Adobe Workfront Mobile App のエラーメッセージ：「アカウントが API 有効になっていません」](workfront-basics/mobile-apps/tips-tricks-and-troubleshooting/error-message-on-mobile-app.md)
...
* アジャイル {#agile}
   ...
   * ボードでのアジャイルプランニングツールの使用 {#agile-planning-boards}
      ...
      * [ボード上でのグループの使用](agile/use-boards-agile-planning-tools/group-cards-on-board.md)
   ...
   * アジャイルチームのかんばん {#kanban}
      ...
      * [既存のタスクまたは問題をかんばんボードに追加します](agile/use-kanban-in-an-agile-team/add-existing-tasks-or-issues-to-the-kanban-board.md)
      ...
      * [かんばんボード上のストーリーのステータスを更新します](agile/use-kanban-in-an-agile-team/update-the-status-of-stories.md)
      * [かんばんボード上のストーリーにフラグを使用します](agile/use-kanban-in-an-agile-team/use-flags-on-stories.md)
   ...
   * 機敏なチームのスクラム {#scrum}
      ...
      * スクラムボード {#scrum-board}
         ...
         * [スクラムボード上の既存のストーリーにサブタスクを追加する](agile/use-scrum-in-an-agile-team/scrum-board/add-a-subtask-to-an-existing-story-scrum.md)
...
* 作業を管理 {#manage-work}
   ...
   * Portfolio管理 {#portfolio-management}
      ...
      * Management Optimizer でのプロジェクトのPortfolio {#manage-projects-in-portfolio-optimizer}
         ...
         * [Portfolioの最適化の概要](manage-work/portfolios/portfolio-optimizer/portfolio-optimizer-overview.md)
         * [オプティマイザをPortfolio](manage-work/portfolios/portfolio-optimizer/locate-portfolio-optimizer.md)
         ...
         * [ポートフォリオ内の純価値に対するリスクを計算する](manage-work/portfolios/portfolio-optimizer/calculate-risk-to-net-value-in-portfolio.md)
   * リクエスト {#requests}
...
* 作業のレビューと承認 {#review-and-approve-work}
   ...
   * 作業承認 {#work-approvals}
      ...
      * [送信されたドキュメント承認に追加の承認者を追加する](review-and-approve-work/manage-approvals/add-approver-submitted-doc-approvals.md)
   ...
   * 校正 {#proofing}
      ...
      * Adobe Workfrontでの配達確認の確認 {#review-proofs-in-workfront}
         ...
         * 配達確認の確認 {#review-a-proof}
            ...
            * [校正ビューアから配達確認を共有する](review-and-approve-work/proofing/reviewing-proofs-within-workfront/review-a-proof/share-a-proof-in-proofing-viewer.md)
...
* Adobe Workfront目標 {#adobe-workfront-goals}
   ...
   * 目標のレビューとAdobe Workfront目標の節 {#goal-review-and-adobe-workfront-goals-sections}
      ...
      * [Adobe Workfront目標での目標の進行状況の更新](workfront-goals/goal-review-and-workfront-goals-sections/check-in-goals.md)
   ...
   * Adobe Workfront目標の設定 {#adobe-workfront-goal-settings}
...
* Adobe Workfront Fusion {#adobe-workfront-fusion}
   ...
   * Adobe Workfront Fusion のシナリオ {#scenarios-in-fusion}
      ...
      * [Adobe Workfront Fusion シナリオの例：電子メール、テキストパーサー、Googleシートの接続](workfront-fusion/scenarios/example-connect-email-text-parser-gsheets.md)
   ...
   * Workfront Fusion Apps とそのモジュール {#fusion-apps-and-modules}
      ...
      * [Analyplan モジュール](workfront-fusion/apps-and-their-modules/anaplan-modules.md)
      ...
      * [購入モジュール](workfront-fusion/apps-and-their-modules/bynder-modules.md)
      ...
      * HTTP モジュール {#fusion-http-modules}
         ...
         * [HTTP > クライアント証明書認証要求モジュールを作成する](workfront-fusion/apps-and-their-modules/http-modules/http-module-make-a-client-cert-auth-request.md)
...
* Adobe Workfront統合 {#adobe-workfront-integrations}
   ...
   * Adobe Workfront forCreative Cloud {#workfront-for-creative-cloud}
      ...
      * Adobe Workfront Plugin for InstallCreative CloudApplications {#install-wf-cc}
         * [Adobe Workfront forCreative Cloudアプリケーション](workfront-integrations-and-apps/adobe-workfront-for-creative-cloud/wf-cc-install-toc.md)
   ...
   * Adobe Workfront for Jira {#workfront-for-jira}
      ...
      * [Jira 用のAdobe Workfrontの設定](workfront-integrations-and-apps/use-workfront-with-jira/configure-workfront-for-jira.md)
   ...
   * Adobe Workfront forSlack {#workfront-for-slack}
      ...
      * [お気に入りと最近使用した項目にSlackからアクセス](workfront-integrations-and-apps/using-workfront-with-slack/access-favorites-and-recent-items-from-slack.md)
   ...
   * Adobe Workfrontとアナプラン {#workfront-with-anaplan}
      ...
      * [Anaplan リスト項目へのAdobe Workfrontプロジェクトの更新の送信](workfront-integrations-and-apps/adobe-workfront-with-anaplan/send-workfront-project-updates-to-anaplan-list-item.md)
      ...
      * [Adobe Workfrontの実際の時間更新を Anaplan リスト項目に送信する](workfront-integrations-and-apps/adobe-workfront-with-anaplan/send-workfront-project-actual-hours-updates-to-anaplan-list-item.md)
...
* Workfront プルーフ {#workfront-proof}
   ...
   * Workfront Proof での配達確認とファイルの使用 {#work-with-proofs-in-wf-proof}
      ...
      * 配達確認とファイルの共有 {#share-proofs-and-files}
         ...
         * [Workfront Proof でのファイルの共有](workfront-proof/wp-work-proofsfiles/share-proofs-and-files/share-files.md)
   ...
   * E メールアラート {#email-alerts}
      ...
      * [Workfront Proof での電子メール通知の設定](workfront-proof/wp-emailsntfctns/email-alerts/config-email-notification-settings-wp.md)
   ...
   * Workfront Proof でのユーザーと連絡先の管理 {#managing-users-in-wf-proof}
      ...
      * ユーザー {#users}
         ...
         * [Workfront配達確認を使用してアカウント間でユーザーを移動する](workfront-proof/wp-mnguserscontacts/users/move-users-between-accounts.md)
      * グループ {#groups}
...
* Adobe Workfront API {#adobe-workfront-api}
   ...
   * イベント購読 {#event-subscriptions}
      ...
      * [イベント購読用のアウトバウンドメッセージ形式](wf-api/api/message-format-event-subs.md)
