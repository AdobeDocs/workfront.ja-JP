...
* 製品に関するお知らせ {#product-announcements}
   ...
   * 製品リリース {#product-releases}
      ...
      * 2024年第 4 四半期リリース {#release-24-q4}
         ...
         * [2024 年第 4 四半期のドキュメント管理の強化](/help/quicksilver/product-announcements/product-releases/24-q4-release-activity/24-q4-document-mgmt-enhancements.md)
      ...
      * Adobe Workfront Fusion リリースアクティビティ {#fusion-release}
         ...
         * [Workfront Fusion リリースアクティビティ：2024 年 7 月 8 日の週 ](/help/quicksilver/product-announcements/product-releases/fusion-release-activity/fusion-2024-7-11.md)
...
* Adobe Workfront計画 {#adobe-workfront-planning}
   ...
   * Adobe Workfront計画フィールド {#adobe-workfront-planning-fields}
      ...
      * [フィールド設定を編集](planning/fields/edit-fields.md)
      * [フィールドの削除](planning/fields/delete-fields.md)
      * [数式フィールドの概要](planning/fields/formula-fields.md)
      * [Adobe Workfrontからのフィールドのインポート](planning/fields/import-fields-from-workfront.md)
   ...
   * Adobe Workfront計画リクエスト {#adobe-workfront-planning-requests}
      ...
      * [Adobe Workfront Planning でリクエストフォームに承認を追加する](planning/requests/add-approval-to-request-form.md)
      * [Adobe Workfront Planning でリクエストを承認する](planning/requests/approve-request.md)
...
* Adobe Workfront Fusion {#adobe-workfront-fusion}
   ...
   * Adobe Workfront Fusion の基本を学ぶ {#get-started-with-workfront-fusion}
      ...
      * [Fusion での大きなファイルの操作](/help/quicksilver/workfront-fusion/get-started/fusion-large-files.md)
   ...
   * Workfront Fusion アプリとそのモジュール {#fusion-apps-and-modules}
      ...
      * [[!DNL Draft.js] モジュール](/help/quicksilver/workfront-fusion/apps-and-their-modules/draft-js-modules.md)
