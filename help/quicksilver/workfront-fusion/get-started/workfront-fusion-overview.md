...
様々なアプリや web サービスのモジュールを、タスクを実行するシナリオに配置します。例えば、[!DNL Workfront Fusion for Work Automation and Integration] ライセンスを使用すると、1 つのアプリまたは web サービスで新しいデータを監視するシナリオを作成し、そのデータをシナリオの後続のモジュールで使用して、新規レコードの作成などの特定の結果を作成できます。シナリオを設定したら、[!DNL Workfront Fusion] タスクを自動的に実行します。
...
* シナリオについて詳しくは、[ [!DNL Adobe Workfront Fusion]](../../workfront-fusion/get-started/create-a-practice-scenario.md) でプラクティス統合シナリオを作成を参照してください。
