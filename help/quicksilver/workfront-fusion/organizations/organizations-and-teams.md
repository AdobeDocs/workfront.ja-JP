...
>
>* [Adobe Workfront Fusion の組織とチームの概要 ](https://experienceleague.adobe.com/docs/workfront-fusion/using/set-up-and-manage-fusion/set-up-and-manage-orgs-and-teams/set-up-orgs-teams-and-users/org-and-team-overview.html)
...
各組織の役割でユーザーが使用できる特定のアクションについて詳しくは、[組織とチームの役割](/help/quicksilver/workfront-fusion/organizations/organization-roles.md)を参照してください。
...
各チームの役割でユーザーが使用できる特定のアクションについて詳しくは、[組織とチームの役割](/help/quicksilver/workfront-fusion/organizations/organization-roles.md)を参照してください。
...
>[!NOTE]
>
>組織が Unified Shell に移行した場合は、アドビ通知エリアを通じて通知を受け取ります。アドビ通知エリアで通知を表示するには、Unified Shell エクスペリエンスを使用する必要があります。
>
>アドビ通知エリアを含め、Unified Shell エクスペリエンスを使用するには、ページ上部付近にある「Unified Experience で新しい Fusion UI を試す」ボタンをクリックします。このボタンは、組織が Unified Shell に移行した場合にのみ使用できます。
>
>詳しくは、[!DNL Workfront Fusion] の [!DNL Adobe Unified Experience] での[通知へのアクセス](/help/quicksilver/workfront-fusion/fusion-in-admin-console/fusion-unified-experience.md#access-your-notifications)を参照してください。
