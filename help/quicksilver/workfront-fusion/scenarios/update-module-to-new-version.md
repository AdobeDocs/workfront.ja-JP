...
title: モジュールの新しいバージョンへの更新 [!DNL Adobe Workfront Fusion] シナリオ
...
# モジュールの新しいバージョンへの更新 [!DNL Adobe Workfront Fusion] シナリオ
...
1. 「」をクリックします **アップグレードモジュール** アイコン ![アップグレードアイコン](assets/upgrade-icon.png) 新しいバージョンにアップグレードするモジュールで。
1. クリック **新しいモジュールの表示**.
