...
>
>* [HTTP > API キー認証リクエストの作成 ](https://experienceleague.adobe.com/docs/workfront-fusion/using/references/apps-and-their-modules/universal-connectors/http-module-make-an-api-key-auth-request.html)
>
>ブックマークを更新してください。
>
