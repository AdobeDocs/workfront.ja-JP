...
>
>* [HTTP > OAuth 2.0 リクエストモジュールを作成 ](https://experienceleague.adobe.com/docs/workfront-fusion/using/references/apps-and-their-modules/universal-connectors/http-module-make-an-oauth-2-request.html)
>
>ブックマークを更新してください。
>
