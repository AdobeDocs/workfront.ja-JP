...
次の手順で [!DNL Quickbase] モジュール、 [!DNL Quickbase] アカウント。

## [!DNL Quickbase] モジュールとそのフィールド

設定時に [!DNL Quickbase] モジュール、 [!DNL Workfront Fusion] に、以下のフィールドを示します。 これらと共に、 [!DNL Quickbase] アプリまたはサービスのアクセスレベルなどの要因に応じて、フィールドが表示される場合があります。 モジュール内の太字のタイトルは、必須フィールドを示します。
...
このモジュールは、使用可能な [!DNL Quickbase] RESTful API エンドポイントはで文書化されています。 [developer.quickbase.com](https://developer.quickbase.com/).
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>接続方法については、 [!DNL Quickbase] アカウント [!DNL Workfront Fusion]を参照してください。 <a href="../../workfront-fusion/connections/connect-to-fusion-general.md" class="MCXref xref" data-mc-variable-override="">Adobeへの接続を作成 [!DNL Workfront Fusion]  — 基本手順</a></p> </td> 
  </tr> 
  <tr> 
