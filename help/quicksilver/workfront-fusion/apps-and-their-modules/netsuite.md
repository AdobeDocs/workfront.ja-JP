...
次を使用するには： [!DNL NetSuite] モジュールの場合は、 [!DNL NetSuite] アカウント。



## [!DNL NetSuite] モジュールとそのフィールド

設定時に [!DNL NetSuite] モジュール、 [!DNL Workfront Fusion] に、以下のフィールドを示します。 これらと共に、 [!DNL NetSuite] アプリまたはサービスのアクセスレベルなどの要因に応じて、フィールドが表示される場合があります。 モジュール内の太字のタイトルは、必須フィールドを示します。
