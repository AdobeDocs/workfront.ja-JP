...
1. 次のいずれかの操作を行って、存在する可能性のある競合についての詳細を把握します。
   ...
   * 月別にプランを表示する場合、プランのタイムラインで月の上にマウスポインターを置くと、その月に必要なリソースと、その月の競合が人物かコスト関連なのかがを表示されます。
     ...
     ![月次タイムラインでの競合の詳細](assets/details-of-conflicts-on-monthly-plan-timeline-pop-up-350x178.png)
...
1. （オプション）イニシアチブのタイムラインの月の横にある右向き矢印をクリックすると、担当業務の競合がある月がさらに表示されます。
   ...
   ![詳細ボックス内の右向き矢印](assets/right-arrow-initiative-months-inside-details-box-highlighted-350x145.png)
...
1. 担当業務の競合を解決するには、次のいずれかを行います。
   ...
   * 「**[!UICONTROL 計画の利用可能リソースに担当業務を追加する]**」を選択し、「**[!UICONTROL 適用]**」をクリックします。
     ...
     上向きの緑の矢印![上向きの緑の矢印](assets/upward-green-arrow.png)は、プランのタイムラインに1か月にわたって表示され、その月に追加されたリソースが多いことを示します。 このインジケーターを表示するには、[!UICONTROL 月]ビューを選択する必要があります。
