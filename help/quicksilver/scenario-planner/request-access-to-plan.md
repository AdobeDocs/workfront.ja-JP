...
title: シナリオプランナーでのプランに対する権限のリクエスト
...
# [!DNL Scenario Planner] 内のプランに対する権限のリクエスト

<!--Audited: 11/2025-->

プランへのリンクが共有されている場合は、[!DNL Adobe Workfront Scenario Planner] でプランへの権限をリクエストできます。
...
## [!DNL Workfront Scenario Planner] ージ内のプランに対する権限のリクエスト
...
1. プランへのリンクをクリックします。
   ...
   ![ 計画許可の申請 ](assets/request-access-to-plan-350x277.png)
