...
title: Adobe Workfrontの項目を購読
description: Adobe Workfrontは、自分が割り当てられている項目または自分が所有している項目に関する通知を送信します。 自分に割り当てられていないが、作業に影響を与える可能性のあるアイテムについてのコミュニケーションをフォローする場合は、それらのアイテムを購読できます。
author: Lisa
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>次に、 [!DNL Workfront] 管理者が有効になっています <strong>[!UICONTROL 会話に含まれている更新のみを表示します ]</strong> アクセスレベルでは、 [!DNL Workfront].</p> <p>注意：まだアクセス権がない場合は、[!UICONTROL Workfront] 管理者に、アクセスレベルに追加の制限が設定されているかどうかを問い合わせてください。 [!UICONTROL Workfront] 管理者がアクセスレベルを変更する方法について詳しくは、 <a href="../../administration-and-setup/add-users/configure-and-grant-access/create-modify-access-levels.md" class="MCXref xref">カスタムアクセスレベルの作成または変更</a>.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader"><strong>オブジェクトの権限</strong></td> 
   <td> <p>[!UICONTROL 表示 ] プロジェクト、タスクまたは問題（購読）へのアクセス権以上</p> <p>プロジェクト、タスクまたは問題に対する [!UICONTROL Manage] アクセス権と [!UICONTROL Share] 権限（他のユーザーを購読する場合）</p> </td> 
  </tr> 
 </tbody> 
</table>
...
1. 購読する問題に移動します。
   ...
   >
   >* 購読するプロジェクトに移動し、 **[!UICONTROL 詳細]** アイコン ![](assets/qs-more-menu.png) をプロジェクト名の右側に追加し、 **[!UICONTROL 購読]**.
   >* プロジェクトリストまたはレポートに移動して、プロジェクトを選択し、 **[!UICONTROL 詳細]** アイコン ![](assets/qs-more-menu.png) リストの上部で、「 **[!UICONTROL 購読]**. これは、プロジェクトのリストでのみ使用できます。


1. クリック **[!UICONTROL 詳細]** ![](assets/more-icon.png)を選択し、「 **[!UICONTROL 購読]**.
   ...
   購読電子メールについて詳しくは、 [独自のイベント通知をアクティブ化または非アクティブ化する](../../workfront-basics/using-notifications/activate-or-deactivate-your-own-event-notifications.md).

## 項目の購読解除

次のアイテムを簡単に購読解除： [!DNL Workfront]. の項目の購読を解除するプロセス [!DNL Workfront] は、すべての項目で同一です。
...
1. 購読解除する問題に移動します。
   ...
   >
   >* 購読解除元のプロジェクトに移動し、 **[!UICONTROL 詳細]** アイコン ![](assets/qs-more-menu.png) をプロジェクト名の右側に追加し、 **[!UICONTROL 配信停止]**.
   >* プロジェクトリストまたはレポートに移動して、プロジェクトを選択し、 **[!UICONTROL 詳細]** アイコン ![](assets/qs-more-menu.png) リストの上部で、「 **[!UICONTROL 配信停止]**. これは、プロジェクトのリストでのみ使用できます。


1. クリック **[!UICONTROL 詳細]** ![](assets/more-icon.png)を選択し、「 **[!UICONTROL 配信停止]**.

   ![](assets/unsubscribe-to-a-work-item-350x258.png)

1. また、 [!UICONTROL 配信停止] 購読メール内のリンク。
...
* [別の人物をアイテムから配信停止](#unsubscribe-another-person-from-an-item)
...
1. クリック **[!UICONTROL 詳細]** ![](assets/more-icon.png).
...
が [!UICONTROL 更新] 項目の「 」タブで、購読者がアプリ内通知を受け取る。 Workfront管理者が有効にした機能に応じて、購読者は、その項目に関する電子メールおよびモバイル通知を受け取る場合もあります。
...
1. の **[!UICONTROL 購読者]** 表示されるページで、購読解除するユーザーの名前の横にある「X」をクリックします。
...
1. 購読者を表示する項目に移動します。
   ...
   ![購読者の表示](assets/bell-hover-for-list-qs-350x90.png)
...
* この [!DNL Workfront] 管理者は、ユーザーが購読できるか、登録できないかを制御できません。
