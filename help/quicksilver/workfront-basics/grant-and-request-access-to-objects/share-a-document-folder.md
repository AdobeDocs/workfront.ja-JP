...
1. フォルダーを選択し、ツールバーの共有アイコン ![共有アイコン ](assets/share-icon.png)をクリックします。
...
1. （オプション）システム内の全員がフォルダーとその内容を表示できるようにするには、共有ボックスの右上隅にある歯車アイコン ![下向き矢印](assets/gear-icon-settings-with-dn-arrow.jpg)を含む歯車アイコン設定をクリックし、**この表示可能なシステム全体を作成**&#x200B;をクリックします。
