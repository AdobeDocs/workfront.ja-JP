...
* 継承された権限をプログラムから削除できます。オブジェクトから権限を削除する方法の詳細については、「   [ オブジェクトから権限を削除](../../workfront-basics/grant-and-request-access-to-objects/remove-permissions-from-objects.md)。
...
1. 「**プログラムに**&#x200B;へのアクセス権を付与」フィールドで、プログラムを共有するユーザー、チーム、役割、グループ、会社、<span class="preview">またはビジネスプロファイル </span>の名前の入力を開始し、ドロップダウンリストに表示されたら、名前をクリックします。

   >[!TIP]
   >
   >プログラムを共有できるのは、アクティブなユーザー、チーム、役割、または会社のみです。


1. （オプション）「**アクセス可能なユーザー**」ドロップダウンを選択し、プログラムのアクセスレベルを選択します。

   * **招待されたユーザーのみがアクセスできます：** プログラムに招待されたユーザーのみがアクセスできます（デフォルト）。
   * **システム内のすべてのユーザーが表示できます**: システム内のすべてのユーザーは、招待なしでプログラムを表示できます。


1. ユーザー名の右側にあるドロップダウンをクリックし、このプログラムの権限レベルを選択します。

   * **表示**: ユーザーはプログラムをレビューして共有できます。
   * **管理**: ユーザーは、管理者権限を持たずにプログラムに完全にアクセスできます。管理者権限は、アクセスレベルで付与されます（すべての表示権限も含まれます）。

1. （オプション）付与した権限レベルの横にある「詳細オプション」アイコンをクリックして、プログラムに対する特定の権限を設定します。

   ![高度な権限オプションを設定](assets/advanced-options-icon.png)

1. （オプション）プログラムの子オブジェクトに対する継承された権限をオフにするには、**継承された権限**&#x200B;で&#x200B;**をインラインでオフにします。**

1. （オプション）リンクを使用してプログラムをすばやく共有するには、**リンクをコピー**&#x200B;をクリックし、受信者に転送します。
...
1. ユーザー名の右側にあるドロップダウンをクリックし、プログラムの権限レベルを選択します。
