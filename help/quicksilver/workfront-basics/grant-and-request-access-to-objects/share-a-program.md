...
* 継承された権限をプログラムから削除できます。オブジェクトからアクセス許可を削除する方法の詳細については、を参照してください。   [ オブジェクトから権限を削除 ](../../workfront-basics/grant-and-request-access-to-objects/remove-permissions-from-objects.md).
