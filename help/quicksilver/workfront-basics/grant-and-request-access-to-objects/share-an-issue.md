...
1. 「**課題へのアクセス権を付与**」フィールドで、課題を共有するユーザー、チーム、役割、グループ、会社、またはビジネスプロファイルの名前を入力し始め、ドロップダウンリストに表示されたら、名前をクリックします。
...
1. 「**課題へのアクセス権を付与**」フィールドで、課題を共有するユーザー、チーム、役割、グループ、会社、またはビジネスプロファイルの名前の入力を開始し、ドロップダウンリストに表示されたら、名前をクリックします。
