...
Workfront 管理者は、「設定」のアクセスレベル領域でドキュメント表示または編集できるユーザーを制御します。 詳しくは、[ドキュメントへのアクセス権を付与](../../administration-and-setup/add-users/configure-and-grant-access/grant-access-documents.md)を参照してください。

ユーザーは、アップロードしたドキュメントまたはアクセスしたを共有して、他のユーザーに表示や管理権限を与えることもできます。

* アクセス許可は個人アイテムに適用され、ユーザーが実行できるアクションを定義します。
* ドキュメントアップロードしたユーザーは、自動的にフル コントロール (アクセス許可の管理) を取得します。
* フォルダ全体を共有するには、 [ドキュメントフォルダを共有する](../../workfront-basics/grant-and-request-access-to-objects/share-a-document-folder.md)を参照してください。

>[!NOTE]
>
>Workfront インスタンス でエンタープライズストレージを使用している場合、個人ドキュメントを共有することはできませんAdobe Systems。 代わりに、プロジェクト レベルでアクセス権を付与します。 プロジェクトを共有すると、選択した権限のレベルに応じて、財務などの機密性の高いプロジェクト情報へのアクセスが許可される可能性があることに注意してください。
...
1. **ドキュメント** ページで、共有するドキュメントの上にカーソルを置き、表示される **ドキュメント詳細**&#x200B;リンクをクリックします。「 **ドキュメントの詳細** ページが開きます。

   ![ドキュメント詳細リンク](assets/document-details-link.png)

1. ドキュメント名の右側にある **詳細** アイコン ![詳細アイコン](assets/more-icon.png) をクリックし、「 **共有**」をクリックします。 **共有[ドキュメント名前]**&#x200B;ダイアログボックスが開きます。

   ![ドキュメントを共有](assets/share-a-document-350x160.png)

1. &lbrack; **ドキュメントアクセスを許可する** フィールドに、ドキュメントを共有するユーザー、チーム、役割、グループ、または会社の名前を入力し始め、ドロップダウンリストに表示される名前をクリックします。

   >[!TIP]
   >
   >ドキュメント共有できるのは、アクティブなユーザー、チーム、役割、または会社とのみです。


1. (オプション)&lbrack; **アクセス権を持つユーザー** ドロップダウンを選択し、ドキュメントのアクセス レベルを選択します。
...
1. **すべてを選択ドキュメント**&#x200B;**ページドキュメント**&#x200B;タブで、キーボードの&#x200B;**コマンド**(Mac)または&#x200B;**Ctrl**(Windows)を押したまま、共有する各ドキュメントをクリックします。
...
## エンタープライズストレージとのドキュメント共有Adobe Systems

Workfrontは、Adobe Creative Cloud製品とのより大きな接続を提供するために、Adobe Systemsエンタープライズストレージソリューションに移行しています。 既存のお客様は、段階的に新しいモデルに移行されます。 Adobe Systemsエンタープライズストレージの利点の詳細については、訪問 [Adobe Systemsエンタープライズストレージの概要](/help/quicksilver/review-and-approve-work/esm-overview.md)を参照してください。

Workfront インスタンスがAdobe エンタープライズストレージを使用している場合、個々のドキュメントを直接共有することはできません。 代わりに、プロジェクトレベルでアクセスを許可する必要があります。

>[!IMPORTANT]
>
>プロジェクトを共有すると、選択した権限レベルに応じて、財務などの機密性の高いプロジェクト情報にユーザーがアクセスできるようになる場合もあります。
>
>共有する前に権限設定を注意深く確認してください。
