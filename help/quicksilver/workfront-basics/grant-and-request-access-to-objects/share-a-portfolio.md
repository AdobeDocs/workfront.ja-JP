...
1. **ポートフォリオアクセス権を**&#x200B;に付与フィールドで、ポートフォリオを共有するユーザー、チーム、役割、グループ、会社、<span class="preview">またはビジネスプロファイル </span>の名前を入力し始め、ドロップダウンリストに表示されたら、名前をクリックします。
...
1. 「**ポートフォリオアクセス権を付与**」フィールドで、ポートフォリオを共有するユーザー、チーム、役割、グループ、会社、<span class="preview">またはビジネスプロファイル </span>の名前を入力し始め、ドロップダウンリストに表示されたら、名前をクリックします。
