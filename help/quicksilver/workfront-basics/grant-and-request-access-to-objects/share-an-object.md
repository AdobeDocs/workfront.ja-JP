...
* プランについては、[シナリオプランナーでのプランの共有](../../scenario-planner/share-a-plan.md)を参照してください。
  ...
  Workfront Scenario Plannerには、追加のライセンスが必要になる場合があります。

* 目標については、[Workfront Goalsでの目標の共有](../../workfront-goals/workfront-goals-settings/share-a-goal.md)を参照してください。

  Workfront Goalsには、追加のライセンスが必要になる場合があります。
