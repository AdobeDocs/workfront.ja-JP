---
title: AI アシスタントを使用した、プロジェクト、タスクおよびイシューの作業
...
1. 次のようなプロンプトを入力します。
   ...
   * *現在のステータスのプロジェクトを検索*
   ...
   >[!NOTE]
   >
   > AI アシスタントは、プロンプトの大きさや複雑さ、検索に必要なレコード数に応じて、情報を見つけるまでに少し時間がかかる場合があります。
1. **AI アシスタント** パネルで応答を表示します。
1. （オプション）作業項目に移動するには、**AI アシスタント** パネルのリンクをクリックします。
