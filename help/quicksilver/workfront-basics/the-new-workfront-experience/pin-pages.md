...
1. 固定するページに移動します。 プロジェクト、タスク、リクエストキューなど、任意の作業アイテムにすることができます。
...
1. 削除するピンの横にある&#x200B;**詳細** アイコン ![](assets/more-icon.png)をクリックします。
1. 「**ピンを削除**」をクリックします。 このページは、[!DNL Workfront] のどのページの上部からもアクセスできなくなります。
