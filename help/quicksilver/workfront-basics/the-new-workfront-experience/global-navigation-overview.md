...
![上部のナビゲーションバー](assets/wf-top-navigation-2026.png)
...
**[!UICONTROL メインメニュー]**&#x200B;アイコン ![メインメニュー](assets/main-menu-icon-left-nav.png) をクリックすると、[!UICONTROL メインメニュー]が開き、そこから Workfront の別のエリアに移動できます。
