...
![上部のナビゲーションバー](assets/wf-top-navigation-070626.png)
...
**[!UICONTROL お気に入り]**&#x200B;アイコン ![お気に入り](assets/favorites-icon.png) をクリックすると、お気に入りとしてマークしたシステム内のページのリストが開きます。 このメニュー内から、現在表示しているページを追加できます。
...
**[!UICONTROL 最近使用したもの]**&#x200B;アイコン ![[!UICONTROL 最近使用したもの]](assets/recents-icon.png) をクリックすると、最近アクセスしたページのリストが開きます。
