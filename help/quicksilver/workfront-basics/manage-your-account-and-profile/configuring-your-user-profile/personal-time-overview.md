...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>個人の休暇を設定するには、次の条件が必要です。</p>
        <p>標準（個人の休暇を設定する）</p>
        <p>仕事またはそれ以上（個人的な休暇を設定するため）</p> </td>
  </tr> 
  <tr> 
   <td>アクセスレベル設定</td> 
   <td><p>別のユーザーの休暇カレンダーを変更するには、そのユーザーのマネージャーであり、ユーザーの編集アクセス権を持っている必要があります。</p>
   <p><strong> メモ：</strong>管理者が別のユーザーの個人休暇カレンダーを編集した場合、すべてのエントリは管理者のタイムゾーンではなく、ユーザーのタイムゾーンに表示されます。</p></td> 
  </tr> 
 </tbody> 
</table>
...
>[!NOTE]
>
>組織がAdobe統合エクスペリエンスを利用している場合は、上部のナビゲーション領域の右上隅にある&#x200B;**Adobe** アカウントメニュー（プロフィール画像）をクリックし、**Workfront プロファイル**&#x200B;をクリックします。
>
