...
1. [!DNL Adobe Workfront]の上部ナビゲーション領域でプロフィール写真をクリックします。
1. **[!UICONTROL ログアウト]**&#x200B;をクリックします。
1. これにより、電子メールアドレスとパスワードを再入力できるログインページに戻ります。

   >[!NOTE]
   >
   >すべてのCX Enterprise アプリケーションからログアウトしています。
