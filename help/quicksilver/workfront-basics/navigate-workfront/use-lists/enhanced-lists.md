...
| <span class="preview"> 報告書の一覧 </span> | <span class="preview"> メインメニュー/レポート </span> <p><span class="preview"> 拡張リスト形式は、**共有可能なフォルダーを使用** が有効になっている場合にのみ適用されます。 詳しくは、[&#x200B; 共有可能なレポートフォルダーの使用 &#x200B;](/help/quicksilver/reports-and-dashboards/reports/report-usage/use-sharable-report-folders.md) を参照してください </span>。 |
...
1. 「表示」ドロップダウンで、コピーする **共有表示** 内の表示にポインタを合わせ、「詳細 **」メニュー** 「詳細」メニュー ![&#x200B; をクリックし、「環境設定とともにコピー &#x200B;](assets/more-icon.png)**をクリックします**。
