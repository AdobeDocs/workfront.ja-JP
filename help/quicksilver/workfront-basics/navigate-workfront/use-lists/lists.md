...
description: Adobe Workfrontのオブジェクトは、リストで表示できます。 リストにフィルター、ビュー、またはグループ化を適用して、表示される情報を変更できます。 このセクションには、リストに関する次の記事が含まれています
...
Adobe Workfrontのオブジェクトは、リストで表示できます。 リストにフィルター、ビュー、またはグループ化を適用して、表示される情報を変更できます。

このセクションには、リストに関する次の記事が含まれています。
