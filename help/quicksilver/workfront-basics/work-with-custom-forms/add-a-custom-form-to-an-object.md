...
Workflow Ultimate パッケージを使用している場合は、カスタムフォームを次の追加オブジェクトに添付できます。
...
<tr> 
 ...
 <p>リクエスト以上</p> 
  ...
  <tr> 
   ...
   <td> <p>カスタムフォームを添付するオブジェクトへの権限を管理します。</p> <p><b> カスタムデータに添付</b> オブジェクト （プロジェクト、タスク、イシュー）へのアクセス許可を持つ、カスタムフォームに対する表示以上の権限。</td> 
  </tr> 
 </tbody> 
</table>
