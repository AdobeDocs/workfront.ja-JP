...
1. 承認前にアイテムを承認または却下したり、ドキュメントに対する変更を提案したりするには、次の手順を実行します。
   ...
   1. （オプション）承認決定（**承認済み**、![変更](assets/down-arrow-blue.png)、**[!UICONTROL 却下]**）の横にある&#x200B;**[!UICONTROL ドロップダウンアイコン]** ドロップダウンアイコン **[!UICONTROL をクリックし、コメントを追加してから、]**&#x200B;追加&#x200B;**[!UICONTROL をクリックします。]**
...
1. （オプション） コメントに返信するには、**[!UICONTROL 返信]**&#x200B;をクリックし、次のいずれかの操作を行います。
   * 返信を入力してください
   * リッチテキストツールバーを使用して、テキストの書式設定、リンク、リスト、絵文字、引用符、または画像をメッセージに追加します
   * ユーザーまたはチームを追加して、返信を通知します。

     更新への返信について詳しくは、[作業の更新](/help/quicksilver/workfront-basics/updating-work-items-and-viewing-updates/update-work.md)を参照してください。
