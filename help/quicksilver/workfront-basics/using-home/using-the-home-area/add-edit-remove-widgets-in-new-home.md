...
1. ホームページに移動します。移動するには、ホームがランディングページとして設定されている場合は、画面上部の Adobe Workfront アイコン ![Adobe Workfront アイコン](assets/home-icon-30x29.png) をクリックします。あるいは、メインメニューアイコン ![メインメニューアイコン](assets/main-menu-icon.png) をクリックして「**ホーム**」をクリックします。
...
+++ 展開すると、使用可能なウィジェットの詳細なリストが表示されます
        ...
        現在選択可能な 11 のウィジェットと、表示される情報の概要は次のとおりです。
...
1. ホームページに移動します。それには、ホームがランディングページとして設定されている場合は、画面上部の Adobe Workfront アイコン ![Adobe Workfront アイコン](assets/home-icon-30x29.png) をクリックします。それ以外の場合は、メインメニューアイコン ![メインメニューアイコン](assets/main-menu-icon.png) をクリックしてから「**ホーム**」をクリックします。
...
1. ホームページに移動します。それには、ホームがランディングページとして設定されている場合は、画面上部の Adobe Workfront アイコン ![Adobe Workfrontアイコン](assets/home-icon-30x29.png) をクリックします。それ以外の場合は、メインメニューアイコン ![メインメニューアイコン](assets/main-menu-icon.png) をクリックしてから「**ホーム**」をクリックします。

1. 削除するウィジェットをホームページで見つけ、そのウィジェットの右上隅にあるその他アイコン ![その他アイコン](assets/more-icon.png) をクリックします。
