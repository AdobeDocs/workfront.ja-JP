...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 
    <ul> 
     <li> <p>[!DNL Workfront] プレビューサンドボックス環境の最新の更新をテストします。 サンドボックスのプレビュー環境について詳しくは、<a href="https://experience.workfront.com/s/article/The-Workfront-Preview-Sandbox-Environment-519456234"> サンドボックス環境のプレビュー[!DNL Adobe Workfront]を参照してください。</a></p> </li> 
     <li> <p>アップデートがどのように作業に影響を与えるかを特定します。<a href="https://experienceleague.adobe.com/ja/docs/workfront/using/home"> ナレッジベース </a>と<a href="https://experienceleague.adobe.com/ja/events"> イベント </a>がお役に立ちます。 製品マネージャーは、多くの場合、機能によって解決された直接のエンドユーザーまたはビジネス上の問題を挙げ、変更への影響を最小限に抑えるのに役立ちます。</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
