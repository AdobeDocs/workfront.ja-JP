...
Workfront モバイルアプリが[!DNL Microsoft Intune] アプリストアで利用できるようになりました。 Workfront管理者は、Intuneを通じてアプリをデバイスに割り当てることができます。

* iOS
* Android

Workfront インスタンスは、Adobe Identity Management システム（IMS）上にある必要があります。
