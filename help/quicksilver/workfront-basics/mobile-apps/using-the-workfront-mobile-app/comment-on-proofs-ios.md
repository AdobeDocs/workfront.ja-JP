...
1. 選択したコメントを削除するには、下部のツールバーで&#x200B;**[!UICONTROL 削除]** アイコン ![削除アイコン &#x200B;](assets/delete-30x28.png)を選択します。 次に、確認メッセージで「**[!UICONTROL 削除]**」をクリックして、コメントを完全に削除します。
...
1. （条件付き）シェイプを選択し、**[!UICONTROL 設定]**&#x200B;を選択してシェイプ設定を編集するか、**[!UICONTROL 削除]**&#x200B;を選択してシェイプを削除します。
