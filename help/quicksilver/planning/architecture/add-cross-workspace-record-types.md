...
1. （省略可能）新しいレコードの種類のカードにある **その他** メニュー ![ その他メニュー ](assets/more-menu.png) をクリックするか、そのページのレコードの種類の名前の右側をクリックしてから、**共有** をクリックして、同じワークスペース内の他のユーザーと共有します。
...
1. （条件付き）表示されたフィールドに **削除** と入力し、「**完全に削除**」をクリックします。
   ...
   * 同じ一元化されたレコードタイプから追加された他のすべてのレコードタイプは、ワークスペースに残ります。
