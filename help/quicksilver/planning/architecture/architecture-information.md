...
* [CSV または Excel ファイルから情報を読み込んで、レコードタイプを作成](/help/quicksilver/planning/architecture/import-file-to-create-record-types.md)
...
* [依存関係の管理](/help/quicksilver/planning/architecture/manage-dependent-connections.md)
* [レコードタイプのビジネスルールの設定](/help/quicksilver/planning/architecture/configure-business-rules.md)
