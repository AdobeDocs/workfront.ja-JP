...
* **エンタープライズ：マーケティング管理**：複雑なマーケティングシステムを持つ大規模または成熟した組織向けに設計されています。 テンプレートには、次のレコードタイプと、他のレコードタイプに接続されたフィールドを含むフィールド数が含まれます。
   ...
   * 分類：
      ...
      * **製品**: 10 フィールド
      * **成果物**: 18 フィールド
      * **ターゲットオーディエンス**: 8つのフィールド
      * **地域**: 8つのフィールド
      * **サブ領域**: 7つのフィールド
      * **パートナー**: 7つのフィールド
      * **ユースケース**: 7つのフィールド
      * **顧客ジャーニーステージ**: 3つのフィールド

* **販売管理**：販売プロセスを合理化し、効率を高める包括的な販売システムを構築できます。テンプレートには、次のレコードタイプと、他のレコードタイプに接続されたフィールドを含むフィールド数が含まれます。
...
* **製品管理**：このテンプレートを使用して、構造化された効率的な製品管理プロセスを作成できます。このテンプレートには、次のレコードタイプと、他のレコードタイプに接続されたフィールドを含むフィールド数が含まれます。
