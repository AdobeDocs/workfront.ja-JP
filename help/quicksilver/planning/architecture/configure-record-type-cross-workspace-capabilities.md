...
<p>各Workfront Planning パッケージに含まれる内容について詳しくは、Workfront アカウント担当者にお問い合わせください。 </p>
  ...
  <tr> 
   ...
   <td>
   <p>実稼動環境では、次の操作を行います。 </p>
   <p>レコードをグローバルにするには：</p>
   <ul><li>Standard 以上</li></ul>
   <p>レコードを接続可能にする手順は、次のとおりです。</p>
   <ul><li>システム管理者</li></ul>

<div class="preview">

<p>プレビュー環境で、以下を行います。</p>
   <p>レコードをグローバルにするには：</p>
   <ul><li>Standard 以上</li></ul>
   <p>レコードを接続可能にする手順は、次のとおりです。</p>

<ul><li>特定のワークスペースからレコードを接続可能にするための標準</li>
   <li>すべてのワークスペースからレコードを接続可能にするためのシステム管理者</li></ul>
   </div>
...
ユーザーは、投稿権限があり、グローバルレコードタイプが追加される任意のワークスペース（元のワークスペースを含む）からグローバルレコードタイプにレコードを追加できます。 グローバルレコードタイプのプライマリワークスペースから、表示権限のみを持つワークスペースのレコードを表示できます。
...
1. <span class="preview"> （条件付き）保有しているライセンスに応じて </span> レコードタイプにアクセスできるワークスペースを選択します。 次のオプションから選択します。

   * **すべてのワークスペース**：ユーザーは、管理権限を持つすべてのワークスペースからこのレコードタイプに接続できます。 <span class="preview"> このオプションは、Standard ライセンスを持つワークスペースマネージャーではグレー表示になっています。 システム管理者のみが、すべてのワークスペースからレコードタイプの接続を有効にできます。</span>
