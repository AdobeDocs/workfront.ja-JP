...
* バージョン 1.0 - 2024年7月にリリース

  詳しくは、この記事の「[Workfront Planning API Version 1.0](#workfront-planning-api-version-10)」の節を参照してください。
  <!--
...
## Workfront Planning API バージョン 1.0

Workfront Planning API バージョン 1.0は、2024年7月にリリースされました。

次の節では、Workfront API バージョン 1.0で使用できる機能について説明します。
