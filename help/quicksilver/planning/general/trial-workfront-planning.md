...
description: Adobe Workfrontでは現在、Adobe Workfront Planning を 60 日間無料で利用できます。 この体験版では、Planning が全体像に関する戦略と、それを実現する日常業務をどのように結び付けるかを確認する機会です。 プランニングを使用すると、マーケティングライフサイクルを一元的に把握できるので、チーム間のコラボレーション、キャンペーンのリアルタイム追跡、自動ワークフローを改善できます。 カスタムワークスペースを作成し、インタラクティブなタイムラインとカレンダーでの作業を視覚化できます。 この体験版では、Planning が日常業務と戦略目標を連携させ、実行を効率化し、組織の測定可能な結果を推進するのにどのように役立つかを実際に確認できます。
hidefromtoc: true
hide: true
...
Workfront Planning の現在のお客様は、Workfront Planning の体験版をご利用いただけません。 この体験版は、Planning をご利用のお客様ではないAdobe Workfrontのお客様がWorkfront Planning を体験し、全体像に基づく戦略とそれを実現する日々の作業を結びつける方法を確認する機会です。

Workfront Planning は、マーケティングライフサイクルを一元的に可視化し、チーム間の共同作業、キャンペーンのリアルタイムトラッキング、自動ワークフローを可能にします。 カスタムワークスペースを作成し、インタラクティブなタイムラインとカレンダーでの作業を視覚化できます。

この体験版では、Planning が日常業務と戦略目標を連携させ、実行を効率化し、組織の測定可能な結果を促進する方法を実際に確認できます。
...
* 組織のWorkfront インスタンスで使用できる署名済みの法的体験版契約
...
* **2026 年 5 月 1 日**:Workfront Planning の体験版が終了し、Planning へのアクセス権が削除されます。 Workfrontは、体験版の終了後にデータを保護します。
...
* 2026 年 3 月 2 日（PT）以降、体験版が起動したら、次の操作を行います。
   ...
   1. 契約書を確認した後、「**同意する**」をクリックします。
      ...
      * 計画領域は、自分自身と、システム内のすべてのユーザーのメインメニューに **体験版** バッジで追加されます。
      * 計画領域の「**ベストプラクティスのワークスペース**」タブへの管理アクセス権が表示されます。
      * システム内のすべてのユーザーは、計画領域の「**ベストプラクティスのワークスペース** タブへの表示アクセス権を受け取ります。
   1. （条件付き）システム管理者でない場合で、システム管理者がまだ体験版契約を受け入れていない場合は、**Workfront Planning 体験版** に関する情報を含むアプリ内バナーの手順に従い、「**詳細情報**」をクリックします。

      Workfront Planning の体験版およびWorkfront Planning について詳しくは、こちらを参照してください。
   1. （条件付き）システム管理者でない場合に、システム管理者が体験版契約を承諾したら、**Workfront Planning 体験版に関する情報を含むアプリ内のバナーに従って**&#x200B;**Planning を開く** をクリックします。
...
* 2026 年 3 月 2 日～5 月 1 日：
  ...
  **Planning 体験版** 領域の「**ベスト・プラクティス・ワークスペース**」タブで使用可能なデータに対して次の権限が付与されます。
...
* 2026 年 5 月 1 日以降：
  ...
  Workfront Planning へのアクセス権が削除され、Workfrontによってデータが保護されます。
