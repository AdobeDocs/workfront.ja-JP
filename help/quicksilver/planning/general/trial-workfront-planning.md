...
* 2026 年 1 月 26 日（PT）以降、組織のWorkfront インスタンスで使用可能な法的体験版契約に同意します。 体験版契約に同意するには、Workfront管理者である必要があります。
...
* **2026 年 3 月 2 日**:Workfrontプランニングの体験版が公開されます。

  次の項目がWorkfront インスタンスに追加されます。
