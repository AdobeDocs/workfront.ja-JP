---
title: Adobe Workfront計画の概要：記事インデックス
description: マーケティング業務のリーダーとして、Adobe Workfront Planning を使用すると、すべてのチームのマーケティングライフサイクル全体の作業を整理できます。 この節の記事では、Workfront計画に関する一般的な概念と、その導入方法に関するベストプラクティスについて説明し、現在利用可能な機能の一部を紹介します。
author: Alina
...
マーケティング業務のリーダーとして、Adobe Workfront Planning を使用すると、すべてのチームのマーケティングライフサイクル全体の作業を整理できます。 この節の記事では、Workfront計画に関する一般的な概念と、その導入方法に関するベストプラクティスについて説明し、現在利用可能な機能の一部を紹介します。
