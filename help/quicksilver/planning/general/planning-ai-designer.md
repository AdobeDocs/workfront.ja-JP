...
<p>任意のワークフローとプランニングパッケージ</p>
  ...
  <tr> 
   ...
   <td><p>標準</p> 
   <p>組織のPlanning Designerを有効にする必要があります</p>
  </td> 
  </tr> 
  <tr> 
...
1. **AIを有効にする**<!--and ensure you have a signed Gen AI Agreement with Adobe-->をオンにします。
...
* Planning Designerで実行するアクションは、組織がAI契約書に署名している場合に、Planning領域で使用する場合もAI Assistantで実行できます。
