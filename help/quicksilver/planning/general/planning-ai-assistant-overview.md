...
1. Workfrontにログインし、画面の右上隅にある&#x200B;**メインメニュー** アイコン ![ ドットメインメニュー](assets/dots-main-menu.png)、または左上隅にある&#x200B;**メインメニュー** アイコン ![行メインメニュー](assets/lines-main-menu.png)をクリックします（使用可能な場合）。

.「**計画**」をクリックします。 計画領域が開きます。
