---
title: Adobe Workfront プランニングの基本を学ぶ
description: Adobe Workfront プランニングは、Adobe Workfront の追加機能です。 完全にカスタマイズできるワークスペースを作成して、企業の各組織単位のニーズを満たすワークフローを定義できます。
author: Alina
...
ワークフローライセンスと共に購入した場合、Adobe Workfront PlanningはAdobe Workfrontの追加機能です。 Workfront プランニングの目的は、組織の運用上の詳細に関する包括的な可視性を解き放ち、作業管理ライフサイクルの各段階で重要なビジネス上の質問に答えることです。
...
## Workfront インスタンスのユーザーに対する Workfront プランニングの有効化

組織で Workfront プランニングのパッケージを購入後、ユーザーが Workfront プランニングにアクセスする前に、Workfront 管理者として次の点を確認する必要があります。

* コントリビューターまたはライトのアクセスレベルを持つユーザーに、Planningを含むレイアウトテンプレートを割り当てます。

  標準ユーザーとシステム管理者の場合、プランニングはデフォルトで有効になっています。
...
* ユーザーに、WorkfrontおよびPlanningのライセンスと、Workfront Planningでオブジェクトを表示または作成できるWorkfront Planningの権限を割り当てます。
  ...
  他のユーザーが Workfront プランニングを使用できるようにアクセス権を付与して有効にする方法について詳しくは、[Adobe Workfront プランニングへのアクセスの概要](/help/quicksilver/planning/access/access-overview.md)を参照してください。
...
## Adobe Workfront プランニングへのアクセス

アドビのプランニングにアクセスする前に、組織に Workfront プランニングへのアクセス権が付与されており、システム管理者またはグループ管理者がプランニングエリアをメインメニューに追加していることを確認してください。 詳しくは、[アドビのプランニングへのアクセスの概要](/help/quicksilver/planning/access/access-overview.md)を参照してください。

Workfront プランニングにアクセスするには、次の手順に従います。

1. Workfront にログインします。

{{step1-click-main-menu-shell-only}}

1. 「**プランニング**」![プランニングアイコン](assets/planning-icon.png) をクリックします。

   Workfront プランニングのメインページが開きます。

   ![プランニングランディングページの管理者](assets/planning-landing-page-admin.png)

   >[!TIP]
   >
   >    Workfront 管理者は、レイアウトテンプレートの「ランディングページを選択」オプションにプランニングエリアを追加できるため、Workfront にログインするとすぐにプランニングを開くことができます。 詳しくは、[レイアウトテンプレートを使用したランディングページのカスタマイズ](/help/quicksilver/administration-and-setup/customize-workfront/use-layout-templates/customize-landing-page.md)を参照してください。
...
* [Workfront Fusion の Adobe Workfront プランニングモジュール](https://experienceleague.adobe.com/ja/docs/workfront-fusion/using/references/apps-and-their-modules/adobe-connectors/workfront-planning-modules)：Adobe Workfront プランニングモジュールを使用すると、Workfront プランニングでイベントが発生した場合にシナリオをトリガーできます。 また、レコードの作成、読み取り、更新、削除、および Adobe Workfront プランニングのアカウントへのカスタム API 呼び出しも実行できます。 Workfront Fusionにアクセスするには、追加ライセンスを購入する必要があります。
