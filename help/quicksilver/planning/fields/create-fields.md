...
1. 「**デフォルトの選択肢**」フィールドで、このフィールドにデフォルトで表示する選択肢を選択します。 複数の選択肢を選択できます。 ユーザーは、このフィールドを更新する際に、デフォルトの選択肢を削除できます。
...
1. 「**デフォルトの選択肢**」フィールドで、このフィールドにデフォルトで表示する選択肢を選択します。 選べる選択肢は1つだけです。 ユーザーは、このフィールドを更新する際に、デフォルトの選択肢を削除できます。
...
1. 「**新しいフィールド**」タブで次の情報を追加します。
   ...
   * 次のオプションから選択します。
      ...
      * **24hr**：例：18:00
      * **12hr**：例：午後6:00
      * **すべてのユーザーに同じタイムゾーンを表示**&#x200B;してから、**タイムゾーン**&#x200B;を選択します。ユーザーのタイムゾーンに関係なく、フィールドを表示しているすべてのユーザーに同じタイムスタンプを表示する場合は、これを選択します。 選択したタイムゾーンがこのフィールドの列ヘッダーに追加されます。
...
1. **デフォルトユーザー**&#x200B;または&#x200B;**デフォルトユーザー** フィールドで、このフィールドにデフォルトで表示するユーザーを選択します。

   **複数の値を許可**&#x200B;設定も選択した場合は、複数のユーザーを選択できます。

   ユーザーは、このフィールドを更新する際に、デフォルトユーザーを削除できます。

   >[!TIP]
   >
   >この設定でデフォルトユーザーとして選択したユーザーを非アクティブ化すると、ユーザーの名前がデフォルトとして保持されます。 非アクティブ化されたユーザーがフィールド値から削除されることはなく、ユーザーが非アクティブ化されたことを示す他のユーザーの表示もありません。
