...
1. リスト表示のセル内をダブルクリックして、プロジェクトのフィールドを編集します。 一部のフィールドは読み取り専用です。
1. リスト表示を編集するには、次のいずれかの操作を行います。

   * テンプレートを使用せずにプロジェクトを作成するには、**新しい行**&#x200B;をクリックします。 新しいプロジェクトは、現在のレコードに自動的に接続されます。

     詳細については、[ レコードに接続する際にWorkfront PlanningからWorkfront オブジェクトを作成する](/help/quicksilver/planning/records/create-workfront-objects-from-workfront-planning.md)を参照してください。
   * ビューの右上隅にある**レコードを作成**をクリックして、既存のプロジェクトを追加します。 プロジェクトは、選択したレコードにすぐに接続されます。

   * リスト内のプロジェクト名にカーソルを合わせ、**詳細** メニュー[詳細メニュー](assets/more-menu.png)をクリックし、**表示**&#x200B;をクリックして別のタブでプロジェクトを開きます

     または

     1つ以上のプロジェクトを選択し、リストの下部にあるアクションバーから、**削除**&#x200B;または&#x200B;**切断**&#x200B;をクリックして、リストから項目を削除します。


   * ビューのドロップダウンメニューをクリックし、**新しいビュー**&#x200B;をクリックしてページの新しいビューを追加してから、次の操作を行うか、新しい名前の右側にある&#x200B;**詳細** メニュー![詳細メニュー](assets/more-menu.png)をクリックし、**名前を変更**、**共有**&#x200B;または&#x200B;**ビューを削除**&#x200B;します。

     管理権限を持たないシステムビューやビューの名前を変更、共有、削除することはできません。

     ![ プロジェクト接続レコードページのその他のメニューを表示](assets/view-more-menu-projects-connected-records-page.png)

   * 次のいずれかをクリックして、ビューの要素を更新します。

      * リスト内の情報量を制限するには、**フィルター**&#x200B;してください
      * **列**&#x200B;列を非表示にするか、順序を変更する
      * テーブル ビューの右上隅にある&#x200B;**+** アイコンを使用して、既存のフィールドをリストに追加します。 フィールドを追加する前に、フィールドが存在している必要があります。

   リスト ビューでのオブジェクトの管理について詳しくは、[ リスト ビューの管理](/help/quicksilver/planning/views/manage-the-list-view.md)を参照してください。
