...
Adobe Workfront Planningで関連性がなくなったレコードを削除できます。 削除されたレコードは、削除された後30日間復元できます。 削除されたレコードの回復について詳しくは、[削除されたレコードの回復](/help/quicksilver/planning/records/restore-deleted-records.md)を参照してください。
...
* 自分または他のユーザーが削除した削除されたレコードを復元できます。
* 削除したレコードが別のレコードにリンクされている場合、リンクされているレコードは削除されませんが、削除したレコードの情報は削除されます。
* タイムラインまたはカレンダービューからレコードを削除することはできません。
