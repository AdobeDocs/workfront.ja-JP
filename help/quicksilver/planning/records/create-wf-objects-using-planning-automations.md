...
<tr> 
   ...
   <p><span class="preview">自動処理を実行しているレコードに対する権限を管理します。</span></p>
...
* 組織で従来のWorkfrontとAdobe クラウドストレージの両方を使用している場合、Planningから自動的に作成されたアイテムは、設定領域でWorkfront管理者が選択したデフォルトストレージを使用して作成されます。
