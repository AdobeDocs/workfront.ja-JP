...
レコードタイプのリクエストフォームが作成され、「リクエスト」エリアに公開されるか、リクエストフォームへのリンクを共有した後、そのレコードタイプのレコードを作成するリクエストを送信できます。
...
Workfrontのリクエスト エリアからレコードを作成するリクエストを追加できるのは、Workfront ユーザーのみです。
