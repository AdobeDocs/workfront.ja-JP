...
1. <span class="preview"> （オプションおよび条件付き）詳細ページに表示するフィールドに応じて、次のいずれかの操作を行います。</span>
   ...
   * レコードのテーブルビューから、非表示のフィールドを含むすべてのフィールドを表示するには、**すべてのフィールドを表示**&#x200B;設定を選択します。
   * レコードのテーブルビューで非表示にされていないフィールドのみを表示するには、**すべてのフィールドを表示**&#x200B;設定の選択を解除します。 これはデフォルト設定です
   ...
   >[!TIP]
   >
   ><span class="preview">すべてのフィールドを表示&#x200B;**設定は、レコードの詳細プレビューボックスでのみ使用できます。**&#x200B;レコードの詳細ページでは使用できません。</span>
1. （オプション）接続されたレコードに移動する場合は、詳細ページの上部にあるパンくずリストでそのレコードの名前をクリックします。 <span class="preview"> パンくずリストにレコード名が表示されない場合は、**詳細**&#x200B;をクリックします。 これにより、複数の行にパンくずリストが表示されます。 **Less**&#x200B;をクリックしてパンくずリストを短くし、1行に表示します。</span>
