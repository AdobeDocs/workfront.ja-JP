...
1. <span class="preview"> （オプションおよび条件付き）プレビュー環境を使用している場合、詳細領域はデフォルトで&#x200B;**選択したテーブルビューフィールド** ビューで開きます。 これにより、テーブルビューに表示されるフィールドのみが表示されます。</span>
   ...
   >[!TIP]
   >
   > <span class="preview">選択したテーブル表示フィールド **ビューは、レコードの詳細プレビューページのテーブル表示でレコードを表示する場合にのみ使用できます。**
   >**選択したテーブルビューフィールド**&#x200B;は、他のレコードタイプビューや、ブラウザーウィンドウで開くレコードの詳細ページでは使用できません。</span>
