...
* 次のタイプのフィールドはサポートされておらず、インポートシートのフィールドにマッピングできません。
   * 接続されたレコードまたは接続されたWorkfront オブジェクトのルックアップフィールド
   * 数式フィールド
   * 作成日、作成者
   * 最終変更日、最終変更者
   * ユーザー
* 複数選択または単一選択のフィールドがインポートされ、Planning の類似のフィールドより多くの選択肢がある場合、インポート中に追加のオプションが作成されます。
...
1. **ファイルからアップロード** をクリックし、**続行** をクリックします。
...
1. （オプション）画面の左下隅にある「**不足しているオプションを作成**」を選択します。 有効にすると、単一選択フィールドと複数選択フィールドの欠落している選択肢が追加されます。

   たとえば、選択したレコード・タイプに、新規、進行中、クローズの選択肢を持つ単一選択ステータス・フィールドがあり、ファイルからインポートされたステータス・フィールドにも「保留中ステータス」選択肢がある場合、「保留中ステータス」選択肢も追加されます
...
1. 「**インポート**」をクリックします。
   ...
   * Planning に存在しない複数選択フィールドまたは単一選択フィールドの新しい選択肢。

   フィールドとレコードの管理は、レコードタイプ ページから開始できます。
