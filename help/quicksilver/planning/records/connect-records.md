...
Adobe Workfront Planning レコードを相互に接続したり、他のアプリケーションのオブジェクトに接続したりできます。 1つのレコードの情報を別のレコードに接続すると、表示できます。
...
<tr> 
  ...
  <tr> 
   ...
   <p><span class="preview">接続元のレコードに対する権限の管理</span></p>
   <p><span class="preview">接続先のレコードに対する表示権限またはそれ以上の権限</span></p>
...
レコードをAdobe Experience Manager オブジェクトに接続するには：
...
1. （条件付き）選択したレコードタイプをAEM オブジェクトに接続した後、レコードの接続されたフィールドに移動して、フィールドをクリックするか、**Connect**&#x200B;をクリックしてExperience Manager オブジェクトをレコードに追加し、**+** アイコンをクリックします。
...
1. アセットまたはコンテンツフラグメントの選択が完了したら、**選択**&#x200B;をクリックします。<!-- we might change this to Connect-->
   ...
   * リンクされたフィールド（またはルックアップフィールド）には、Experience Managerに接続されたオブジェクトからの情報が入力されます。
     ...
     Experience Manager アセットまたはコンテンツフラグメントのフィールドにある既存の情報は、リンクされたフィールドまたはルックアップフィールドに自動的に表示されます。

     PlanningのGenStudio WorkspaceのGenStudio for Performance Marketing レコードタイプをAEM オブジェクトに接続すると、AEMのキャンペーン、リージョン、ペルソナ、製品、チャネルのGenStudio情報を表示できます。

     Workfront PlanningでGenStudio Workspaceを表示するには、AEMおよびWorkfront計画ライセンスに加えて、Adobe GenStudio for Performance Marketing ライセンスが必要です。
...
1. （オプションおよび条件付き）レコードタイプのテーブルビューから、リンクされたExperience Manager アセットまたはフラグメントの列ヘッダーにカーソルを合わせてドロップダウンメニューをクリックし、**ルックアップフィールドを編集**&#x200B;をクリックします。<!--not sure if this is also possible for fragments??-->
