...
<td> 
   ...
   <ul><li><p>Adobe Experience Manager Assetsライセンスと、AEM Assetsとプランニングタイプを連携させるAEM AssetsとWorkfrontの統合。</p>
...
1. 検索ボックスにレコード名を入力していき、リストに表示されたら選択します
   ...
   * レコードタイプを接続したときにリンクされたルックアップフィールドを追加した場合、リンクされたフィールドには、リンクされたレコードからの情報が入力されます。
   ...
   >* Workfrontの先行入力フィールドをルックアップフィールドとして追加することはできません。 実稼動環境では、「プロジェクトオーナー」や「プロジェクトスポンサー」など、人物タイプのフィールドが含まれます。 <span class="preview">People-type フィールドをプレビュー環境のルックアップフィールドとして追加できます。</span>
   >
...
レコードタイプと Adobe Experience Manager Assets 間の接続を作成した後、個別のレコードを Experience Manager Assets に接続できます。Experience Managerから接続したアセットフィールドは、リンク元のレコードタイプに自動的に入力されます。
...
レコードをExperience Manager Assetsに接続するには：
...
1. （条件付き）選択したレコードタイプをExperience Managerに接続した後、レコードの接続されたフィールドに移動して、フィールドをクリックするか、**Connect**&#x200B;をクリックしてExperience Manager アセットをレコードに追加し、**+** アイコンをクリックします。
...
1. クリックすると、**Assets**&#x200B;領域から次の種類のアセットを選択できます。
...
1. 「**コンテンツフラグメント**」をクリックして、リンクされたレコードフィールドに追加するコンテンツフラグメントを選択します。
...
1. （オプション）Experience Managerにリンクしたレコードタイプに移動し、リンクされたレコードフィールドでアセットの名前をクリックします。 アセットのExperience Managerの詳細がポップアップウィンドウに表示されます。
...
1. （オプション）Experience ManagerでExperience Manager アセットのレコードページを開くには、リンク元のレコードのレコードタイプページに移動し、リンクされたレコードフィールドのアセット名をクリックしてポップアップウィンドウを開き、**AEMで開く** アイコン ![AEMでアセットを開くアイコン &#x200B;](assets/open-asset-icon.png)をクリックしてアセットを開きます。
