...
1. 検索ボックスにレコード名を入力していき、リストに表示されたら選択します
   ...
   * レコードタイプを接続したときにリンクされたルックアップフィールドを追加した場合、リンクされたフィールドには、リンクされたレコードからの情報が入力されます。
   ...
   >* Workfrontの先行入力フィールドを参照フィールドとして追加することはできません。 実稼動環境では、これには、プロジェクト所有者やプロジェクトスポンサーなどの人物タイプのフィールドが含まれます。 <span class="preview"> 人物タイプのフィールドをプレビュー環境のルックアップフィールドとして追加できます。</span>
   >
