...
>[!IMPORTANT]
>
>Adobe Experience Managerのライセンスが必要です。Workfront計画レコードをAdobe Experience Managerに接続するには、組織のWorkfront インスタンスをAdobe Business PlatformまたはAdobe Admin Consoleにオンボーディングする必要があります。
>
