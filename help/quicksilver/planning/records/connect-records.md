...
1. （条件付き）選択したレコードタイプをExperience Manager Assetsに接続した後、レコードの接続されたフィールドに移動して、フィールドをクリックするか、**Connect**&#x200B;をクリックしてExperience Manager アセットをレコードに追加し、**+** アイコンをクリックします。
   ...
   ![AEM レコード接続のアセットボックスを選択](assets/select-assets-box-for-aem-record-connections.png)
