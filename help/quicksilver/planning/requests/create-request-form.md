...
1. 任意のフィールドをクリックし、フォームの右側のパネルにあるコントロールを使用して、フィールドのサイズまたは次の情報を定義します。
   ...
   * **ロジックの追加**：フィールドを表示または非表示にするには、どの条件を満たす必要があるかを定義します。
   ...
   >   
   >
   >   次の表は、テーブルビューのフィールドタイプの名前と、レコードタイプのリクエストフォームの同じフィールドの名前を示しています。 各フィールドの形式は、テーブルビューとリクエストフォームで一致します。
   >
   >   | Workfront計画フィールドタイプ | リクエストフォームフィールドタイプ |
   >   |-------------------------------|-------------------------|
   >   | 1 行テキスト | 1 行テキスト |
   >   | 段落 | 段落 |
   >   | 通貨、数値、パーセンテージ | 1 行のテキスト （これらのフィールドの形式は、通貨、数値、パーセンテージのままです） |
   >   | 単一選択 | 単一選択 |
   >   | 複数選択 | 複数選択 |
   >   | チェックボックス | チェックボックス |
   >   | 日付 | 日付 |
