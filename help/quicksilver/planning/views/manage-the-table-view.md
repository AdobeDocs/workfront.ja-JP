...
1. （オプション）ツールバーの **フィールド** アイコン ![ フィールドアイコン ](assets/fields-icon.png) をクリックして、リスト <!--or <span class="preview"> search for a field</span>,--> でフィールドを見つけ、フィールド名の右側にある切り替えを選択解除して、フィールドを非表示にします。
