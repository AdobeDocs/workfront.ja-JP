...
1. <span class="preview"> （オプション）選択したフィールドの右側にある並べ替えドロップダウンメニューから、「A ～ Z」または「Z ～ A」を選択します。 これにより、タイムラインのグループ化が適切に並べ替えられます。</span>
...
1. アバターの横にあるドロップダウンメニューをクリックし、「**共同作業者を表示** 設定をオンにします。 この設定は、デフォルトでオンになっています。
...
1. <span class="preview"> （オプション）他のユーザーによって編集されたフィールドを含むセルの右上隅にある三角形をクリックします。 現在フィールドを編集しているユーザーのリストが表示されます。</span>

>[!TIP]
>
><span class="preview"> リアルタイムプレゼンス指標は、Workfront Planning の任意の場所で現在フィールドを編集しているユーザーを表示します。 これには、レコードのテーブル表示または詳細エリアが含まれます。</span>
