---
title: レコード ビューの削除
description: Adobe Workfront Planningで使用しなくなったレコードビューを削除できます。 この記事では、レコード ビューを削除する方法について説明します。
author: Alina
...
1. ビューのタブで、ビューのタブをクリックし、ドロップダウンメニューのビューにカーソルを合わせ、**詳細** メニュー![詳細メニュー](assets/more-menu.png)をクリックしてから、**削除**&#x200B;をクリックします。</span>

   ![その他のオプション付きメニュー](assets/more-menu-for-views-expanded-with-delete-option.png)
