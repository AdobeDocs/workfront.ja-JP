...
* GenStudio レコードタイプとAEM オブジェクトタイプ。 Adobe Experience ManagerがAEM オブジェクトにアクセスするには、Workfront PlanningおよびAdobe GenStudio for Performance Marketingのライセンスに加えて、ライセンスが必要です。
