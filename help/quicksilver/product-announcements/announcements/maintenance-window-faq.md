...
Workfrontは、混乱を可能な限り最小限に抑えることに取り組んでいます。 メンテナンスが必要な場合は、Workfront ステータスサイト（[status.adobe.com](https://status.adobe.com/ja/)）でスケジュールが通知されます。

## Workfront のメンテナンス期間は？

メンテナンスウィンドウは、通常、金曜日の午後8時から日曜日の正午の山岳時間12時までの週末に事前にスケジュールされます。

## 定期メンテナンスの前に通知を受け取ることはできますか？

Workfront ステータスサイト （[status.adobe.com](https://status.adobe.com/ja/)）に登録すると、メンテナンス計画の詳細な通知を受け取ることができます。 Workfront ステータスサイトでは、イベントの少なくとも3日前にメンテナンスを発表しています。 緊急事態が発生した場合、事前通知がイベントの 3 日前以内になることがあります。
