...
>
>* 新しいコメントエクスペリエンスベータプログラムが閉じられた後にコメントエクスペリエンス用にリリースされた機能について詳しくは、現在の製品リリースの概要ページを参照してください。
...
ベータ版の期間中にリリースされた機能とリリース日について詳しくは、 [ベータ版の期間にリリースされた機能](#features-released-during-the-beta-period) 」の節を参照してください。
...
* 2023 年第 4 四半期 (23.10) リリース（2023 年 10 月 27 日）
   ...
   * コメント作成エクスペリエンスにリリースされるすべての機能は、現在の通常の月次および四半期リリースのこの日付の部分から始まります。
* 2023 年末：
   * プロジェクト、タスク、問題、ドキュメントの各オブジェクトのセカンダリオプションとして、従来のコメントエクスペリエンスを保持します。 新しいコメントエクスペリエンスは、すべてのユーザーのデフォルトオプションです。
...
この節で説明する機能は、すべてのお客様とすべての環境で利用できるようになりました。
