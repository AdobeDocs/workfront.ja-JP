...
Scenario Plannerは、計画の俊敏性を高めるのに役立ちます。 会社の戦略的計画を有している場合でも、単一のビジネスユニット、部門またはチームの四半期計画を策定している場合でも、シナリオプランナーが役に立ちます。 予算やチームリソースなどの制約に基づいて、複数のシナリオを迅速かつ簡単に作成し比較できます。
