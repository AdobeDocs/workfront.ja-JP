...
**プレビューリリース：2025 年 1 月 23 日（PT）、実稼動リリース：発表予定**
...
**プレビューリリース：2025 年 1 月 16 日（PT）、実稼動リリース：発表予定**
...
この変更を表示するには、チーム / チームを選択/ イテレーション /イテレーションを選択に移動し、「**新しいストーリー**」または **新しいイシュー** をクリックします。
...
**プレビューリリース：2025 年 1 月 30 日（PT）、実稼動リリース：発表予定**
...
**プレビューリリース：2025 年 1 月 17 日（PT）、実稼動リリース：発表予定**
