...
このページでは、22.1 リリースに含まれる機能について説明します。 新しいAdobe Workfrontエクスペリエンスでは、すべての機能を使用できます。 一部の機能はAdobe Workfront Classic でも使用できますが、 [Workfront Classic は 2022 年 3 月に廃止されます](https://one.workfront.com/s/new-workfront-experience)。その後、まもなく 2022 年 7 月にWorkfront Classic のサポート終了日になります。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/22.1-release-activity/22-1-admin-enhancements.md#styling" class="MCXref xref" xrefformat="{para}">「カスタムForms」領域でのスタイル設定の更新</a> </p> <p>カスタムForms領域は、新しいWorkfrontエクスペリエンスの他の多くの領域と最新の状態にするための新しいルックアンドフィールを備えています。</p> </td> 
  ...
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/22.1-release-activity/22-1-admin-enhancements.md#blueprin" class="MCXref xref" xrefformat="{para}">ブループリント会社のマッピングおよびその他の機能強化</a> </p> <p>一部のブループリントに会社が含まれるようになり、ブループリントをインストールする前にカスタマイズできます。 ブループリント内の会社をWorkfrontインスタンス内の既存の会社にマッピングしたり、必要に応じて新しい会社を作成したりできます。</p> <p>ブループリントに対するその他の機能強化も利用できます。</p> </td> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td> <p><b>次の日に利用可能：</b> </p> <p>プレビューリリース： 2021 年 9 月 10 日<br></p> <p>実稼動リリース： 2021 年 11 月 9 日 <span style="color: #ff0000;">（この機能は、21.4 リリースの Cluster 4 のお客様のみが実稼動環境で使用できるようになりました。2021 年 11 月 8 日に、実稼動環境の他のすべてのクラスタで使用できるようになりました）。</span></p> <p><strong>次の環境で使用できます。</strong> </p> <p>新しいAdobe Workfrontエクスペリエンス </p> <p>Adobe Workfront Classic (<a href="https://one.workfront.com/s/new-workfront-experience" target="_blank">Workfront Classic は 2022 年 3 月に廃止されます</a>( その後、まもなく 2022 年 7 月にWorkfront Classic のサポート終了日になります )</p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
  ...
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/22.1-release-activity/22-1-admin-enhancements.md#for" class="MCXref xref" xrefformat="{para}">グループ管理者の場合：グループを削除する際に置き換えグループを簡単に選択できます。</a> </p> <p>グループを削除する場合は、[ グループの削除 ] ボックスに 2 つの改善点があり、削除したグループのユーザー、作業項目、サブグループを保持する置換グループを簡単に選択できます。</p> 
    <ul> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td><strong>次の日に利用可能：</strong> <p>プレビューリリース： 2021 年 12 月 3 日 <b style="color: #ff0000;">（統合校正機能を持つ EMEA のお客様のみ利用可能、2022 年 1 月 17 日に残りのすべてのお客様が利用可能）</b><br></p> <p>実稼動リリース： 2021 年 12 月 21 日 <b style="color: #ff0000;">（統合校正機能を持つ EMEA のお客様のみ利用可能、残りのすべてのお客様は 2022 年 2 月 3 日から利用可能）</b><br></p> <p><strong>次の環境で使用できます。</strong> </p> <p>新しいAdobe Workfrontエクスペリエンス </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   ...
   <td><strong>次の日に利用可能：</strong> <p>プレビューリリース： 2021 年 12 月 3 日 <b style="color: #ff0000;">（EMEA と米国の両方のお客様が利用可能）</b><br></p> <p>実稼動版リリース：未定 <b style="color: #ff0000;">（2021 年 12 月 21 日に EMEA でのお客様が利用可能、2022 年 2 月 3 日に残りのすべてのお客様が利用可能）</b></p> <p><strong>次の環境で使用できます。</strong> </p> <p>新しいAdobe Workfrontエクスペリエンス </p> <p>Adobe Workfront Classic (<a href="https://one.workfront.com/s/new-workfront-experience" target="_blank">Workfront Classic は 2022 年 3 月に廃止されます</a>( その後、まもなく 2022 年 7 月にWorkfront Classic のサポート終了日になります )</p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
...
Workfront Proof の新機能が使用できるようになりました。 詳しくは、 [Workfront Proof リリースアクティビティ： 2021 年 11 月 30 日の週](../../../product-announcements/product-releases/workfront-proof-release-activity/wp-release-22-1.md).
...
Workfront 22.1 リリースウェビナーは 2022 年 1 月 12 日に発表されました。 オンラインセミナーの録画は、 [Workfront One のイベントページ](https://one.workfront.com/s/event).
