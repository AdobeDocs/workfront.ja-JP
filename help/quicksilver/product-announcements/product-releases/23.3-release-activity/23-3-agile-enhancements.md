...
[この機能のデモ動画をご覧ください。](https://video.tv.adobe.com/v/3421283/){target=_blank}
...
[この機能のデモ動画をご覧ください。](https://video.tv.adobe.com/v/3420932/){target=_blank}
...
[この機能のデモ動画を見る](https://video.tv.adobe.com/v/3420832/){target=_blank}
...
[この機能のデモ動画を見る](https://video.tv.adobe.com/v/3419420/){target=_blank}
...
[この機能のデモ動画を見る](https://video.tv.adobe.com/v/3418600/){target=_blank}

## アジャイルチームのカンバンカードをボードに移行する

アジャイルチームのカンバンボードの新しい「**ボードに追加**」ボタンを使用すると、カンバンボードのすべてのカードをWorkfront ボードに追加できます。 新しい Workfront ボードを作成するか、既存のボードにカードを追加するかを選択できます。

Workfront ボードでのカードの配置は、列ポリシーに基づいています。 （例えば、ポリシーでは、ステータスが「進行中」のすべてのカードを特定の列に移動できます）。 ポリシーがない場合、またはカードがポリシーと一致しない場合、カードは一番左の列に配置されます。 現時点では、レガシーボードのバックログ列のカードは Workfront ボードに追加されません。
...
[この機能のデモ動画をご覧ください。](https://video.tv.adobe.com/v/3418598/){target=_blank}
...
[この機能のデモ動画を見る](https://video.tv.adobe.com/v/3418597/){target=_blank}
