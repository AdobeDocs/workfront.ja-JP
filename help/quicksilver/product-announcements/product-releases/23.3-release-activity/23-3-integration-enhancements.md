...
Experience Manager Assets as a Cloud Serviceのこの機能について詳しくは、[Experience Manager Assets as a Cloud Service]統合](/help/quicksilver/administration-and-setup/configure-integrations/configure-aacs-integration.md)の[!UICONTROL 設定を参照してください。
