...
このページでは、23.3 リリースで行われた管理者の機能強化について説明します。 これらの機能強化は、2023年7月20日（PT）および 2023年7月21日（PT）の 23.3 リリースで本番環境で使用可能になりました。
...
[この機能のデモ動画を見る](https://video.tv.adobe.com/v/3419111/){target=_blank}

## フォーム designer（Beta）に表示されるロジックとスキップロジックのインジケーターとルールを表示

フォームデザイナーの公開ベータ版は、2023年7月21日（PT）にプレビュー版および実稼動版で再度有効になりました。新しいフォームデザイナーには、フィールド、カンバス、フィールド設定をすべて同時に表示できる新しいカンバススタイルのワークスペースがあります。
さらに、従来のフォームビルダーで作成された表示またはスキップロジックを含むカスタムフォームをフォームデザイナーベータ版で開くと、ロジックを表示できるようになりました。
