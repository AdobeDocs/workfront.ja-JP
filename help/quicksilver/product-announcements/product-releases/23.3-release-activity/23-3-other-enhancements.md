...
このページでは、23.3 リリースで行われたその他すべての機能強化について説明します。 これらの機能強化は、2023年7月20日（PT）および 2023年7月21日（PT）の 23.3 リリースで本番環境で使用可能になりました。
...
[この機能のデモ動画を見る](https://video.tv.adobe.com/v/3420969/){target=_blank}
