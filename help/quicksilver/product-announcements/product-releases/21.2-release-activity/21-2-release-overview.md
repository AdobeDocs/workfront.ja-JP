...
title: 21.2 リリースの概要
description: 21.2 リリースは、2021年5月10日（PT）の週に、本番環境で使用可能になりました。
author: Luke
...
21.2 リリースは、2021年5月10日（PT）の週に、本番環境で使用可能になりました。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.2-release-activity/21-2-other-enhancements.md#we" class="MCXref xref" xrefformat="{para}">正式に Adobe Workfront になりました</a> </p> <p>Workfront は Adobe Workfront としてブランド変更されました。 Adobe Workfront アプリケーションと、お客様向け web サイトの最も重要な部分がアップデートされました。</p> <p>今後数週間で、この新しいブランディングが他の場所（モバイルのプルーフアプリやブラウザータブのお気に入りなど）にも反映されます。 </p> </td> 
   <td><strong>公開日：</strong> <p>Beta プレビューリリース：2021年4月27日<br></p> <p>実稼動リリース：2021年4月27日（PT）</p> <p><strong>利用可能な環境：</strong> </p> <p>新しい Adobe Workfront エクスペリエンス </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td><strong>公開日：</strong> <p>Beta プレビューリリース：2021年4月22日<br></p> <p>実稼動版リリース：21.2 リリースを使用</p> <p><strong>利用可能な環境：</strong> </p> <p>新しい Adobe Workfront エクスペリエンス </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   ...
   <td><strong>公開日：</strong> <p>Beta プレビューリリース：2021年4月22日<br></p> <p>実稼動版リリース：21.2 リリースを使用</p> <p><strong>利用可能な環境：</strong> </p> <p>新しい Adobe Workfront エクスペリエンス </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td><strong>公開日：</strong> <p>Beta プレビューリリース：2021年4月08日<br></p> <p>実稼動版リリース：21.2 リリースを使用</p> <p><strong>利用可能な環境：</strong> </p> <p>新しい Adobe Workfront エクスペリエンス </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td><strong>公開日：</strong> <p>Beta プレビューリリース：2021年2月18日<br></p> <p>実稼動版リリース：2021年3月4日（PT）</p> <p><strong>利用可能な環境：</strong> </p> <p>新しい Adobe Workfront エクスペリエンス </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   ...
   <td><strong>公開日：</strong> <p>Beta プレビューリリース：2021年2月18日<br></p> <p>実稼動版リリース：21.2 リリースを使用</p> <p><strong>利用可能な環境：</strong> </p> <p>新しい Adobe Workfront エクスペリエンス </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   ...
   <td><strong>公開日：</strong> <p>Beta プレビューリリース：2021年2月18日<br></p> <p>実稼動版リリース：21.2 リリースを使用</p> <p><strong>利用可能な環境：</strong> </p> <p>新しい Adobe Workfront エクスペリエンス </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td><strong>公開日：</strong> <p>Beta プレビューリリース：2021年1月13日 </p> <p>実稼動版リリース：21.2 リリースを使用<span class="uitext" style="color: #dc143c;">（元々は 21.1 リリースに予定されていましたが、21.2 に移行しました）</span></p> <p><strong>利用可能な環境：</strong> </p> <p>新しい Adobe Workfront エクスペリエンス </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td><strong>公開日：</strong> <p>Beta プレビューリリース：2021年4月08日<br></p> <p>実稼動版リリース：21.2 リリースを使用<span class="uitext" style="color: #dc143c;">（2021年5月20日（PT）に実稼動版から一時的に削除）</span></p> <p><strong>利用可能な環境：</strong> </p> <p>新しい Adobe Workfront エクスペリエンス </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td><strong>公開日：</strong> <p>ベータ版プレビューリリース：2021年3月11日（PT）<br></p> <p>本番リリース：21.2 リリース<span class="uitext" style="color: #dc143c;">（プレビューおよび本番環境から削除されました。この機能は 21.2 リリースではリリースされません）</span></p> <p><strong>利用可能な環境：</strong> </p> <p>新しい Adobe Workfront エクスペリエンス </p> <p>Adobe Workfront Classic </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td><strong>公開日：</strong> <p>Beta プレビューリリース：2021年4月27日<br></p> <p>実稼動リリース：2021年4月27日（PT）</p> <p><strong>利用可能な環境：</strong> </p> <p>新しい Adobe Workfront エクスペリエンス </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr data-mc-conditions=""> 
   ...
   <td><strong>公開日：</strong> <p>Beta プレビューリリース：2021年4月22日<br></p> <p>実稼動版リリース：21.3 リリースで一般に利用可能</p> <p><strong>利用可能な環境：</strong> </p> <p>新しい Adobe Workfront エクスペリエンス </p> </td> 
  </tr> 
  <tr data-mc-conditions=""> 
   <td> <p><a href="../../../product-announcements/product-releases/21.2-release-activity/21-2-other-enhancements.md#new" class="MCXref xref" xrefformat="{para}">オブジェクトヘッダーの新しいルックアンドフィール</a> </p> <p>情報の階層をさらに強化し、ユーザーがどのページにいるかをより明確に理解できるように、各オブジェクトヘッダーに以下が追加されました。</p> 
    <ul> 
     ...
     <li> <p>アップデートされたフォントスタイルとテキストサイズ</p> </li> 
...
Workfront Fusion の新機能は、21.2 リリーススケジュール以外のタイミングで実稼動環境で利用可能になります。 最新の機能について詳しくは、[Adobe Workfront Fusion リリースアクティビティ](https://experienceleague.adobe.com/ja/docs/workfront-fusion/using/fusion-release-activity/fusion-release-activity)を参照してください。
...
お客様からのフィードバックに基づき、**Workfront は、2021年3月30日（PT）にプレビュー環境から、2021年3月31日（PT）に本番環境から、この変更を削除します**。
