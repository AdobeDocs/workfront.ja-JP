---
title: 2023年第 4 四半期の財務管理の機能強化
description: 2023年第 4 四半期の財務管理の機能強化
author: Lisa
...
# 2023年第 4 四半期の財務管理の機能強化

このページでは、プレビュー環境への 2023年第 4 四半期リリースで行われたすべての財務管理の機能強化について説明します。 これらの機能強化は、23.10 リリースの本番環境で使用できるようになりました。
...
>[!NOTE]
>
>これらの機能は、2023年6月29日（PT）にプレビュー環境にリリースされました。 会社、ユーザー、担当業務の日付が有効なコストと請求率は、23.10 リリースの本番環境で利用できるようになります。 レートカードなどのその他の財務管理機能は、プレビュー版で引き続き利用でき、後日実稼動環境にリリースされます。
...
[この機能のデモ動画をご覧ください。](https://video.tv.adobe.com/v/3424915/){target=_blank}
