...
## ドキュメントの承認メールテンプレートのルックアンドフィールの更新

>[!NOTE]
>
>プレビューリリース：2023年11月1日（PT）、実稼動版リリース（すべてのお客様向け）：2023年11月1日（PT）

ドキュメントの承認通知用のメールテンプレートが更新され、他のアドビのメールテンプレートとうまく適合するようになり、明確性と操作性が向上しました。

## ワークロードバランサーで手動で調整された割り当てのインジケーター

>[!NOTE]
>
>プレビューリリース：2023年10月12日（PT）。実稼動版（迅速リリース用）：24.2 リリース（2024年2月15日（PT））に伴う。実稼動版（四半期リリース用）：24.4 リリース（2024年4月）に伴う

ワークロードバランサーでの手動調整やアウトラインをより明確にするために、手動調整された時間単位の割り当てに鉛筆アイコンが表示されるようになりました。
...
## 担当業務画面のルックアンドフィールの更新

>[!NOTE]
>
>プレビューリリース： 2023年9月21日（PT）、実稼動版リリース（すべてのお客様向け）：レートカードおよびその他の財務管理のアップデートのリリース時

新しい担当業務画面と担当業務の編集画面を、Workfront の他のエリアと一貫性のある、より最新のデザインに更新しました。
