...
このページでは、2023年第 4 四半期リリースでプレビュー環境に対して行われたすべてのプロジェクトの機能強化について説明します。 これらの機能強化は、23.10 リリースの本番環境で使用できるようになりました。
...
[この機能のデモ動画をご覧ください。](https://video.tv.adobe.com/v/3424867){target=_blank}
...
[この機能のデモ動画をご覧ください。](https://video.tv.adobe.com/v/3422678/){target=_blank}
