...
description: このページでは、2020.1 リリースで強化されたすべてのプルーフ機能について説明します。 これらの機能強化は、現在、プレビュー環境で使用でき、2020年3月下旬または 4月上旬に本番環境で使用できるようになる予定です。
author: Luke
...
このページでは、2020.1 リリースで強化されたすべてのプルーフ機能について説明します。 これらの機能強化は、現在、プレビュー環境で使用でき、2020年3月下旬または 4月上旬に本番環境で使用できるようになる予定です。
