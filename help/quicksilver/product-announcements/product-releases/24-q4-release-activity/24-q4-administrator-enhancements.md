...
>[!NOTE]
>
>プレビューリリース：2024年10月17日（PT）、すべてのユーザー向け実稼動リリース：24.10 リリース（2024年10月17日（PT））
...
>[!NOTE]
>
>プレビューリリース：2024年10月1日（PT）、すべてのユーザー向け実稼動リリース：24.10 リリース（2024年10月17日（PT））

カスタムフォームのフィールド数は 500 個に制限されています。 長いフォームでは、フォームのフィールド数や上限に達しているかどうかを把握するのは難しい場合があります。
...
## カスタムフォームデザイナーの「レイアウト」ボタンを使用すると、2列または3列のレイアウトが可能になります

>[!NOTE]
>
>~~プレビューリリース：2024年8月12日~~、高速リリース用の実稼動：N/A、四半期リリース用の実稼動：N/A
>
>_この機能はプレビューから削除されました。今後のリリースでリリースされることはありません。_
