...
>[!NOTE]
>
>プレビューリリース：2024 年 2 月 13 日（PT）、迅速なリリースの実稼動：24.5 リリース（2024 年 5 月 16 日（PT））、すべてのお客様向けの実稼動リリース：今後発表される予定です。
...
>[!NOTE]
>
>プレビューリリース：2023 年 12 月 21 日（PT）、迅速なリリースのための実稼動：24.5 リリース（2024 年 5 月 16 日（PT））、すべてのお客様向けの実稼動リリース：今後発表される予定です。
