...
このページでは、2025年第4四半期リリースのプレビュー環境に対するプロジェクトの機能強化について説明します。 これらの機能強化は、前述のように本番環境で利用できるようになります。
...
## Workfrontの計算カスタムフィールドに新しい式が追加されました

>[!NOTE]
>
>* プレビュー：2025年8月7日（PT）
>* プロダクション高速リリース：2025年8月7日（PT）
...
リスト内の割り当てに&#x200B;**詳細** ボタンが使用できるようになりました。これにより、高度な割り当てページに素早くアクセスできるようになります。 詳細な割り当てを取得するための&#x200B;**人物** アイコンは、リストの割り当てでも使用できます。

この変更は、タスクと問題の両方の割り当てに適用されます。
