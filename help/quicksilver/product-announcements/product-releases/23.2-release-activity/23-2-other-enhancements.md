...
この更新の一環として、イシューの「更新」セクションに新しいコメントエクスペリエンスが導入されます。現在のリリースでは、各ユーザーが自分の環境のベータモードでこのエクスペリエンスを有効にするために使用できる切替スイッチがあります。ベータ版の契約に同意すると、新しい「更新」セクションが表示され、現在のように、そのセクションでの作業を引き続き管理できます。
