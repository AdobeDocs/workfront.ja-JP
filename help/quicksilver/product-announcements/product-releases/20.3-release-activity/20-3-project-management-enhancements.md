...
description: このページでは、20.3 リリースで本番環境に対して行われた、プロジェクト管理に関するすべての機能強化について説明します。 これらの機能強化は、2020年8月10日（PT）の週に本番環境で利用可能になりました。
author: Luke
...
このページでは、20.3 リリースで本番環境に対して行われた、プロジェクト管理に関するすべての機能強化について説明します。 これらの機能強化は、2020年8月10日（PT）の週に本番環境で利用可能になりました。
