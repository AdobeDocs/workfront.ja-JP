...
## 管理者向けの新規：請求レコードのカスタムフォームを作成します
...
請求レコードのカスタムフォームをプロジェクトに添付する方法については、 [オブジェクトにカスタムフォームを追加する](../../../workfront-basics/work-with-custom-forms/add-a-custom-form-to-an-object.md).
