...
このページでは、プレビュー環境の 21.4 リリース（PT）で行われたリソース管理のすべての機能強化について説明します。 これらの機能強化は、2021年10月4日（PT）の週に本番環境で利用可能になる予定です。
...
>[!NOTE]
>
>フィルターの更新により、**すべての作業アイテム**&#x200B;および&#x200B;**このプロジェクトの作業アイテム**&#x200B;のプロジェクトのワークロードバランサーのビルトインのフィルターを削除しました。
