---
title: 21.4 プルーフの機能強化
description: 21.4 プルーフの機能強化
author: Luke
draft: Probably
...
このページでは、21.4 リリースでプレビュー環境に対して行われたすべてのプルーフの機能強化について説明します。 これらの機能強化は、2021年10月4日（PT）の週に本番環境で利用可能になる予定です。
...
詳しくは、[プルーフの役割の概要](../../../review-and-approve-work/proofing/proofing-overview/proof-roles.md)を参照してください。
