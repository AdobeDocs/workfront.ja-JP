...
次の機能は、現在、プレビューまたはベータ版では使用できませんが、R1 の本番環境にリリースされます。
...
ProofHQ にリリースされた機能は、本番環境にリリースする前に、プレビュー環境でテストできるようになります。

本番環境前にプレビュー環境に機能をリリースするこの新しいワークフローにより、ProofHQ 本番環境の今後のアップデートにより準備を整えることができます。
