...
description: 2016 年のプレビュー環境では、次の機能が使用可能になりました。 これらの機能は、R1 リリースで本番環境にリリースされる予定です。
author: Luke
...
2016 年のプレビュー環境では、次の機能が使用可能になりました。 これらの機能は、R1 リリースで本番環境にリリースされる予定です。
...
ユーザー割り当てオプションを有効にする方法の詳細については、「
「スケジュール領域でのユーザー割り当ての管理」。
