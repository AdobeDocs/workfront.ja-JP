...
* [モバイルおよび Outlook の機能強化](#mobile-and-outlook-enhancements)
...
* [スケジューリングタイムラインでのユーザー割り当ての管理](../../../../product-announcements/product-releases/quarterly-release-archive/r1-release-activity/available-in-preview-in-2016.md#manage-user-allocations-on-the-scheduling-timeline)
...
* [更新されたプロジェクト、タスクおよび問題の承認](../../../../product-announcements/product-releases/quarterly-release-archive/r1-release-activity/r1-preview-4.md#update-project-task-and-issue-approval)
* [個々のオブジェクトの既存のグローバル承認プロセスの変更](../../../../product-announcements/product-releases/quarterly-release-archive/r1-release-activity/r1-preview-5.md#modify-an-existing-global-approval-process-for-an-individual-object)
...
* [承認待ちの更新オブジェクトを設定](../../../../product-announcements/product-releases/quarterly-release-archive/r1-release-activity/r1-peview-1-and-2.md#configure-objects-that-are-pending-approval-to-be-updated)
* [承認ダイアグラムに、前、現在および将来の承認ステップが視覚的に表示されます](../../../../product-announcements/product-releases/quarterly-release-archive/r1-release-activity/r1-peview-1-and-2.md#approval-diagram-shows-visual-representation-of-previous-current-and-future-approval-steps)
...
* [外部ファイルをリンクする方法を改善しました](../../../../product-announcements/product-releases/quarterly-release-archive/r1-release-activity/r1-preview-3.md#improved-method-for-connecting-external-files)
...
* [複数の電子メール通知のルックアンドフィールを更新しました](../../../../product-announcements/product-releases/quarterly-release-archive/r1-release-activity/r1-peview-1-and-2.md#updated-look-and-feel-of-email-notifications)
* [ドキュメント承認電子メール通知のルックアンドフィールを更新しました](../../../../product-announcements/product-releases/quarterly-release-archive/r1-release-activity/r1-preview-3.md#updated-look-and-feel-of-email-notifications)
* [複数の通知領域に対応する新しい電子メールダイジェストオプションが追加されました。](../../../../product-announcements/product-releases/quarterly-release-archive/r1-release-activity/r1-peview-1-and-2.md#new-email-digest-options-for-several-notification-areas)
...
* [モバイルアプリのテキストをコピー](../../../../product-announcements/product-releases/quarterly-release-archive/r1-release-activity/r1-preview-4.md#copy-text-in-the-mobile-app)
...
* [モバイルアプリ (Workfront) での検索](../../../../product-announcements/product-releases/quarterly-release-archive/r1-release-activity/r1-final.md#search-in-the-mobile-app)
* [モバイルアプリのヘルプの改善：Tutorials(Workfront)](../../../../product-announcements/product-releases/quarterly-release-archive/r1-release-activity/r1-final.md#improved-help-in-the-mobile-app-tutorials)
...
* [自分の作業領域 (Workfront) で配達確認の承認を決定する](../../../../product-announcements/product-releases/quarterly-release-archive/r1-release-activity/r1-final.md#make-approval-decisions-for-proofs-from-the-my-work-area)
* [自分の作業領域内 (Workfront) の校正承認のレポート](../../../../product-announcements/product-releases/quarterly-release-archive/r1-release-activity/r1-final.md#report-on-proofing-approvals)
* [ドラッグ&amp;ドロップを使用してドキュメント配達確認の新しいバージョンを自動生成する (Workfront)](../../../../product-announcements/product-releases/quarterly-release-archive/r1-release-activity/r1-final.md#automatically-generate-a-new-version-of-a-document-proof-using-drag-and-drop)
* [すべての校正ユーザーがWorkfrontインターフェイス (Workfront) から直接 ProofHQ にアクセスできるようにします](../../../../product-announcements/product-releases/quarterly-release-archive/r1-release-activity/r1-final.md#enable-all-proofing-users-to-access-proofhq)

### ProofHQ の強化

R1 を使用した ProofHQ アプリケーションに対して、次の機能強化がリリースされています。

* [PDFドキュメントで検索 (ProofHQ)](../../../../product-announcements/product-releases/quarterly-release-archive/r1-release-activity/r1-final.md#search-in-pdf-documents)
* [更新されたグローバルナビゲーションバー (ProofHQ)](../../../../product-announcements/product-releases/quarterly-release-archive/r1-release-activity/r1-final.md#updated-global-navigation-bar):

   * 新しいユーザープロファイル画像
   * Workfrontアプリケーションへの新しいリンク (ProofHQ アカウントがWorkfrontアカウントと統合されている場合 )
   * ルックアンドフィールの更新
...
* [レポート（旧称 Analytics）(ProofHQ) の校正機能の改善](../../../../product-announcements/product-releases/quarterly-release-archive/r1-release-activity/r1-final.md#improvements-to-proofing-reports)
* [プレビュー環境での ProofHQ 機能の表示 (ProofHQ)](../../../../product-announcements/product-releases/quarterly-release-archive/r1-release-activity/r1-final.md#view-proofhq-functionality-in-the-preview-environment)
...
* [Adobe Creative Cloudとの統合](../../../../product-announcements/product-releases/quarterly-release-archive/r1-release-activity/available-in-preview-in-2016.md#adobe-creative-cloud)
* [プレビューサンドボックス環境で E メールを管理するための新しいフィールド](../../../../product-announcements/product-releases/quarterly-release-archive/r1-release-activity/r1-final.md#new-field-for-managing-emails-in-the-preview-sandbox-environment) ( どの時点でも実稼動環境に移動することは意図されていません。次の場所でのみ使用できます： **プレビュー** そして&#x200B;**カスタム更新サンドボックス**)
