...
description: このページでは、2017.2 Beta 1 リリースに関してプレビュー環境で使用できるすべての変更について説明します。 このページの機能は、2017年5月10日（PT）にプレビュー環境で使用できるようになりました。
author: Luke
...
2017.2 Beta 1 リリースには、Workfront 管理者およびその他のユーザー向けの機能強化が含まれています。
...
列を別の場所からドラッグして別の場所にドロップすることでリストの列の順序を変更する機能は、2017.2 リリースで本番環境の早期アクセスから削除され、どのユーザーも利用できなくなります。 
