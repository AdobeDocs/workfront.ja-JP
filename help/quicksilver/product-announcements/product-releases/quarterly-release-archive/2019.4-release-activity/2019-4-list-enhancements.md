...
description: このページでは、2019.4 リリースで行われたすべてのリストの機能強化について説明します。 これらの機能強化は、2019年11月11日（PT）の週に本番環境で利用可能になる予定です。
author: Luke
...
このページでは、2019.4 リリースで行われたすべてのリストの機能強化について説明します。 これらの機能強化は、2019年11月11日（PT）の週に本番環境で利用可能になる予定です。
