...
description: このページでは、2019.4 リリースで行われたすべてのリソース管理の機能強化について説明します。 2019年11月11日（PT）の週に本番環境で公開されます。
author: Luke
...
このページでは、2019.4 リリースで行われたすべてのリソース管理の機能強化について説明します。 2019年11月11日（PT）の週に本番環境で公開されます。
