...
description: 注意：2018.3 リリースは、次の日付に実稼動環境で利用できるようになりました（詳細な日付と時刻については、trust.workfront.comを参照）。
author: Luke
...
* *Workfront Proof実稼動環境 – 11月6*
* *クラスター2および4*&#x200B;のWorkfront実稼動環境
...
API バージョン 10がプレビュー環境で使用できるようになりました。これは、18.3 リリースの実稼動環境で使用できるようになります。詳しくは、[API バージョン 10](../../../../wf-api/api/new-api-version-10.md)の新機能を参照してください。 
...
JSONP （Javascript with Padding）は既知のセキュリティ脆弱性を伴う古い標準であるため、Workfrontは2018年11月をもってJSONPをサポートしなくなります。
