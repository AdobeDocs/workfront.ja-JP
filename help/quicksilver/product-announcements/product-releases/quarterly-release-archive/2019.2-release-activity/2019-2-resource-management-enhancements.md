...
description: このページでは、2019.2 リリースに含まれるすべてのリソース管理の機能強化について説明します。 この機能は、2019年5月20日の週に本番環境で使用できる予定です。
author: Luke
...
このページでは、2019.2 リリースに含まれるすべてのリソース管理の機能強化について説明します。 この機能は、2019年5月20日の週に本番環境で使用できる予定です。
...
この機能強化以前は、ポートフォリオ優先度をリソースプランナーでのみ表示でき、プランナー優先度によってのみプロジェクトを順序付けできました。
...
新しいフィールド（グループ）をビルトインのフィルター条件に追加する場合、リソースプランナーでのフィルター操作がより簡単になりました。 最も使用されるフィルターをビルトインのオプションで検索できるようになりました。
