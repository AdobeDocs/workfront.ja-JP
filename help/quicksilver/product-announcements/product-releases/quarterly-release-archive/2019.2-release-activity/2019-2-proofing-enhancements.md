...
description: このページでは、2019.2 リリースに含まれているすべてのプルーフ機能強化について説明します。 この機能は、2019年5月20日の週に本番環境で使用できる予定です。
author: Luke
...
このページでは、2019.2 リリースに含まれているすべてのプルーフ機能強化について説明します。 この機能は、2019年5月20日の週に本番環境で使用できる予定です。
...
>[!NOTE]
>
>この機能は、2019.2 プレビュー期間中に本番環境に直接リリースされました。
