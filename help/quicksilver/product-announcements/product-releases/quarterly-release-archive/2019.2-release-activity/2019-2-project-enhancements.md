...
description: このページでは、2019.2 リリースに含まれるすべてのプロジェクトの機能強化について説明します。 この機能は、2019年5月20日の週に本番環境で使用できる予定です。
author: Luke
...
このページでは、2019.2 リリースに含まれるすべてのプロジェクトの機能強化について説明します。 この機能は、2019年5月20日の週に本番環境で使用できる予定です。
...
タスクリストでは、親タスクを含む行が太字で表示されます。 この変更は、リストが作業分割構造またはタスク番号の昇順で並べ替えられたときに表示されます。
