...
description: このページでは、2019.3 リリースに含まれる機能について説明します。このページに記載の機能は、2019年8月19日（PT）の週に本番環境で使用できるようになりました。リリースが利用可能になった具体的な日時については、Workfront Trust Site を参照してください。
author: Luke
...
このページでは、2019.3 リリースに含まれる機能について説明します。このページに記載の機能は、2019年8月19日（PT）の週に本番環境で使用できるようになりました。
...
この節では、2019.3 リリース期間中に行われた変更について説明します。これらの変更点は、2019.3 の一般リリースより前に本番環境にリリースされます。
...
8月1日の午前9[時に](https://event.on24.com/eventRegistration/EventLobbyServlet?target=reg20.jsp&partnerref=Product&eventid=2040896&sessionid=1&key=EFBB434E2FDF446E010DA62D1C27E9E5&regTag=&sourcepage=register)第3四半期ロードマップ ウェビナー:00で予定されている内容について詳しくは、こちらを参照してください。 。
