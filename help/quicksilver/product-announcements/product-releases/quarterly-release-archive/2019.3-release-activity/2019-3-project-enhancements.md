...
description: このページでは、2019.3 リリースで行われたプロジェクトの機能強化に関するすべての変更について説明します。 2019年8月19日（PT）の週に、本番環境で使用できるようになりました。
author: Luke
...
このページでは、2019.3 リリースで行われたプロジェクトの機能強化に関するすべての変更について説明します。 2019年8月19日（PT）の週に、本番環境で使用できるようになりました。
