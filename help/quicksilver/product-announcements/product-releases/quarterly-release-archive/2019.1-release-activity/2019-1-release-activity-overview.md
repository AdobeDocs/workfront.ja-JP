...
API バージョン 10 がプレビュー環境で使用できるようになりました。 18.3 リリースの本番環境で使用できるようになります。 詳しくは、[API バージョン 10の新機能を参照してください。](https://support.workfront.com/hc/en-us/articles/360010455333) 
