...
現在アジャイルチームに割り当てられているタスクとイシューを、タスクまたはイシューから直接イテレーションに追加できるようになりました。
...
スクラムアジャイル手法を使用する場合、イシューはデフォルトでアジャイルチームのバックログに含まれるようになりました（カンバン手法を使用する場合、アジャイルチームのバックログにはイシューが表示されません）。
