...
* [Workfrontからのリソースの予算時間オブジェクトの削除](#remove-the-resource-budgeted-hour-object-from-workfront)
* [使用状況の統計をレポート](#report-usage-statistics)
* [ガントチャートの更新](#gantt-chart-updates)
* [新しいPortfolioの最適化](#new-portfolio-optimizer)
* [リソース・プランナの「予算日の調整」オプション](#budget-date-adjustment-option-in-the-resource-planner)
* [生産資源計画：グループ・メンバーシップに基づいて割当をユーザーに制限](#resource-scheduling-restrict-assignments-to-users-based-on-group-membership)
* [資源計画：役割に関係なくユーザーへの割当を許可](#resource-scheduling-allow-assignments-to-users-regardless-of-role)
...
クリップボードから貼り付ける機能は、以前のリリースでWorkfrontから削除されました。このリリースでは再導入中です。 この新しい方法は、より合理化され、直感的です。
...
Optimizer の詳細については、「Portfolio・オプティマイザ」を参照してください。 [Portfolioの最適化の概要](../../../../manage-work/portfolios/portfolio-optimizer/portfolio-optimizer-overview.md)
