...
description: このページでは、2018.1 Beta 1 リリースでのプレビュー環境で最近行われたすべての変更点について説明します。 このページの機能は、2017年12月1日（PT）にプレビュー環境で使用できるようになりました。 2018年3月（PT）に、本番環境で利用できるようになります。
author: Luke
...
2018.1 Beta 1 リリースには、Workfront 管理者およびその他のユーザー向けの機能強化が含まれています。
