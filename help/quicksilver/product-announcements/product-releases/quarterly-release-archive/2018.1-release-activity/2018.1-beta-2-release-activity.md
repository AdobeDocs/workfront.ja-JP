...
すべてのユーザーの計画配分全体を、リソース・プランナのグラフに使用可能性に対して表示できるようになりました。 このグラフは、 **ユーザー別に表示** （「生産資源プランナ」内）
...
新しいホーム領域の使用方法、およびマイワークとホームの機能の違いについて詳しくは、 [ホーム領域を使用する](../../../../workfront-basics/using-home/using-the-home-area/use-the-home-area.md).
