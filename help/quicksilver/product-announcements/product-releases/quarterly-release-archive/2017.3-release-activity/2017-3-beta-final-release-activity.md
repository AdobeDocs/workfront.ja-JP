...
description: このページでは、2017.3 ベータ版最終リリースでプレビュー環境で最近利用可能となったすべての変更について説明します。このページの機能は、2017年9月12日（PT）にプレビュー環境で使用できるようになりました。2017年11月初旬に、本番環境で利用可能になる予定です。
author: Luke
...
>[!NOTE]
>
>この機能は、17.3 リリースで本番環境にはリリースされません。2018年初めまでプレビュー環境に残ります。
...
アジャイルチームは、既にサポートされているスクラムアジャイル手法に加えて、Workfront内のかんばん方式を使用できるようになりました。

Workfrontのスクラムとかんばんアジャイルの手法は、次のように異なります。
...
* 他の項目が完了と同じステータスに移動されると、バックログの項目が自動的にかんばんアジャイルストーリーボードに追加されるように設定します。
...
* かんばんアジャイル ストーリーボードに表示される進行中の作業（WIP）の制限を設定します。
...
* アジャイル反復にストーリーのセットを追加し、その反復のストーリーボードを作成します。
* スクラムストーリーボードにイシューを追加できます。
* アジャイルチームのバックログに問題を含めます。
...
アジャイルチームのかんばんを有効にして設定する方法について詳しくは、[&#x200B; アジャイルチームの作成 &#x200B;](../../../../agile/get-started-with-agile-in-workfront/create-an-agile-team.md#deciding) の「アジャイル手法を決定する [&#x200B; を参照してください &#x200B;](../../../../agile/get-started-with-agile-in-workfront/create-an-agile-team.md)。

## アジャイルチームのスクラムバックログにイシューを含める {#include-issues-on-the-scrum-backlog-for-an-agile-team}

>[!NOTE]
>
>この機能は、2017年11月14日（PT）に本番環境から削除されました。デザインを強化し安定性を向上させたうえで、2018年初めにプレビュー環境に再導入される予定です。2018.1 リリースで本番環境において使用できるようになります。

スクラムアジャイル手法を使用する際に、アジャイルチームのバックログに問題を含めることができるようになりました（かんばん手法を使用する場合、アジャイルチームのバックログに問題が表示されません）。 問題を含めるには、既存のスクラムアジャイルチームがこの機能を有効にする必要があります。 イシューは、2017.3 リリース以降に作成されたスクラムアジャイルチームのバックログに自動的に含まれます。
...
アジャイルスクラムチームのバックログでイシューを使用できるようにする方法については、を参照してください  [&#x200B; スクラムを設定 &#x200B;](../../../../agile/get-started-with-agile-in-workfront/configure-scrum.md#configur5) で、作業項目を反復に追加する際の日付の適用方法を設定 [&#x200B; します &#x200B;](../../../../agile/get-started-with-agile-in-workfront/configure-scrum.md)。
...
スクラムアジャイル手法を使用する際に、ストーリーボードにイシューを含めることができるようになりました。

詳しくは、[&#x200B; スクラムを設定 &#x200B;](../../../../agile/get-started-with-agile-in-workfront/configure-scrum.md#configur2) の [&#x200B; アジャイルストーリーボードのステータス列の設定 &#x200B;](../../../../agile/get-started-with-agile-in-workfront/configure-scrum.md) を参照してください。
...
>[!NOTE]
>
>Slack 統合は現在使用できません。2017年11月に、本番環境で使用できるようになります。
