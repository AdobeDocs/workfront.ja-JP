...
現在、2017.3 リリースをプレビュー環境でテストできます。2017.3 リリースは、2017年11月に本番環境で使用できるようになる予定です。
...
Workfront 2017.3 9月プレビューリリースウェビナーは、2017年9月26日午前9:00時（MT）にWorkfront リリース対応チームによって発表されました。 このウェビナーでは、9月にプレビュー環境で利用可能になった新機能に重点を置いています。
