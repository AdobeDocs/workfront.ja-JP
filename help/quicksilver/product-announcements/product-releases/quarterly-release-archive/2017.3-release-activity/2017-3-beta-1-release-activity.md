...
description: このページでは、2017.3 リリースでプレビュー環境にて最近利用可能となったすべての変更について説明します。 このページに記載されている機能は、2017年8月9日（PT）にプレビュー環境で使用できるようになりました。 2017年11月初旬に、本番環境で利用可能になる予定です。
author: Luke
...
このページでは、2017.3 リリースでプレビュー環境にて最近利用可能となったすべての変更について説明します。 このページに記載されている機能は、2017年8月9日（PT）にプレビュー環境で使用できるようになりました。 2017年11月初旬に、本番環境で利用可能になる予定です。
