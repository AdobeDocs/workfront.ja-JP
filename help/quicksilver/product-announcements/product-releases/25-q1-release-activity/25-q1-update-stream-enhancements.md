...
## ホームおよびマイアップデート領域のメンションウィジェットのコメント機能を更新しました

>[!NOTE]
>
>プレビューリリース：2024年12月19日（PT）、Home向けのすべてのユーザー向け実稼動リリース：お知らせ予定、My Updates向けのすべてのユーザー向け実稼動リリース：2025年6月19日（PT）

ホームのメンションウィジェットとマイアップデート領域の「メンション」セクションでコメント機能を更新しています。 現在では、ほとんどのWorkfront オブジェクトの更新領域で同じエクスペリエンスをメンションウィジェットとマイアップデートの「メンション」セクションでも利用できます。

この機能強化以前は、これらの領域で従来のコメントエクスペリエンスが使用できました。

>[!NOTE]
>
>この変更により、次の機能もホームのメンションウィジェットから削除されました。
>
>* 更新を読み取りまたは未読にマークするための青い点インジケーター
>
>* メンションをエントリ時間に応じてグループ化します。
