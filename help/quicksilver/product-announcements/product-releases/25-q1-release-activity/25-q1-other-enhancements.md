...
Adobe WorkfrontとExperience Manager Assetsおよび Assets Essentials の統合を使用する際の、移動および削除されたアセットの処理方法を変更しました。

* 削除されたアセット：Assetsまたは Assets Essentials のリンクされたフォルダー内でアセットを削除すると、削除されたアセットはプロジェクトドキュメント エリアに保持されます。
