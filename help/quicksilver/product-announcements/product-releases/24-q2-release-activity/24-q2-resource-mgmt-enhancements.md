...
>[!NOTE]
>
>プレビューリリース：2023年10月12日（PT）。迅速リリース用の実稼動版：24.2 リリース（2024年2月15日（PT））。四半期リリース用の実稼動版：24.4 リリース（2024年4月11日（PT））

ワークロードバランサーの手動調整またはアウトラインをより明確にするために、手動で調整された時間単位の割り当てに鉛筆のアイコンが表示されるようになりました。
