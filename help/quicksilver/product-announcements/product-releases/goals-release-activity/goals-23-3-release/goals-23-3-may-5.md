...
description: このページでは、Adobe Workfront Goals のプレビュー環境向けの 23.3 リリースで行われたすべての機能強化について説明します。 これらの機能強化は、2023年5月1日（PT）の週に本番環境で利用可能になる予定です。
author: Courtney
...
特に指定のない限り、これらの機能強化は、23.3 リリースの本番環境で利用可能になります。

## 更新セクションの機能強化

目標の「更新」セクションの機能強化は、新しいコメント機能のベータ版エクスペリエンスにリリースされるアップデートと同時に、23.3 リリース期間内に提供されます。 これらの機能強化は、プレビューにリリース後すぐに、本番環境で利用できるようになります。
