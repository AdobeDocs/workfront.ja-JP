...
description: このページでは、2021年4月19日（PT）の週にプレビュー環境に対して Adobe Workfront Goals 21.2 リリースで行われたすべての機能強化について説明します。 これらの機能強化は、21.2 の第 1 四半期に本番環境で利用可能になる予定です。
author: Luke
...
このページでは、2021年4月19日（PT）の週にプレビュー環境に対して Adobe Workfront Goals 21.2 リリースで行われたすべての機能強化について説明します。 これらの機能強化は、21.2 の第 1 四半期に本番環境で利用可能になる予定です。
