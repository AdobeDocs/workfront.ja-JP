...
description: 2020.2 リリースは、2020年5月11日（PT）の週に、本番環境で使用可能になりました。 リリースステータスに関する最新情報については、Workfront ステータスサイトを参照してください。 このページでは、2020.2 リリースに含まれる機能について説明します。
author: Luke
...
2020.2 リリースは、2020年5月11日（PT）の週に、本番環境で使用可能になりました。
