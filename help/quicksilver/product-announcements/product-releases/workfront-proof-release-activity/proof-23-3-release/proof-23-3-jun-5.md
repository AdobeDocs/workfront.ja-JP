...
description: このページでは、Adobe Workfront Proof の 23.3 リリースでプレビュー環境に対しておこなわれたすべての機能強化について説明します。 これらの機能強化は、2023年6月5日（PT）の週に本番環境で利用可能になる予定です。
author: Courtney
...
次のOffice ファイルの種類は、プルーフとしてサポートされなくなりました。
XLT、XLTX、DOT、DOTX、POT、POTX、PPS、PPSX

ユーザーは、次のOffice ファイル形式のプルーフを引き続き作成できます。
