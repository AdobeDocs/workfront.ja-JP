...
* 組織にはWorkfront Ultimate パッケージが必要です。
  ...
  Workfront Goals は、Workfront ワークフローパッケージでは使用できません。

  現在Workfrontを更新しており、Workfront Goals を維持したい場合は、Workfront アカウント担当者にお問い合わせください。

  新規のお客様は、Workfront Goals を購入できなくなります。
...
* メインメニューに目標エリアを含むレイアウトテンプレートを割り当てます。
