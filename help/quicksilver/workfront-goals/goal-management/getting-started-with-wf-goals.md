...
| オブジェクト | 説明 |
|---|---|
| 目標 | 達成したい全体的な結果。定義した 1 つの期間に対して複数の目標を作成できます。各目標には所有者、通常は個人またはチームが割り当てられます（ただし、目標をグループに割り当てることもできます）。 目標を相互に関連付けて、複数の目標（子目標）の進捗が別の目標（親目標）の進捗にどのように影響するかを示すことができます。 |
