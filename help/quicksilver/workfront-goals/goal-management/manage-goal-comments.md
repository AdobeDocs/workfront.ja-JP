...
title: Adobe Workfront Goalsでの目標コメントの管理
...
Adobe Workfront Goalsで表示できるすべての目標にコメントを追加できます。
...
1. 左側のパネルの「**更新**」をクリックします。
   ...
   Workfront オブジェクトのコメントの管理について詳しくは、[作業の更新](/help/quicksilver/workfront-basics/updating-work-items-and-viewing-updates/update-work.md)を参照してください。
