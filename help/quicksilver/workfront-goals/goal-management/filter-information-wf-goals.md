...
title: Adobe Workfront Goalsのフィルター情報
...
<p>リクエスト以上</p></td>
 ...
 <td>
  <div>
  <p>目標に対する表示権限またはそれ以上の権限</p>
  <p>目標に対する権限を管理して編集します</p>
  </div> </td>
 </tr>
<tr>
...
1. 次のいずれかの操作を行います。
   ...
   * フィルターの名前にカーソルを合わせ、フィルター名の横にある&#x200B;**編集** アイコン ![編集アイコン ](assets/edit-icon.png)をクリックしてカスタマイズし、ユーザー、チーム、グループ、または組織名の特定の名前を追加し、リストに表示されたら選択します。
...
1. （オプションおよび条件付き）「目標の整合性」セクションで目標を表示して、フィルターした目標を表示する場合は「**表示する**」をクリックします。
   ...
   ![ フィルタリングされたアイテムにリンクを表示](assets/show-them-link-on-filtered-items-goal-list-350x109.png)

   フィルター名は、無視されていることを示すために黄色でアウトライン表示されます。

   ![黄色のアウトラインをフィルター](assets/filter-yellow-outline-next-to-reapply-filter-link-350x118.png)
