...
title: Adobe Workfront Goalsでのトラブル内の目標の確認
...
## トラブルの進展を防ぐための目標に関する推奨事項

目標が「問題あり」の状態に達する前に、その目標を頻繁に監視し、「リスクあり」の状態に達したときに進捗を調整することができます。 リスクのある目標は、トラブルになる恐れがあります。 目標の進捗状況について詳しくは、[Adobe Workfront Goalsの目標の進捗状況と条件の概要](../../workfront-goals/goal-management/calculate-goal-progress.md)を参照してください
...
目標は、Workfront Goalsの任意のセクションで確認できます。 Workfront Goals セクションについて詳しくは、[Adobe Workfront Goals セクションの概要](../../workfront-goals/goal-review-and-workfront-goals-sections/overview-of-wf-goals-sections.md)を参照してください。
...
1. 進行状況バーのインジケーターの上にポインタを合わせると、実際の進行状況の割合と、今日の期待値が表示されます。
   ...
   ![GOal進行状況のホバーの詳細](assets/goal-progress-hover-over-detail-unshimmed.png)
...
1. 目標名をクリックして目標ページを開き、左側のパネルで&#x200B;**進捗状況インジケーター**&#x200B;をクリックします。どの進行状況インジケーターが目標の遅れを引き起こしているかを表示し、進捗状況インジケーターリストの&#x200B;**実際の進行状況**&#x200B;の列で、インジケーターの進行状況をインラインでアップデートします。
   ...
   ![実際の進捗](assets/actual-progress-editable-column-in-indicator-list-unshimmed.png)
