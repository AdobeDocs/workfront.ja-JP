...
1. **メインメニュー** ![ メインメニューアイコン ](assets/main-menu-icon.png)をクリックします（シェル用にドラフトします：または、使用可能な場合は、左上隅の&#x200B;**メインメニュー** ![ メインメニューライン ](assets/three-line-main-menu-icon.png)をクリックします）。次に、**目標**&#x200B;をクリックします。
...
1. （オプション）「**検索**」アイコン「![検索アイコン ](assets/search-icon.png)」をクリックし、プロジェクト名の入力を開始して、リスト内のプロジェクトをすばやく見つけます。
