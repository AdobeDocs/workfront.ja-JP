...
* 最初から
* レコードタイプを接続する方法
* Excel ファイルおよび CSV ファイルを使用してレコードタイプを読み込む方法
* レコードタイプを作成する方法
* テンプレートからのワークスペースを作成する方法

Maestro フィールドについて詳しくは、[フィールドの概要](../fields/fields-overview.md)を参照してください。
...
1. 「**作成**」をクリックします。
   ...
   新しい段落フィールドがレコードタイプに列として追加され、その値をレコードに関連付けることができます。
...
1. 選択肢を削除するには、その選択肢の右側にある **x** アイコンをクリックします。
...
1. 「**作成**」をクリックします。
   ...
   新しいパーセンテージフィールドがレコードタイプの列として追加され、その値をレコードに関連付けることができます。
...
1. フィールド名をWorkfront Planning インタフェースに表示されるとおりに追加して、式で参照します。

   >[!NOTE]
   >
   > * 複数選択タイプのフィールドは、式に追加できません。
   >
   > * リンクされたレコードからのフィールドは、式に追加できません。この機能は後日リリースされる予定です。新しいリリースについて詳しくは、 [Adobe Workfront計画リリースアクティビティ](/help/quicksilver/maestro/release-activity.md).


1. 「**作成**」をクリックします。

   新しい式フィールドがレコードタイプに列として追加され、その値をレコードに関連付けることができます。


### ユーザー

ユーザーフィールドタイプを使用すると、レコードにユーザー <!--, job role, or team--> を追加できます。これは先行入力フィールドです。追加できるのは、既に Workfront に存在するユーザー <!--, roles, or teams--> のみです。
...
1. 「**作成**」をクリックします。
   ...
   新しいユーザータイプフィールドがレコードタイプの列として追加され、その値をレコードに関連付けることができます。
...
作成日フィールドタイプを使用して、レコードが作成された日付をレコードに追加できます。これは読み取り専用フィールドであり、レコードが作成された日付（およびオプションで時刻）が自動的に入力されます。
...
## Excel ファイルや CSV ファイルでレコードタイプを読み込むことでフィールドを作成
