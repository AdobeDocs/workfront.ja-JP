...
1. クリック **フィールドを追加** をクリックして変更を保存します。
   ...
   * リンク先のレコードタイプ上のリンクされたレコードフィールド。 リンクされたレコードタイプのリンクされたレコードフィールドの名前は、リンク元のレコードタイプの名前です。
     ...
     例えば、「Campaign」レコードタイプから「Product」レコードタイプをリンクし、「Linked Product」キャンペーンの接続済みフィールドに名前を付けた場合、「Campaign」リンク済みフィールドが「Product」レコードタイプ用に作成されます。

     <!--is the statement in the note below still accurate?? they were working on removing this from taxonomies-->

     >[!NOTE]
     >
     >リンク元のレコードの種類を表示するリンクされたレコードフィールドは、次のレコードの種類と接続するときに、レコードの種類には追加されません。 <!--is this temporary for taxonomies??-->
     >        
     >   * 分類。
     >   * 別のアプリケーションのオブジェクトタイプ。

1. （オプション）元のレコードの種類またはリンクされたレコードの種類のテーブルビューから、リンクされたレコードフィールドの右にあるドロップダウンをクリックし、次のいずれかをクリックします。
...
1. （オプション）リンクされたレコードまたはリンクされたフィールドのヘッダーにある下向き矢印をクリックし、 **削除**.

   レコードフィールドとその他の参照フィールドは削除され、フィールドとその情報は復元できません。

   >[!TIP]
   >
   >    元のレコードからリンクされたレコード上の、リンクされたレコードフィールドは削除されません。 <!-- is this still accurate?! -->
