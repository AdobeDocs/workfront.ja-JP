...
description: この記事では、Adobe Workfront Planning レコードタイプと Workfront プロジェクトオブジェクトタイプの間で接続を作成する方法について、例を説明します。また、Workfront Planning レコードを個々のプロジェクトに接続する方法についても説明します。
hidefromtoc: true
hide: true
...
1. （条件付き）前の手順で「**参照フィールドを選択**」を選択した場合は、「**製品**」レコードタイプに関連付けられたフィールドのリストから、「**予算**」フィールドの「**+**」アイコンを選択し、「**フィールドを追加**」をクリックします。これにより、「**予算（製品情報から）**」というフィールドが作成されます。これは、リンクされたフィールドの名前です。製品予算の情報は、「キャンペーン」レコードのこのフィールドに表示されます。
   ...
   >
   > 「**SUM**」でなく「**なし**」を選択した場合は、選択した製品の個々の予算がコンマ区切で表示されます。

   これにより、次のフィールドが生成されます。

   * あるキャンペーンのキャンペーンレコードテーブルビューとキャンペーンレコードページでは：

      * **製品情報**（リンクされたレコードフィールド）：製品を追加する際に、製品の名前が表示されます。
...
1. 「**選択されていないフィールド**」セクションで、プロジェクト の Workfront Planning レコードに追加するプロジェクトフィールドの **+** アイコンをクリックします。
1. 「**選択されたフィールド**」セクションで、Workfront プロジェクト Planning レコードから削除するプロジェクトフィールドの **-** アイコンをクリックします。
1. 「**保存**」をクリックします。
