...
1. サイドナビゲーションバーの&#x200B;**[!UICONTROL ストア]**&#x200B;をクリックします。

1. **[!UICONTROL すべて検索]**&#x200B;ボックスに「*[!DNL Workfront]*」と入力します。

1. **[!DNL Workfront]** カードをクリックし、ウィザードの指示に従います。
1. （推奨）**[!UICONTROL チームに追加]**&#x200B;ドロップダウンメニューからチームを選択し、「**[!UICONTROL はい]**」オプションを有効にしてアプリをチームに追加します。

   ![ms_teams_add_to_a_team_option.png](assets/ms-teams-add-to-a-team-option-350x122.png)

1. チャネルに対して、選択したチームのそのチャネルでアプリを使用するには、「**[!UICONTROL 一般]**」を選択し、必要な機能の&#x200B;**[!UICONTROL 設定]**&#x200B;をクリックします。

1. インストールが完了すると、インストールが成功したことを示す通知が、選択したチームの[!UICONTROL 一般]チャネルに表示されます。チームのメンバー全員がこの通知を見ることができます。
1. （オプション）簡単にアクセスできるように、[!DNL Workfront] アプリを固定します。

   1. [!UICONTROL 一般]チャネルのメッセージフィールドの下にある&#x200B;**[!UICONTROL その他]**&#x200B;アイコンをクリックします。

   1. リスト内の [!DNL Workfront] アプリの上にマウスを置き、その右側にある&#x200B;**[!UICONTROL その他]**&#x200B;アイコンをクリックします。

   1. **[!UICONTROL ピン]**&#x200B;をクリックします。
...
1. 「**[!UICONTROL アプリ]**」タブを選択し、画面の右下隅にある「**[!UICONTROL カスタムアプリのアップロード]**」をクリックします。
...
1. （オプション）「**[!UICONTROL ここに質問を入力してください]**」フィールドの下にある&#x200B;**[!UICONTROL その他]**（...）アイコンをクリックします。

1. （オプション）リスト内の [!DNL Workfront] アプリの上にマウスを置き、その右側にある&#x200B;**[!UICONTROL その他]**&#x200B;アイコンをクリックします。

1. （オプション）**[!UICONTROL ピン]**&#x200B;をクリックします。

   これにより、「[!UICONTROL ここに質問を入力してください]」フィールドの下に [!DNL Workfront] アイコンが追加されます。ここから[!UICONTROL 検索]エリアにすぐにアクセスできます。\
   Workfront 項目の検索の詳細については、[項目を検索して共有 [!DNL Adobe Workfront]  [!DNL Microsoft Teams]](../../workfront-integrations-and-apps/using-workfront-with-microsoft-teams/search-for-and-share-wf-items-in-ms-teams.md)を参照してください。
...
1. [!DNL Microsoft Teams] の [!DNL Workfront] ボットチャットチャネルに移動し、「**[!UICONTROL ここに質問を入力]**」フィールドに「*[!UICONTROL ログイン]*」と入力します。
...
1. 拡張認証 OAuth 2.0 または Security Assertion Markup Language（SAML）URL を使用し、画面の指示に従って、[!DNL Workfront] にログインします。
   ...
   >* 拡張認証は、[!DNL Workfront] 管理者がこの統合に対して拡張認証を有効にするまで使用できません。
