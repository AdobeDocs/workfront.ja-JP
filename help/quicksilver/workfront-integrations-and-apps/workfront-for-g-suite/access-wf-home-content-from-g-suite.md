...
title: Google Workspaceから [!DNL Adobe Workfront]  ホームコンテンツにアクセス
description: Google Workspaceを離れることなく、割り当てられたすべてのタスク、イシュー、承認、アクセス要求を含む [!DNL Adobe Workfront]  ホームコンテンツにアクセスできます。
author: Becky
