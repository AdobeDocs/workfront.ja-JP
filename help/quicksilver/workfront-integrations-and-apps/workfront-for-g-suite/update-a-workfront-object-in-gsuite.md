...
title: Google Workspaceから [!DNL Adobe Workfront]  オブジェクトを更新する
description: Google Workspaceを離れることなく、新しい更新プログラムを投稿したり、 [!DNL Adobe Workfront]  オブジェクトの既存の更新プログラムに返信したりできます。
author: Becky
