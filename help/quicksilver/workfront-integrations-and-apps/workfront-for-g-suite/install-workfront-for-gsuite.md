...
title: Google Workspaceの [!DNL Adobe Workfront] をインストール
description: Google Workspace Marketplaceから [!DNL Adobe Workfront] for Google Workspace アドオンをインストールできます。
author: Becky
