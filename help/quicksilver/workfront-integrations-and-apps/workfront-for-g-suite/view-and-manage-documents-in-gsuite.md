...
* [!DNL Workfront for Google Workspace] の「[!UICONTROL  詳細 ]」タブの使用について詳しくは、[ オブジェクトの詳細の表示と管理  [!DNL Adobe Workfront]  を参照してください  [!DNL Google Workspace]](../../workfront-integrations-and-apps/workfront-for-g-suite/view-manage-work-item-details-in-gsuite.md)。
