...
1. 条件 [!DNL Adobe Workfront for design and video] 検索結果にプラグインが表示されたら、 **[!UICONTROL 取得]**.
1. ダイアログボックスの情報を読み、 **[!UICONTROL OK]**.
1. プラグインをインストールしたら、 [!DNL Creative Cloud] 必要なアプリケーションをプラグインパネルでWorkfrontプラグインを探します。
