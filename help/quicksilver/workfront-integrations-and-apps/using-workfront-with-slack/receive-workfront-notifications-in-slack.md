...
ただし、 [!DNL Workfront] 通知 [!DNL Slack]に設定し、 [!DNL Workfront] インターフェイス。
...
事前に [!DNL Workfront] 通知 [!DNL Slack]を
...
1. デフォルトでは、すべての通知が有効になっています。\
   ...
   * [!UICONTROL 購読しているタスク、問題、またはプロジェクトが更新された]
   * [!UICONTROL 誰かが自分の作業アイテムのいずれかに対してコメントした]
   * [!UICONTROL 誰かが私の援助要請にコメントする]
...
受信し、 [!DNL Workfront] 通知 [!DNL Slack].

有効にした通知の電子メール通知を無効にできます。 [!DNL Slack]を使用して、重複する通知を受信しないようにします。\
...
有効または無効 [!DNL Workfront] 通知 [!DNL Slack] は、 [!DNL Workfront] インターフェイス。\
内の通知 [!DNL Workfront] インターフェイスを無効にすることはできません。
