...
承認は、従来のドキュメントの承認を指します。 統合ドキュメント承認は、現在 [!DNL Microsoft Teams] ではサポートされていません。 Workfrontの様々な承認システムについて詳しくは、「[&#x200B; ドキュメント承認で使用できる機能 &#x200B;](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/asset-review-and-approval.md)」を参照してください。
