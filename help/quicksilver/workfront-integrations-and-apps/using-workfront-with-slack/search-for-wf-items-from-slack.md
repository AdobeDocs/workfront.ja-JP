...
title: を検索 [!DNL Adobe Workfront] 次の項目： [!DNL Slack]
description: 以下を検索できます。 [!DNL Adobe Workfront] 次の項目： [!DNL Slack], if your instance of Slack has had the [!DNL Workfront] アプリがインストールされました。
author: Becky
...
# を検索 [!DNL Adobe Workfront] 次の項目： [!DNL Slack]

以下を検索できます。 [!DNL Adobe Workfront] 次の項目： [!DNL Slack]( [!DNL Slack] は [!DNL Workfront] アプリがインストールされました。

設定に関する詳細 [!DNL Workfront] と [!DNL Slack]を参照してください。 [設定 [!DNL Adobe Workfront] 対象 [!DNL Slack]](../../workfront-integrations-and-apps/using-workfront-with-slack/configure-workfront-for-slack.md).
...
を検索する前に [!DNL Workfront] 次の項目： [!DNL Slack]を

* 設定 [!DNL Workfront] 対象 [!DNL Slack]\
...
## を検索 [!DNL Workfront] 次の項目： [!DNL Slack]:
...
1. 表示されるフィールドで、次の中からオブジェクトタイプを選択します。
   ...
   * メモ
      ...
      一度に選択できるオブジェクトのタイプは 1 つだけです。\
      検索条件に一致する項目のリストが表示されます。

1. 項目名をクリックして開く [!DNL Workfront] をクリックします。
