...
ユーザーがプルーフにユーザーを追加し、自動ワークフローを使用して承認者の役割またはレビュー担当者と承認者の役割を付与すると、承認リクエストはホーム領域のMy Approvals ウィジェットに表示されます。 その後、プルーフを確認し、プルーフに関する承認の決定を Workfront から直接行うことができます。

マイ承認ウィジェットから承認を決定する方法について詳しくは、[作業をホーム エリアから承認](../../../review-and-approve-work/manage-approvals/approving-work.md#approving-work-from-the-home-area)または[作業を承認](../../../review-and-approve-work/manage-approvals/approving-work.md#approving-work-from-the-my-work-area)する[作業を承認](../../../review-and-approve-work/manage-approvals/approving-work.md)を参照してください。
