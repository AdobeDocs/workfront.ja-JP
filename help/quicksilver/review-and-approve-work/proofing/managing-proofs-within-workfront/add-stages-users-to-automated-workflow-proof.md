...
title: プルーフの自動ワークフローにステージとユーザーを追加
description: プルーフの所有者である場合は、既存の自動ワークフローにステージを追加できます。
author: Courtney
...
# プルーフの自動ワークフローにステージとユーザーを追加

プルーフの所有者である場合は、既存の自動ワークフローにステージを追加できます。
...
## 自動ワークフローにステージとユーザーを追加

1. ドキュメントリストで、ドキュメントにポインタを合わせ、表示されたら「**プルーフ ワークフロー**」をクリックします。
1. Adobe Workfrontの右上隅付近にある「**新規ステージ**」をクリックします。
1. 以下を指定します。
