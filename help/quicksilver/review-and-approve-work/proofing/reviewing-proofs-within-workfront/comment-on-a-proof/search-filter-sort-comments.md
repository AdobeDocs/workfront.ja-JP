   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      ...
      <td>選択したアクションに一致するコメントのみが表示されます。アクションはありません。アクションはシステムで有効にする必要があります。詳しくは、を参照してください。
      <!--
        &nbsp;
       -->
       </td>
...
1. ![&#x200B; メニューの並べ替え](assets/mceclip3.png)
