...
title: プルーフビューアーでのプルーフのダウンロード
description: 既存のプルーフからファイルをダウンロードできます。プルーフに関連付けられているコメントやその他の情報は、ダウンロードには含まれません。
author: Courtney
...
既存のプルーフからファイルをダウンロードできます。プルーフに関連付けられているコメントやその他の情報は、ダウンロードには含まれません。
...
1. プルーフビューアの左側にあるツールバーで、**ダウンロード**&#x200B;ボタンをクリックします。\
