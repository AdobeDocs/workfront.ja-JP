...
title: GenStudio for Performance MarketingとFrame.ioの連携についてさらに詳しく
description: GenStudio for Performance MarketingとFrame.ioの連携についてさらに詳しく
author: Courtney
...
* Workfrontの統合承認テンプレートを使用したレビューと承認のワークフロー
...
* Adobe Unified ExperienceでWorkfront インスタンスを有効にする必要があります。

* Workfront インスタンスでは、Adobe エンタープライズストレージが有効になっている必要があります。 詳しくは、[Adobe エンタープライズ ストレージを有効にする](/help/quicksilver/administration-and-setup/set-up-workfront/configure-system-defaults/enable-esm.md)を参照してください。


## Workfrontの統合承認テンプレートを使用して、承認ワークフローを定義します

組織のコンテンツレビュープロセスが同じ担当者によって繰り返されたり、レビューされたりする場合、統合された承認テンプレートを使用して、レビューと承認のワークフローを自動化できます。
...
Frame.io ビューアのGenStudio for Performance Marketingで、ドラフトコンテンツを直接レビューおよび承認できます。

Frame.io ビューアでは、次のことが可能です
