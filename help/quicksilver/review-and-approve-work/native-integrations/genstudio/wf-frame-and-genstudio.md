...
title: GenStudio for Performance Marketingと Frame.io の統合の概要
description: GenStudio for Performance Marketingと Frame.io の統合の概要
author: Courtney
...
# GenStudio for Performance Marketingと Frame.io の統合の概要

GenStudio for Performance Marketingと Frame.io の統合により、以下が可能になります

* Workfront統合承認テンプレートを使用したレビューワークフローと承認ワークフローの定義
...
* Workfront インスタンスでは、Adobe エンタープライズストレージが有効になっている必要があります。 詳しくは、[Adobe エンタープライズストレージの有効化 &#x200B;](/help/quicksilver/administration-and-setup/set-up-workfront/configure-system-defaults/enable-esm.md) を参照してください。


## Workfront統合承認テンプレートを使用した承認ワークフローの定義

組織のコンテンツレビュープロセスを頻繁に繰り返したり、同じ人物によってレビューされる場合は、統合承認テンプレートを使用すると、レビューと承認のワークフローを自動化できます。

### Workfrontでの統合承認テンプレートの作成
...
Frame.io ビューアのGenStudio for Performance Marketingで、ドラフトコンテンツを直接確認して承認できます。

Frame.io ビューアを使用すると、次のことができます
