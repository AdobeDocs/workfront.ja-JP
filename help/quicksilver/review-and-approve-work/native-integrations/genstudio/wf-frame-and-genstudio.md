...
* Workfront インスタンスでは、Adobe クラウドストレージが有効になっている必要があります。 詳しくは、[Adobe クラウドストレージを有効にする](/help/quicksilver/administration-and-setup/set-up-workfront/configure-system-defaults/enable-esm.md)を参照してください。
