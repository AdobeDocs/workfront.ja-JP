...
title: コンテンツレビュアーの作成
description: Workfrontで少なくとも1つのブランドを設定したら、複数のコンテンツレビュー担当者を作成して、承認テンプレートや個々のレビューおよび承認リクエストに割り当てることができます。
author: Courtney
...
Workfrontで少なくとも1つのブランドを設定したら、複数のコンテンツレビュー担当者を作成して、承認テンプレートや個々のレビューおよび承認リクエストに割り当てることができます。
...
1. 左側のパネルで、**レビューと承認** > **コンテンツレビュー担当者**&#x200B;に移動します。
1. 「**新規追加**」をクリックします。
1. レビュアーに名前を付けます。
1. **ブランド**&#x200B;を選択します。
1. 「**ガイドラインの種類**」ドロップダウンメニューで、次のいずれかを選択します。
   * **画像**: コンテンツレビュー担当者は、Workfrontで設定した画像ブランドガイドラインに照らし合わせてアセットを確認します。
   * **ブランドボイス**: コンテンツレビュー担当者は、Workfrontで設定したブランドボイスのガイドラインに照らし合わせてアセットを確認します。
1. 「**作成**」をクリックします。

   コンテンツレビュアーを作成すると、ユーザーはコンテンツレビュアーを承認テンプレートまたは個別の承認に追加できます。
