...
1. 下にスクロールして、 **承認** 「ドキュメントの概要」ペインの「 」セクションを参照してください。 承認者を追加するには、 **承認者** 「 」チェックボックスがオンになっている場合、 **レビュー担当者** テキストボックス。 Workfrontユーザーまたはチームは、名前で追加できます。 レビュー担当者を追加する場合は、「 **承認者** チェックボックスをオンにして入力します。
