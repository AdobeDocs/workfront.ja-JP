...
## 実稼動環境のドキュメントページからドキュメントのレビューまたは承認リクエストを作成します
...
1. 承認者を追加するには、**承認者**&#x200B;をクリックし、ユーザー名またはチーム名の入力を開始します。
...
## 実稼動環境のドキュメント概要パネルからドキュメントのレビューまたは承認リクエストを作成します

1. ドキュメントを含むプロジェクト、タスクまたはイシューに移動し、「**ドキュメント**」を選択します。

1. 必要なドキュメントをクリックすると、そのドキュメントのドキュメント概要の左側のパネルが開きます。
...
## レガシードキュメント領域のプレビュー環境にある概要パネルから承認ワークフローを作成します
