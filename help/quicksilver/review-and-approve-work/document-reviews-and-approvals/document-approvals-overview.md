...
* Workfrontのお客様は、V2 Workfront SKUを使用している必要があります。 お客様の組織がV2 Workfront SKUを既に使用していない場合、V2 Workfront SKUを契約に追加するには、Adobeとの契約イベントが必要です。 Adobeの担当者にお問い合わせください。
...
統一されたレビューと承認にアクセスするには、組織がV2 Workfront SKUを使用している必要があります。 V2 Workfront SKUを既に使用していない組織は、V2 Workfront SKUを追加するために、Adobeとの契約イベントを経る必要があります。 開始するには

* 現在のAdobe契約がV2 Workfront SKUに基づくかどうかを確認するには、Workfrontの担当者にお問い合わせください。

* お客様の組織がV2 Workfront SKUを使用していない場合は、アカウント担当者が追加に必要な契約イベントを案内します。

* 契約にV2 Workfront SKUが含まれると、Adobe Professional Servicesが組織の統合を設定します。
...
統一されたレビューと承認は現在利用可能です。 アクセスにはV2 Workfront SKUが必要です。 V2 Workfront SKUが利用可能になる前に契約が締結された場合、V2 Workfront SKUを追加するには、Adobeとの契約イベントが必要です。 2つのパスがあります。

* 更新時：次の契約更新日に、V2 Workfront SKUが追加されます。

* 早期リコントラクト：既存の契約終了日を維持しながら、Adobe アカウントチームが早期にリコントラクトを行い、V2 Workfront SKUの使用権限を追加することができます。 同等のパッケージに移行する際に価格の上昇はありません。
...
**V2 Workfront SKUにアップグレードすると、ストレージが増えますか？**

はい。 V2 Workfront SKUでは、ライセンスを取得した各ユーザーに60 GBのストレージが割り当てられますが、以前のバージョンでは30 GBでした。
...
V2 Workfront SKUに署名すると、すべてのWorkfront ユーザーはレビューおよび承認ワークフローのためにFrame.io ビューアにアクセスできるようになります。これには個別のFrame.io Enterprise ライセンスは必要ありません。
