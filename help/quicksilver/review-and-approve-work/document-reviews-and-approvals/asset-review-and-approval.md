...
現在、Workfrontでは、次の 3 つの異なる文書承認用システムを使用できます。
...
従来のドキュメント承認は、後日、Workfrontから削除されます。 統合承認システムは、従来のドキュメント承認に代わるように設計されています。
...
* Frame.io 統合を使用して、ドキュメントをレビューおよび承認します。 詳しくは、[Frame.io 統合の概要 ](/help/quicksilver/review-and-approve-work/native-integrations/frame-io/get-started-with-frame-integration.md) を参照してください。
