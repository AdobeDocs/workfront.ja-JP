...
### アルファリリース 4 - 2023 年 5 月

この第 4 アルファリリースでは、特定の顧客グループに対してのみ実稼動環境にローンチする前に、Workfrontヘッダー、更新ストリーム、E メールに通知を組み込んでいます。 電子メール通知は実稼動環境専用で、プレビュー環境には表示されません。 このリリースを 6 月 14 日に実稼動環境で実装したい場合は、jbarron@adobe.comまで直接お問い合わせください。
...
次を監視： [ビデオウォークスルー](https://video.tv.adobe.com/v/3417854/){target=_blank}
