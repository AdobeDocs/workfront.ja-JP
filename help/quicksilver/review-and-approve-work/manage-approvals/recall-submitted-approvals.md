...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>プロジェクト、タスク、タスク、タスク、タイムシート、ドキュメントへのアクセス権を表示または上限に設定する</p> <p>注意：まだアクセス権がない場合は、Workfront管理者に、アクセスレベルに追加の制限が設定されているかどうかを問い合わせてください。 Workfront管理者がアクセスレベルを変更する方法について詳しくは、 <a href="../../administration-and-setup/add-users/configure-and-grant-access/create-modify-access-levels.md" class="MCXref xref">カスタムアクセスレベルの作成または変更</a>.</p> </td> 
  </tr> 
  <tr> 
...
1. Adobe Analytics の **作業用リスト** 領域で、 **送信済みの承認** グループ化。
...
タスクの承認を取り消すと、承認プロセスが開始される前のステータスにタスクが戻ります。
...
1. クリック **承認を管理** をクリックします。 「承認を管理」ボックスが開きます。
