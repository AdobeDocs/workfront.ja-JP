...
* ホームエリア
   ...
   * すべてのプロジェクト、タスク、問題、タイムシート、ドキュメントおよび承認待ちのアクセスは、「すべて」または「承認」を表示するように選択すると、ホーム エリアに表示されます。
   ...
   * 関連するプロジェクト、タスクまたはイシューが、解決済み、保留中、クローズ、キャンセルとマークされると、ホーム領域から承認が削除されます。
