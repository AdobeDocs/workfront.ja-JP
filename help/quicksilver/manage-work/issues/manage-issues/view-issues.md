...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 
   <ul><li><p>コントリビューター以上</p></li> <li><p>プロジェクトの「問題」セクションで問題を表示するには、ライト以上のライセンスが必要です。</p></li>
...
1. イシューを含んだプロジェクト、タスクまたはイテレーションを開いて、左パネルの「**問題**」をクリックします。
   ...
   >[!NOTE]
   >
   >「問題」セクションのリンクの横にある番号は、セクションに記載されているオープン（未解決）問題の数を表します。


1. 開いている問題または閉じられた問題を表示するには、**フィルター** ドロップダウンメニューから、以下に示すフィルターのいずれかをクリックします。

   >[!TIP]
   >
   >フィルターのリストは、システム管理者またはグループ管理者がリストに何を表示するかを選択したかによって異なります。
   >
   >問題リストにフィルターを適用しないと、ステータスに関係なく、すべての問題が表示されます。
...
プロジェクトまたはタスクのレポートまたはリストのビューにアイコンを追加して、問題が添付されているかどうかを表示できます。
