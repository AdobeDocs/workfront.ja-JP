...
title: 問題の変換：記事インデックス
description: 課題に対して追加の作業が必要な場合は、タスクやプロジェクトなど、より大きな作業項目に変換できます。 イシューの変換について詳しくは、以下の記事を参照してください。
author: Alina
...
課題に対して追加の作業が必要な場合は、タスクやプロジェクトなど、より大きな作業項目に変換できます。 問題の変換に関する情報については、次の記事を参照してください。
...
* [問題をタスクに変換](../../../manage-work/issues/convert-issues/convert-issue-to-task.md)
