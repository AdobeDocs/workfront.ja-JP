...
1. **[!UICONTROL プログラムを追加]**&#x200B;ダイアログボックスで、プログラムの名前を入力して選択します。
1. （オプション）プログラムを追加するには、プログラムの名前を入力して選択します。
1. 「**[!UICONTROL プログラムを追加]**」をクリックします。\
   プログラムが、選択したポートフォリオの「**[!UICONTROL プログラム]**」タブに表示されます。
