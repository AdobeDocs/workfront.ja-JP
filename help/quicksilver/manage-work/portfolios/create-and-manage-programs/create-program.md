...
title: プログラムを作成
description: プログラムとは、プロジェクトの境界を越えて共通の戦略、目標、または目標を共有するプロジェクトのコレクションを表します。プログラムをポートフォリオ外に配置することはできません。
author: Alina
...
プログラムとは、プロジェクトの境界を越えて共通の戦略、目標、または目標を共有するプロジェクトのコレクションを表します。プログラムをポートフォリオ外に配置することはできません。
...
1. （オプションおよび条件付き）「**[!UICONTROL カスタムフォームを追加]**」フィールド内をクリックして、ポートフォリオからカスタムフォームを選択し、カスタムフィールドを更新します。
