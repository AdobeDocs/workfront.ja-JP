...
description: Portfolioは、Adobe Workfrontのプロジェクトまたはプログラムの集まりです。 ポートフォリオがシステムに無関係な場合は、ポートフォリオを削除または非アクティブ化できます。
author: Alina
...
ポートフォリオを削除する代わりに、将来のプロジェクトと関連付ける必要のないポートフォリオを非アクティブ化して、現在ポートフォリオとそのプログラムに関連付けられているプロジェクトの履歴情報を保持することをお勧めします。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>ポートフォリオの [!UICONTROL 管理 ] 権限 </p> <p>追加のアクセス権のリクエストについて詳しくは、 <a href="../../../workfront-basics/grant-and-request-access-to-objects/request-access.md" class="MCXref xref">オブジェクトへのアクセスのリクエスト </a>.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
ポートフォリオを削除するか非アクティブにするかを決定する際は、次の点を考慮してください。
...
* ポートフォリオを削除しても、ポートフォリオに関連付けられたプロジェクトは削除されません。
* 削除したポートフォリオを元に戻すことはできません。
* ポートフォリオを非アクティブ化すると、プロジェクトの作成時に、ポートフォリオとそのプログラムの名前をプロジェクトに割り当てることができなくなります。

## ポートフォリオの非アクティブ化

ポートフォリオを非アクティブ化しても、ポートフォリオには [!UICONTROL Portfolio] 領域に表示されることはありませんが、ユーザーがポートフォリオをプロジェクトに追加しようとしたときに、ポートフォリオのリストに表示されなくなります。
...
1. クリック **[!UICONTROL Portfolio]** .
1. ポートフォリオを選択し、「 **[!UICONTROL 削除]**&#x200B; [!UICONTROL 削除] アイコン ![](assets/delete.png).
