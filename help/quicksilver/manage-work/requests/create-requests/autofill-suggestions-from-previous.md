---
title: 以前のデータからのリクエストの自動入力
content-type: reference
description: AI を使用し、以前のリクエストのデータを使用してリクエストフィールドを自動入力できます。
author: Becky
...
AI は、以前のリクエストに基づいてリクエストフィールドを自動入力するのに役立ちます。 リクエストを送信する前に、これらの提案を承認または却下できます。
