...
ユーザーを削除すると、タスクの時間や配分率に影響を与える可能性があります。ユーザーを削除した場合にタスクに与える影響は、タスクに対して選択された期間タイプによって異なります。期間タイプについて詳しくは、[ タスク期間と期間タイプの概要 ](../../../manage-work/tasks/taskdurtn/task-duration-and-duration-type.md) を参照してください。

次の期間タイプでタスクからユーザーを削除した場合：
