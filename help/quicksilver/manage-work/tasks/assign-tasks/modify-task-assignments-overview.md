...
この記事の一部の情報は、問題への割り当てにも当てはまります。 問題の割り当てとその他の考慮事項について詳しくは、 [問題の割り当ての変更の概要](../../../manage-work/issues/manage-issues/modify-issue-assignments-overview.md).
...
* 特定の役割またはユーザーが複数のタスクの担当者に設定されているので、別のユーザーまたは役割に割り当てられるすべての項目をすばやく変更する必要があります
