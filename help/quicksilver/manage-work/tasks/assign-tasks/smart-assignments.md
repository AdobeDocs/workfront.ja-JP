...
タスクやイシューの割り当てを管理する際に、スマート割り当てを使用して、作業を完了するのに最適なリソースを特定できます。
...
* 提案された割り当ては、常にアクティブユーザー、担当業務、チームです。
* 最初にリストされるリソースは、タスクに最適である必要があります。
...
* 「割り当て」列のタスクリストまたはレポート
  ...
  ![&#x200B; タスクリスト割り当て列](assets/smart-assignments-task-list.png)

* 「割り当て」フィールドのタスクヘッダー

  ![&#x200B; タスクヘッダーの割り当てフィールド &#x200B;](assets/smart-assignments-task-header-nwe-350x302.png)

* 「割り当て」フィールドのイシューヘッダー

  ![問題ヘッダーの割り当てフィールド &#x200B;](assets/smart-assignments-issue-header.png)

* 割り当てエリアのタスクまたはイシューの概要パネル

  ![概要パネル割り当て領域](assets/issue-assignments-summary-panel.png)
...
* タスクまたはイシューを割り当てる際のこの割り当て先エリアのワークロードバランサー
  ...
  ![&#x200B; ワークロードバランサーの割り当て領域](assets/smart-assignments-workload-balancer-bulk-assignments.png)
...
Workfrontでは、課題の割り当てを計算するのと同じように、タスクのスマート割り当てを計算します。
...
特定された割り当ては、割り当てフィールドの&#x200B;**ユーザーとチーム**&#x200B;および&#x200B;**ジョブロール**<!--, and <span class="preview">**Rate card roles**</span>--> セクションに一覧表示されます。
