...
履歴情報（更新、スケジュールの変更、ステータス、その他のフィールド）を持つタスクの場合は、それらを削除するのではなく、それらを閉じるか、死者としてマークすることをお勧めします。 これにより、プロジェクトの履歴情報を保持できます。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>タスクとプロジェクトへのアクセス権と削除権限の編集</p></td> 
  </tr> 
  <tr> 
