...
1. （条件付き）新しいエクスペリエンスで、次の操作を行います。
   ...
   1. 「**保存**」をクリックします。
   1. （任意） **タスクを編集** ボックスの下部にある「**古いエクスペリエンスに戻る** をクリックします。

1. （条件付き）古いエクスペリエンスで、次の操作を行います。
