...
1. 「**タスクをコピー**」をクリックします。
   ...
   リストで複数のタスクを選択する場合は、「**タスクをコピー**」をクリックします。
コピーされたタスクは、指定されたプロジェクト上にあり、選択した親タスクのサブタスクか、プロジェクトの最後のタスクです。
