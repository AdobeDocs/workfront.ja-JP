...
プロジェクトのタスクの予定完了日は、プロジェクトが開始日からスケジュールされている場合に、プロジェクトの予定完了日を決定します。 プロジェクトの予定完了日について詳しくは、[ プロジェクトの予定完了日の設定](../../../manage-work/projects/planning-a-project/project-planned-completion-date.md)を参照してください。

>[!NOTE]
>
>タスクの予定完了日は、次の点で、タスクのコミット日またはタスクの見込み完了日と異なります。
>
>* コミット日とは、タスクに割り当てられたユーザーが手動でタスクを完了したことを見積もる日付です。 詳しくは、次の記事を参照してください。
>
...
Workfrontの次の領域で、予定完了日を手動で設定できます。

* タスクを作成または編集する場合は、「タスクを編集」ボックスを選択します。 詳しくは、[タスクを編集](../../../manage-work/tasks/manage-tasks/edit-tasks.md)を参照してください。
* 「タスクの詳細」領域の 詳細については、[タスクの詳細の概要領域でタスク情報を管理](../../../manage-work/tasks/manage-tasks/task-information-in-overview.md)を参照してください。
* 概要パネルでタスクを表示する際に「予定完了日」が表示される場合は、ホーム領域で表示されます。 詳しくは、[ホーム領域の作業項目の更新または編集](../../../workfront-basics/using-home/using-the-home-area/update-and-edit-work-item-home.md)を参照してください。
...
次のいずれかのタスク制約を選択すると、予定完了日を手動で指定できます。
...
* タスクのプライマリ担当者の休暇スケジュール。
  ...
  プライマリ担当者がタスクの期間中に休暇を取る場合、「**ユーザーの休暇**」フィールドで&#x200B;**タスク期間にユーザーの休暇を考慮**&#x200B;の設定が選択されていると、タスクの予定日がそれに応じて調整されます。 新しいプロジェクトでは、プロジェクト環境設定エリアからこの設定を継承しますが、この設定はプロジェクトレベルで編集できます。
...
>[!NOTE]
>
> プロジェクトの更新タイプは、予定時間数と期間を自動的に調整するために、「自動」および「変更時」または「自動」に設定する必要があります。\
