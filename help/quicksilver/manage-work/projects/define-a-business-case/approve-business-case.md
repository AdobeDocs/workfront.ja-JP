...
* ビジネスケースの承認を待っているプロジェクトは、ホームのマイ承認ウィジェットで表示されません。
...
1. **この列に表示** フィールドに&#x200B;*ステータス*&#x200B;と入力し始め、このフィールドがリストに表示されたら選択します。

   この列には、プロジェクトのステータスが表示されます。

1. レポートの「**フィルター**」タブを選択し、**フィルタールールを追加**&#x200B;をクリックします。

1. 「**Only show me Projects in which the ...**」フィールドに「*Status*」と入力し、リストに表示されたら選択します。
