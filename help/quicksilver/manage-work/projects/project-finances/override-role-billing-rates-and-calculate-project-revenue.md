...
* Workfrontの管理者は、場所と日付に基づいて、役割ごとに複数の請求率を持つレートカードを定義できます。 レートカードをプロジェクトに添付すると、すべての役割（場所、場所を使用している場合は場所別）と関連する請求率が、プロジェクトの請求率セクションに追加されます。 レートカードを添付すると、プロジェクト上の既存の請求率が上書きされます。

  詳しくは、 [レートカードの管理](/help/quicksilver/administration-and-setup/set-up-workfront/configure-system-defaults/manage-rate-cards.md) および [プロジェクトへの料金カードの添付](/help/quicksilver/manage-work/projects/project-finances/attach-rate-card-to-project.md).
...
<span class="preview">また、レートカードをプロジェクトに添付し、レートカードからプロジェクトにジョブロールの請求率をインポートすることもできます。</span>
...
プロジェクトの売上高の計算に使用されるジョブの役割の詳細については、「ユーザーと役割の割り当てに基づくタスクの収益計算」の節を参照してください。 [請求と売上高の概要](../../../manage-work/projects/project-finances/billing-and-revenue-overview.md). <span class="preview">レートカードをプロジェクトに取り付ける方法については、 [プロジェクトへの料金カードの添付](/help/quicksilver/manage-work/projects/project-finances/attach-rate-card-to-project.md).</span>
...
請求率は、 **請求率** 領域をそれぞれの役割別に表示します。 <span class="preview">レートカードがプロジェクトに添付されている場合、ジョブの役割もレートカードでグループ化されます。 場所がジョブの役割に適用されている場合は、場所名がジョブの役割名の一部として含まれます。 複数の場所に同じ役割を割り当てることができます。</span>
...
>[!NOTE]
>
><span class="preview">レートカードがプロジェクトに添付されると、 **会社の請求率** は請求率にインポートされません。 計算は、役割のレート・カード・レートまたは会社レートに基づいて行われます。</span>
>
