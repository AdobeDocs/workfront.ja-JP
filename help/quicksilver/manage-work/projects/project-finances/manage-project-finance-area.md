...
description: プロジェクトの財務情報を表示または編集するには、プロジェクトの詳細セクションの財務エリアにアクセスします。
author: Lisa
...
1. 詳細セクションの右上隅にある&#x200B;**編集** アイコン ![編集アイコン &#x200B;](assets/edit-icon.png)をクリックし、**財務**&#x200B;をクリックします。
   ...
   ![詳細ビューの財務領域](assets/finance-area-in-details-view.png)
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      ...
      <td> <p>これらは、特定の時点でのプロジェクトのパフォーマンスを示すプロジェクトパフォーマンス指標です。 それらの値は、パフォーマンス インデックス メソッドに基づいて計算されます。<br>詳細については、次の記事を参照してください。 </p> 
       <ul> 
     ...
     <tr> 
      ...
      <td> プロジェクトの予測される総コスト（PIMが時間ベースの場合は時間ベースで、PIMがコスト ベースの場合は通貨値で表されます）。<br>完了時の見積もりの計算について詳しくは、<a href="../../../manage-work/projects/project-finances/calculate-eac.md" class="MCXref xref">完了時の見積もりの計算（EAC） </a>を参照してください。</td> 
     </tr> 
     <tr> 
...
プロジェクト所有者は、プロジェクトの「財務」領域で情報を編集できます。

プロジェクト財務領域で情報を編集するには：
