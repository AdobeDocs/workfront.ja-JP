...
>[!NOTE]
>
>この記事に示すレート階層は、ユーザーと役割の時間収益またはコストタイプがタスクに適用されている場合にのみ使用されます。
...
## 階層とユーザーおよび役割の時間単位の収益タイプの例外

* 会社レートは、階層内ではサポートされていません。
* プライマリロールのみが階層の計算に使用されます。 その他の役割は使用されません。
* タスクの収益タイプがユーザーおよび役割の時間単位である場合、タスクに時間を記録したユーザーは、そのタスクから割り当てを解除できません。
