...
<tbody> 
  ...
  <tr> 
   <td> <p><span class="preview">ユーザーと役割 (毎時)</span></p> </td> 
   <td> <p><span class="preview"><strong>予定コスト</strong>は次の数式で計算されます。</span></p> <p><span class="preview"><code style="font-style: normal;">Task Planned Cost = Task Planned Labor Cost + Task Planned Expense Cost</code> </span></p> <p><span class="preview">予定労力コストは次の方法で計算されます。</span></p> <p><span class="preview"><code>Planned Labor Cost = Planned Hours * Cost per Hour Rate according to the hierarchy</code> </span></p> <p><span class="preview"><strong>実際のコスト</strong>は次の数式で計算されます。</span></p> <p><span class="preview"><code style="font-style: normal;">Task Actual Cost = Task Actual Labor Cost + Task Actual Expense Cost</code> </span></p> <p><span class="preview">タスクの実際の労力コストは次のように計算されます。</span></p> <p><span class="preview"><code>Task Actual Labor Cost = Actual Hours * Cost per Hour Rate according to the hierarchy</code> </span></p> </td> 
  </tr> 
  <tr> 
   <td> <p>固定 (毎時)</p> </td> 
