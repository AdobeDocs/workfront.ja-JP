   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      ...
      <td><p>プロジェクトがユーザーと共有されている場合、ユーザーにそのプロジェクトで持たせたいアクセスオプションを選択します。ユーザーが<strong>閲覧者</strong>、<strong>参加者</strong>、または<strong>管理者</strong>に指定されている場合は、プロジェクトを共有する際に、そのユーザーのアクセスに使用する特定のオプションを選択します。 </p><p><strong> 管理 </strong> 権限レベルの <strong> 削除 </strong> アクセス権によって、ユーザーがプロジェクト自体を削除できるかどうかが決まります。 プロジェクトへの <strong> 管理 </strong> アクセス権を持つユーザーは、タスクとイシューに対する <strong> 管理 </strong> 権限を持っている場合、このオプションが選択されているかどうかに関係なく、プロジェクト内のタスクとイシューを削除できます。 </p></td> 
     </tr> 
    </tbody> 
   </table>
