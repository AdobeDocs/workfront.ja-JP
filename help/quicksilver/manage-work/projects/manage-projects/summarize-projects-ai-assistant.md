...
title: AI アシスタントでプロジェクトを要約する
description: プロジェクトヘッダーには、AI アシスタントを使用してプロジェクトを要約するボタンが含まれています。
author: Becky
...
# AI アシスタントでプロジェクトを要約する

WorkfrontのAI アシスタントを使用すれば、プロジェクトを概要化し、プロジェクトの目的や状況などのプロジェクト情報をすばやく把握できます。完了したタスクや保留中のタスクの例、追加の詳細やメモなど、プロジェクトに関する基本的な情報を確認できます。

「プロジェクトの概要」ボタンを使用して要約を生成したり、AI アシスタントにプロンプトを入力したりできます。
...
## 「プロジェクトの概要」ボタンを使用して要約する

1. 要約する更新ストリームに移動します。
1. 「**プロジェクトの概要**」ボタンをクリックします。

   AI アシスタントが開き、プロジェクトを要約するためのプロンプトが表示されます。
