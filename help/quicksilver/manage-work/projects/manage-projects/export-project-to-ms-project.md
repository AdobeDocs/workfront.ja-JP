...
1. 書き出すプロジェクトに移動し、プロジェクト名の右側にある&#x200B;**詳細** アイコン ![詳細メニュー](assets/qs-more-menu.png)をクリックします
   ...
   プロジェクトのリストまたはレポートに移動してプロジェクトを選択し、リストの上部にあるその他のアイコン ![詳細メニュー](assets/qs-more-menu.png)をクリックします。

   ![その他のメニューが展開されました](assets/more-menu-expanded-in-a-list-one-project-selected-nwe.png)
