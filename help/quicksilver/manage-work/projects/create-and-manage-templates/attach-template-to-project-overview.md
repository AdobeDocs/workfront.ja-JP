...
* プロジェクトのステータスが「完了」、「停止」、または「承認待ち」の場合、Adobe Workfront管理者またはグループ管理者がプロジェクトの環境設定エリアでこの機能を有効にしている場合にのみ、テンプレートをプロジェクトに添付できます。 プロジェクトの環境設定について詳しくは、[システム全体のプロジェクト環境設定の指定](../../../administration-and-setup/set-up-workfront/configure-system-defaults/set-project-preferences.md)を参照してください。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td>財務情報</td> 
   <td> <p>これを添付プロセスで選択すると、次のフィールドがプロジェクトに転送または追加されます。 </p> 
    <ul> 
