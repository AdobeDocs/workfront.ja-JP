...
* テンプレートタスクは、Adobe Workfront Web アプリケーションの次の領域にコピーできます。

   * テンプレートタスクレベルで、 **その他のアイコン** ![](assets/more-icon.png) をクリックします。

   * テンプレートタスクリスト内。
* テンプレートタスクは、一度に 1 つずつコピーまたは移動するか、複数のテンプレートタスクを選択して移動できます。
...
1. （条件付き） **詳細** メニュー ![](assets/more-icon.png) タスクを開いた場合は、テンプレートタスクリストの上部、またはテンプレートタスク名の右側にあるをクリックし、 **コピー先** または **コピー**（「コピー」オプションにアクセスする元の場所に応じて）
...
1. クリック **オプション** 左のパネルで、テンプレートタスクと共にコピーしないテンプレートタスク属性の選択を解除します。 デフォルトでは、すべてのオプションが選択されています。
   ...
   <tr> 
      ...
      <td> <p>つまり、依存関係はコピーされたテンプレートタスクに引き継がれません。 </p> <p>選択すると、コピーされたテンプレートタスクのグループ内の先行タスクが保持され、その他は削除されます。</p> </td> 
     </tr>
     <tr> 
...
( 最後の行について尋ねる場合：テンプレートタスクに「共有」がないようです )
...
テンプレートタスクのコピーに加えて、同じテンプレート内の別のテンプレートタスク、または別のテンプレートにテンプレートタスクを移動することもできます。
...
1. 次のいずれかの操作を行います。
   * テンプレートタスクの名前をクリックして開きます。
   * リストから 1 つまたは複数のテンプレートタスクを選択します。
1. （条件付き） **詳細** メニュー ![](assets/more-icon.png) タスクを開いた場合は、テンプレートタスクリストの上部、またはテンプレートタスク名の右側にあるをクリックし、 **移動先** または **移動**（「移動」オプションにアクセスする場所に応じて）
...
1. クリック **オプション** 左のパネルで、テンプレートタスクと共にコピーしないテンプレートタスク属性の選択を解除します。 デフォルトでは、すべてのオプションが選択されています。
   ...
   <tr> 
      <td role="rowheader">すべての先行タスク</td> 
      <td> <p>つまり、依存関係は、移動されたテンプレートタスクでは継承されません。 </p> <p>選択すると、移動したテンプレートタスクのグループ内の先行タスクが保持され、その他は削除されます。</p> </td> 
     </tr>
     <tr> 
      <td role="rowheader">カスタムデータ</td> 
