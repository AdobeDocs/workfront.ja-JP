...
1. プロジェクトに関する情報の追加。
   ...
   >[!TIP]
   >
   >プロジェクトのステータスは、計画中か、現在ではない別のステータスにする必要があります。 これにより、プロジェクト参加者に通知を生成せずに、プロジェクトに変更を加えることができます。

1. 「**保存**」をクリックして変更を保存します。

1. （任意）プロジェクト設定を指定し、タスクを追加したら、プロジェクトのヘッダーで、プロジェクトのステータスを **現在** に変更できます。
