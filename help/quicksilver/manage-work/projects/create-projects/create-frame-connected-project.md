...
プロジェクトを作成し、クリエイティブが完了したアセットをアップロードした後、Workfrontでそのアセットにレビューと承認のワークフローを割り当てることができます。 詳しくは、[&#x200B; ドキュメント承認ワークフローの作成 &#x200B;](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/manage-document-approvals/create-a-document-approval.md) を参照してください <!-- name may need to change -->。
