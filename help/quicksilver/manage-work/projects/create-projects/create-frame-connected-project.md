...
上記の前提条件について詳しくは、[ との統合の設定  [!DNL Workfront]  を参照  [!DNL Frame.io]  てください ](/help/quicksilver/administration-and-setup/configure-integrations/configure-wf-and-frame.md)。
