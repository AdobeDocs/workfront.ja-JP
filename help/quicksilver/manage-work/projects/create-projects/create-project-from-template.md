...
1. **お気に入りのテンプレート**&#x200B;リストでテンプレート名をクリックします。
   ...
   1. 次のいずれかの種類のテンプレートの名前をクリックして選択します。
      ...
      * Adobe-storage テンプレート
        ...
        テンプレートと今後のプロジェクトに関するドキュメントは、Adobe エンタープライズストレージに保存されます。

      >[!NOTE]
      >
      >* Adobe エンタープライズ版ストレージテンプレートを使用すると、Adobe エンタープライズ版ストレージプロジェクトが作成されます。
      >
      >* Workfront-storage テンプレートを使用すると、Workfront-storage プロジェクトが作成されます。
      >
...
1. 「**プロジェクトを作成**」をクリックします。
   ...
   プロジェクトと同じ名前のドキュメントフォルダーが、プロジェクトの「ドキュメント」セクションにAdobe ストレージプロジェクト用に自動的に作成されます。
