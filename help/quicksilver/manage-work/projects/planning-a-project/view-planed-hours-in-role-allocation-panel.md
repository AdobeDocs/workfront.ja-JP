...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <p>シナリオプランナーへのアクセスを編集して、イニシアチブの時間を更新する</p>
   </td> 
  </tr> 
  <tr> 
...
1. **役割の割り当て** パネルで、次の情報を確認します。
   ...
   | フィールド | 説明 |
   |---|---|
   | **担当業務** | プロジェクトのタスクとイシューに割り当てられたジョブロール。 これには、タスクやイシューに直接割り当てられたジョブロール、またはプロジェクトのタスクやイシューに割り当てられたユーザーに関連付けられたジョブロールが含まれます。 |
   | **予定時間数** | プロジェクトの担当業務または担当業務に関連付けられているユーザーに割り当てられたタスクとイシューからの予定時間数の合計数。 |
