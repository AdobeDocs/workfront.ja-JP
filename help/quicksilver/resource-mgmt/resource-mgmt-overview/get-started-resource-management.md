...
* リソースを実際の作業（タスクとイシュー）にスケジュールする、または割り当てるには、以下のツールを使用します。
  ...
  * **ワークロードバランサー**：リソース管理の下位レベルの段階に属しており、完了するために必要な時間数とリソースの空き時間に基づいて、完了する必要がある実際の作業（タスクとイシュー）にリソースを割り当てることができます。 ワークロードバランサーを使用すると、現在割り当てられていない、または担当業務に割り当てられている実際の作業に、ユーザーまたは作業担当者を割り当てることができます。
