...
* カスタムタブにリンクを埋め込んで、メインメニューにリソーシング機能がないユーザーと共有します。 詳しくは、[リンクによるワークロードバランサーの共有](../../resource-mgmt/workload-balancer/share-link-for-workload-balancer.md)を参照してください。
...
* タスクとイシューの予定時間の値が0より大きい。
* タスクとイシューの期間の値が0より大きい。
