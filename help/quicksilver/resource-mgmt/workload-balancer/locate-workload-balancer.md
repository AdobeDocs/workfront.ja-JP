...
この記事では、ワークロード・バランサにアクセスできる領域について説明します。

>[!NOTE]
>
>ワークロード・バランサにアクセスする方法に関係なく、ナビゲーションし、リソースを管理する方法は同じです。
>
...
1. 次をクリック： **メインメニュー** アイコン ![](assets/main-menu-icon.png)を選択し、「 **リソース**.
1. クリック **ワークロードバランサー** をクリックします。

   ![](assets/nwe-balancer-global.png)

   ワークロード・バランサには、デフォルトで、リソース領域に次の情報が表示されます。
...
ホームチームのページが表示されます。
   ...
   * **割り当てられた作業**:チームのすべてのメンバーとすべての割り当て。
