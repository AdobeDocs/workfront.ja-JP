...
1. （条件付き）未割り当て作業&#x200B;**または**&#x200B;割り当て済み作業&#x200B;**領域の右上隅にある** フィルター&#x200B;**アイコン ![&#x200B; フィルターアイコン &#x200B;](assets/filter-icon.png)にマウスを合わせると、現在適用されているフィルターの名前または数を含むツールチップが表示されます。**
...
1. 「**複製**」をクリックします。
   ...
   >[!TIP]
   >
   > フィルターの編集中に、**フィルターを編集** ボックスの左下隅にある&#x200B;**詳細** メニュー![詳細メニュー](assets/more-menu-edit-filter.png)をクリックし、**複製**&#x200B;をクリックできます。
...
1. フィルターにマウスポインターを合わせ、**詳細** メニュー![詳細メニュー](assets/more-menu-edit-filter.png)をクリックし、**削除**&#x200B;をクリックします。
   ...
   >[!TIP]
   >
   >フィルターの編集中に、**フィルターを編集** ボックスの左下隅にある&#x200B;**詳細** メニュー![詳細メニュー](assets/more-menu-edit-filter.png)をクリックし、**削除**&#x200B;をクリックできます。
...
1. 「**共有**」をクリックします。 **フィルター共有** ボックスが表示されます。
   ...
   >[!TIP]
   >
   > フィルターの編集中に、**フィルターを編集** ボックスの左下隅にある&#x200B;**詳細** メニュー![詳細メニュー](assets/more-menu-edit-filter.png)をクリックし、**共有**&#x200B;をクリックできます。
