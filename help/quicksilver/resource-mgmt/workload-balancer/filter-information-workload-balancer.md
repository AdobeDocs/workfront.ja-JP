...
* **未割り当て作業領域**：まだユーザーに割り当てられていない作業項目です。
* **割り当て済み作業領域**：ユーザーに割り当てられた作業項目です。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>任意のチームのメンバーおよびその作業項目のユーザー。 </td> 
  </tr> 
  <tr> 
...
1. 次をクリック： **フィルター** アイコン ![](assets/filter-icon.png) の右上隅に **未割り当ての作業** または **割り当てられた作業** 領域。
   ...
   右側にフィルタービルダーボックスが表示されます。 フィルターを作成する領域の名前が、ボックスのヘッダーに表示されます。
...
1. フィルターを作成するには、次の手順を実行します。
   ...
   1. （条件付き）クリックした場合 **フィールドを参照**&#x200B;に値を入力する場合は、 **検索** フィールドを選択し、リストに表示される場合に選択します。
   ...
   1. フィルターを適用するフィールドの値を選択または入力します。
      ...
      >[!NOTE]
      >
      > 特定のポートフォリオの作業オブジェクトを表示する場合は、「Portfolio名にマーケティングを含む」というフィルターを適用できます。 名前に「マーケティング」が含まれる任意のポートフォリオに属する作業項目が表示されます。
      >
...
1. クリック **適用** をクリックします。この場合、選択したワークロード・バランサ・エリアにフィルタの結果を保存せずに適用します。
   ...
   The **適用** ボタンが **新規として保存** 」ボタンをクリックします。
...
1. 「**保存**」をクリックします。
   ...
   保存済みフィルターの適用について詳しくは、 [ワークロードバランサーで保存済みフィルターを削除する](#delete-a-saved-filter-in-the-workload-balancer) 」を参照してください。
...
1. 既存のフィルターの上にマウスを移動し、 **その他** メニュー ![](assets/more-menu.png)を選択し、次に **複製**.

   ![](assets/filter-more-menu-options-wb.png)

   >[!TIP]
   >
   > フィルターの編集中に、 **その他** メニューをクリックし、 **複製**.
...
1. 次をクリック： **フィルターアイコン** ![](assets/filter-icon.png) の右上隅に **未設定** または **割り当てられた作業** 領域。\
   右側にフィルタービルダーが表示されます。

1. 編集するフィルターの上にマウスを移動して、 **編集** ![](assets/wb-edit-filter-icon.png).
...
## ワークロードバランサーで保存済みフィルターを削除する {#delete-a-saved-filter-in-the-workload-balancer}
...
1. フィルターの上にマウスを移動して、 **その他** メニュー ![](assets/more-menu.png)を選択し、次に **削除**.
   ![](assets/filter-more-menu-options-wb.png)

   >[!TIP]
   >
   >フィルターの編集中に、 **その他** メニューをクリックし、 **削除**.
...
1. フィルターの上にマウスを移動して、 **その他** メニュー ![](assets/more-menu.png)を選択し、次に **共有。**

   ![](assets/filter-more-menu-options-wb.png)

   >[!TIP]
   >
   > フィルターの編集中に、 **その他** メニューをクリックし、 **共有**.
...
1. （オプション）フィルターに対する権限を編集するエンティティの名前の横にある右向き矢印をクリックし、 **表示** または **管理** オプション。
