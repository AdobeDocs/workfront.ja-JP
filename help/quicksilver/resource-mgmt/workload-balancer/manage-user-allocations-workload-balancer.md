...
>[!CAUTION]
>
>ワークロードバランサーには、1 作業項目あたり最大 1000 時間の計画時間と、1 項目の期間の最大 1000 日間のみが表示されます。1000 時間または 1000 日の制限に達した後、ワークロードバランサーの割り当ては 0 と表示されます。タスクを小さなサブタスクに分割して、より多くの予定時間や 1000 日を超える期間に対応できるようにすることをお勧めします。
