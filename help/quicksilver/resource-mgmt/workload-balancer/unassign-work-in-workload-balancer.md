...
Adobe Workfront Workload Balancerの「割り当て済み作業」エリアの作業項目からユーザーを割り当て解除したり、他のユーザー、作業担当者、役割、チームにユーザーを割り当て直したりできます。
...
ユーザーから項目の割り当てを解除して未割り当て作業領域に移動するか、他のユーザーまたは作業担当者に再割り当てできます。
