...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td>アクセスレベル設定</td> 
   <td> <p>リソース管理、プロジェクト、ユーザーへの表示またはそれ以上のアクセス権限</p> <p>「原価率の表示」および「一般財務の表示」へのアクセスを含む財務データへのアクセスを表示して、原価情報を表示します</p></td> 
  </tr> 
  <tr> 
   <td>オブジェクト権限</td> 
...
1. （オプション）情報の表示を **FTE** 別にするか&#x200B;**時間**&#x200B;別にするかを選択します。\
   ![FTEまたは時間を選択](assets/rp-hours-or-fte-in-user-view.png)
