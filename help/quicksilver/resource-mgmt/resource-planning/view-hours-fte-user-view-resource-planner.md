...
title: ユーザービューを使用する場合、リソースプランナーで利用可能、計画、実際の時間またはFTEを表示します
description: RPでユーザーviewPlanningを使用する場合に、リソースプランナーで利用可能、計画、および実際の時間またはFTEを表示します。例えば、「RPのリソースの予算化」または「RPのリソースの管理」などです。 他のPOV?！から転用する必要がある場合がある。
author: LIsa
