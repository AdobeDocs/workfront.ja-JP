...
![この役割を持つユーザーはありません](assets/no-users-with-this-role-in-the-res-pool-350x57.png)
...
* コスト別にリソースの予算を計上したい場合は、担当業務をコスト/時間レートに に関連付ける必要がある。 リソースプール内のユーザーに割り当てられた担当業務に関連付けられたコストは、プロジェクトの予算計上労力コストと予算計上コストの計算に使用されます。\
...
![管理設定](assets/resource-management-preferences-section-in-setup-350x89.png)
