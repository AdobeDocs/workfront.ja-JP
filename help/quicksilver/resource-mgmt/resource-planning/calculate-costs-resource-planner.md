...
Adobe Workfront リソースプランナーでリソースを予算計上するには、時間や FTE 値の代わりにコストの値を使用します。 リソース プランナーの&#x200B;**ユーザー別ビュー** ビューでは、コスト値を使用できません。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td>アクセスレベル設定</td> 
   <td> <p>リソースプランナーの優先度と予算計上時間数の編集へのアクセスを含むリソース管理へのアクセスを編集</p> <p>コスト率の編集および一般財務の編集へのアクセスを含む財務データへのアクセスを編集します</p>
   <p>プロジェクトおよびユーザーへの編集アクセス権</p></td> 
  </tr> 
  <tr> 
   <td>オブジェクト権限</td> 
   <td> <p>コスト率を編集し、一般的な財務を編集する機能を使用して、情報を予算するプロジェクトに対する権限を管理します</p></td>
  </tr> 
 </tbody> 
</table>
