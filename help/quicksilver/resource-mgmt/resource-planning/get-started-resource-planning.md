...
title: リソース計画の概要
description: リソース計画ツールを使用して、ジョブの役割、使用可否、およびこの可用性に基づくプロジェクトへの一般的な割り当てを管理できます。
author: Alina
...
Adobe Workfrontのリソース管理ツールを使用してリソースの配分を予測し、プロジェクトが予定どおりに配信されたか予算通りに配信されたかを正確に把握できます。 Workfrontのリソース管理の概要については、 [リソース管理の概要](../../resource-mgmt/resource-mgmt-overview/get-started-resource-management.md).

リソース計画ツールを使用して、ジョブの役割、使用可否、およびこの可用性に基づくプロジェクトへの一般的な割り当てを管理できます。

プロジェクトへのユーザーの一般的な割り当てを予算設定しても、実際の作業（タスクと問題）には割り当てられません。 ワークロードバランサーを使用して、作業するリソースを割り当てる必要があります。
