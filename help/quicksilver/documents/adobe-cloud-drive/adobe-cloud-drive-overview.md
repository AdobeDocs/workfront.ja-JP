...
title: Adobe Cloud Driveの概要
description: Adobe Cloud Driveは、Adobe クラウドストレージプロジェクトをMacまたはWindows コンピューターのドライブとしてマウントするデスクトップアプリケーションです。そのため、Finderまたはファイルエクスプローラーで直接Workfront ファイルを操作できます。
author: Courtney
...
[Adobe Cloud Driveで利用できる機能の概要を動画でご確認ください。](https://video.tv.adobe.com/v/3492492){target="_blank"}

Adobe Cloud Driveが接続するストレージについて詳しくは、[Adobe クラウドストレージの概要](/help/quicksilver/review-and-approve-work/esm-overview.md)を参照してください。
...
Adobe クラウドストレージを使用しているプロジェクトのみがドライブに表示されます。 従来のWorkfront プロジェクトが表示されない。 違いについて詳しくは、[Adobe クラウドストレージと従来のWorkfront ストレージの違いを参照してください](/help/quicksilver/review-and-approve-work/esm-overview.md#differences-between-adobe-cloud-storage-and-legacy-workfront-storage)。
