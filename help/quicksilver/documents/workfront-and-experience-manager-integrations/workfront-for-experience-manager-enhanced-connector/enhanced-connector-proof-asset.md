...
title: リンクされたアセットの強化されたコネクタによる配達確認
description: Experience Manager Assetsからアセットをリンクしたら、配達確認を作成し、そのアセットに対するレビューおよびコメントの追加をユーザーに割り当てることができます。
author: Courtney
...
# リンクされたアセットの強化されたコネクタによる配達確認

Experience Manager Assetsからアセットをリンクしたら、配達確認を作成し、そのアセットに対するレビューおよびコメントの追加をユーザーに割り当てることができます。 リンクされたアセットから作成された配達確認は、配達確認ストレージの割り当てにカウントされます。
