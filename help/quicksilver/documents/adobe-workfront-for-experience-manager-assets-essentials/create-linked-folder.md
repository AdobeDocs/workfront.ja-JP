...
>組織でエンタープライズストレージを使用している場合、Workfrontでドキュメントにアクセスすると、新しい「ドキュメント」領域が表示されます。 そこから、Experience Manager AssetsまたはAssets Essentialsからアセットを追加できますが、リンクされたフォルダーを作成することはできません。
