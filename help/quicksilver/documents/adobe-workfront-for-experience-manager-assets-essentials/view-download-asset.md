...
title: Experience Manager Assets や Assets Essentials からリンクされたアセットを表示またはダウンロード
description: Experience Manager Assets や Assets Essentials からリンクされているアセットを Adobe Workfront で表示またはダウンロードできます。
author: Courtney
...
1. 右側のドキュメントの概要で、上部のサムネールにポインタを合わせて、「**プレビュー**」または「**ダウンロード**」を選択します。
   ...
   ![ プレビューまたはダウンロード ](assets/preview-or-download-350x107.png)
