...
title: Experience Manager Assets Essentials用Adobe Workfront：記事インデックス
description: Adobe Workfront for Experience Manager Assets Essentialsの記事インデックス
author: Courtney
...
* [Experience Manager Assets または Assets Essentials にリンクされたフォルダーの作成](/help/quicksilver/documents/adobe-workfront-for-experience-manager-assets-essentials/create-linked-folder.md)
...
* [Workfront Fusion を使用して、Workfront イシューを Adobe Experience Manager のワークフローを含むプロジェクトに変換](/help/quicksilver/documents/adobe-workfront-for-experience-manager-assets-essentials/use-fusion-to-create-project-with-workflows.md)
