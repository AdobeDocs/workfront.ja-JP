...
title: ドキュメントの移動
description: ドキュメントに対する管理権限を持つユーザーは、ドキュメントを別のオブジェクトに移動できます。
author: Courtney
...
ドキュメントに対する管理権限を持つユーザーは、ドキュメントを別のオブジェクトに移動できます。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>ドキュメントへのアクセス権を管理</p> <p>新しいオブジェクトにドキュメントを追加する権限</p></td> 
  </tr> 
 </tbody> 
</table>
...
1. テキストボックスに「**イシュー**」、「**プロジェクト**」、または「**タスク**」の名前を入力します。
   ...
   >[!NOTE]
   >
   >従来のWorkfront ストレージを使用して、別のプロジェクト、タスク、または問題にのみ移動できます。
...
1. 表示されるボックスのドロップダウンメニューから、**問題**、**プロジェクト**&#x200B;または&#x200B;**タスク**&#x200B;をクリックして、文書を移動するオブジェクトのタイプを指定します。

1. テキストボックスに「**イシュー**」、「**プロジェクト**」、または「**タスク**」の名前を入力します。

   >[!NOTE]
   >
   >エンタープライズストレージを使用して、別のプロジェクト、タスク、イシューにのみ移動できます。
