...
title: ドキュメントの新しいバージョンをアップロードする
description: 以前に Adobe Workfront にアップロードしたドキュメントの新しいバージョンを追加できます。
author: Courtney
...
## 「新規ドキュメント」領域に新しいドキュメントバージョンをアップロードします
...
1. ドキュメントがアップロードされるドキュメントエリアに移動します。
1. Workfrontで、ドキュメントの新しいバージョンを既存のバージョンの上にドラッグします。

   ![&#x200B; ドキュメントバージョンをドラッグ&amp;ドロップ &#x200B;](assets/drag-drop-new-doc.png)
