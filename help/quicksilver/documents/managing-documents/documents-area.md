...
新しいドキュメント領域は、組織がエンタープライズストレージ上にある場合にのみ使用できます。 エンタープライズストレージについて詳しくは、[Adobe エンタープライズストレージの概要](/help/quicksilver/review-and-approve-work/esm-overview.md)を参照してください。
