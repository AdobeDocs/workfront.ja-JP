...
1. ドキュメントを含むプロジェクト、タスクまたはイシューに移動し、「**ドキュメント**」を選択します。
1. 必要なドキュメントを選択します。
1. 右側の **詳細** セクションで、「編集 **をクリックし** す。
   ![ 詳細セクションの編集ボタン ](assets/edit-custom-form.png)
1. 「**カスタムForms**」フィールドで、入力を開始し、カスタムフォームを選択します。
1. 「**保存**」をクリックします。カスタムフォームが詳細セクションに表示されます。


## 新しいドキュメント領域でのカスタムフォームの編集

1. ドキュメントを含むプロジェクト、タスクまたはイシューに移動し、「**ドキュメント**」を選択します。
1. 必要なドキュメントを選択します。
1. 右側の **詳細** セクションで、「編集 **をクリックし** す。
   ![ 詳細セクションの編集ボタン ](assets/edit-custom-form.png)
1. [**カスタム Forms**] セクションで、編集するフォームを検索します。
1. 必要な変更を加え、「**保存**」をクリックします。
