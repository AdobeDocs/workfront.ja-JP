...
* Adobe Creative Cloud アプリケーションからメインメニュー ![メインメニューアイコン](assets/main-menu-icon.png) でドキュメントエリアにドキュメントを書き出すことはできません。
...
1. パネルの右上隅にある、**その他**&#x200B;メニュー ![その他メニュー](assets/more-menu.png) をクリックします。
