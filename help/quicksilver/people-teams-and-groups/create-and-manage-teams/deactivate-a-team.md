...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   <td> 
    <ul> 
     <li> <p>カスタムフォームの内部参照または先行入力フィールド</p> </li> 
    </ul> 
    <ul> 
...
* [!DNL Workfront Goals] の所有者フィールド これには、追加の [!DNL Adobe Workfront Goals] ライセンスが必要です。 詳しくは、[概要 [!DNL Adobe Workfront Goals]](../../workfront-goals/goal-management/getting-started-with-wf-goals.md)を参照してください。
