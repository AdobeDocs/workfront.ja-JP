...
「[!UICONTROL 完了]」ボタンを使用すると、タスクまたはイシューのステータスを自動的に設定できます。 担当者が作業項目に「完了」をクリックすると、デフォルトで[!UICONTROL Adobe Workfront]はタスクを[!UICONTROL 完了]とマークします。
...
[!UICONTROL 完了] ボタンに関連付けられているステータスを含む、チームの設定が、これらのユーザーに表示されるようになりました。
