...
title: アジャイルバックログの管理
description: タスクやイシューは、チームが使用するアジャイル手法に応じて、ストーリーとしてアジャイルチームに割り当て、そのチームのバックログに追加することができます。
author: Courtney
feature: Agile
...
1. **[!UICONTROL ビュー]**&#x200B;ドロップダウンメニューで、**[!UICONTROL バックログ]**&#x200B;ビュー、または&#x200B;**[!UICONTROL 注文]**&#x200B;列を含むカスタムビューを選択します。
   ...
   >[!NOTE]
   >
   >タスクまたはイシューにアジャイルチームが割り当てられていて、プロジェクトが現在のステータスではない場合、バックログに表示されません。 ただし、注文列のバックログ数には影響します。
...
バックログから直接ストーリーを作成するか、既存のタスクやイシューをアジャイルチームに割り当てることで、バックログに新しいストーリーを作成できます。

* [バックログからストーリーを作成する](#create-a-story-from-the-backlog)
* [アジャイルチームへのタスクの割り当て](#assign-a-task-or-issue-to-an-agile-team)

### バックログからストーリーを作成する {#create-a-story-from-the-backlog}

バックログからストーリーを作成すると、そのストーリーはプロジェクト内のタスクまたはイシューとして作成されます。
...
タスクやイシューは、アジャイルチームに割り当てることができます。 割り当て後、タスクまたはイシューはチームバックログに新しいストーリーとして表示されます。

タスクやイシューをアジャイルチームに割り当てるには：
