...
title: かんばんの設定
description: チームの作成中または作成後に、カンバンアジャイルチームに対して次のオプションを設定できます。
author: Courtney
feature: Agile
...
[!DNL Adobe Workfront] アジャイルチームの作成[の説明に従って、](../../agile/get-started-with-agile-in-workfront/create-an-agile-team.md)でアジャイルチームを作成できます。 アジャイルチームを編成する際に、チームが作業を完了するために使用する手法を選択できます。 以下のオプションから選択できます。

* スクラム
* かんばん

この記事では、かんばんチームの設定を指定する方法について説明します。アジャイルチームを作成し、カンバン手法を選択した後、この記事を参照して次の設定を更新できます。
...
カンバンチームのWIP制限を設定した後、WIP制限を表示して、[!UICONTROL &#x200B; カンバン &#x200B;] アジャイルストーリーボードから更新できます。詳しくは、[&#x200B; カンバン [!UICONTROL &#x200B; ボード &#x200B;]の進行中の作業（WIP）制限の管理に関する説明を参照してください。](../../agile/use-kanban-in-an-agile-team/work-in-progress-limit-on-the-kanban-board.md)
