...
1. **[!UICONTROL その他]**&#x200B;メニュー![](assets/more-menu.png)をクリックして、「**[!UICONTROL 編集]**」を選択します。
   ...
   ![チームを編集](assets/edit-team-settings-kanban.png)
...
デフォルトでは、次の種類のデータがタスクとイシューのストーリーカードに表示されます。
...
1. 管理するかんばんチームを選択します。
1. **[!UICONTROL その他]**&#x200B;メニュー（![](assets/more-menu.png)）をクリックして、「**[!UICONTROL 編集]**」を選択します。
1. **[!UICONTROL 次のストーリーをバックログから自動的に追加]**&#x200B;を選択して、バックログから次のアイテムを設定し、アイテムが&#x200B;**[!UICONTROL 進行中]**&#x200B;列から移動されたときに&#x200B;**[!UICONTROL 新規]**&#x200B;列に自動的に追加されるようにします。
