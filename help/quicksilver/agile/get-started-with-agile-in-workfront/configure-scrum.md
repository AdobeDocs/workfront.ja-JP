...
この記事では、スクラムチームの設定を行う方法について説明します。アジャイルチームを作成し、スクラム手法を選択したら、この記事を参照して、次の設定を更新できます。

* ストーリーをポイント単位で見積もるか、時間単位で見積もるか
* 反復およびプロジェクト用のアジャイルストーリーボードのステータス列
* アジャイルストーリーボードのストーリーカードに表示する追加フィールド
* アジャイルストーリーボード上のストーリーに対するカラーインジケーターの使用方法
...
チームに割り当てられたすべての反復、または特定のプロジェクトについて、アジャイルストーリーボードに表示する列を設定できます。
...
## アジャイルストーリーボード上のストーリーに対するカラーインジケーターの使用方法を設定します

デフォルトでは、アジャイル反復のストーリーボードのタイルは、ストーリーが関連付けられているプロジェクトに従って色分けされます。 各プロジェクトのカラーは、ストーリーボード上で無作為に割り当てられます。このデフォルトの動作は、アジャイルチームごとに変更できます。 アジャイルストーリーの色は、ストーリーの優先度や所有者などに関連付けることができます。

アジャイルチームのストーリーに色を割り当てる方法の動作を変更するには：
