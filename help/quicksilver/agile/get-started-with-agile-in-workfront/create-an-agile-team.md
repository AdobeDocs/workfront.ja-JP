...
title: アジャイルチームの作成
description: Adobe Workfrontを使用すると、アジャイルチームは、増分的に整理された方法で作業を完了できます。
author: Jenny
feature: Agile
...
[!DNL Adobe Workfront] を使用すると、アジャイルチームは、増分的に整理された方法で作業を完了できます。

組織内のユーザーはアジャイルチームを表示し、バックログ、反復、ストーリーボード、個々のストーリーなど、チームのすべてのアジャイルコンポーネントを表示できます。 ただし、[!UICONTROL 編集]アクセス権があるチームのメンバーだけが、チームに割り当てられた作業を変更することができます。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>標準</p>
   <p>新しいアジャイルチームの作成を計画する</p>
  <p>チームをアジャイルチームに変換するために作業以上を行う</p> </td> 
  </tr> 
 </tbody> 
</table>
...
アジャイルチームには、スクラムまたはかんばんアジャイル手法を使用できます。 それぞれの方法論には様々なメリットがあります。アジャイルチームの働きによって、使用するアジャイル手法が決まります。

[!DNL Workfront] のスクラムとかんばんアジャイルの両方の手法を使用すると、ストーリーボード全体でストーリーを移動して、ステータスの変更とストーリーの進行状況を示すことができます。

[!DNL Workfront] のスクラムとかんばんアジャイルの手法は、次のように異なります。

### [!DNL Workfront] でかんばんを使用するメリット

[!DNL Kanban] の [!DNL Workfront] アジャイル方法論を使用すると、進行中の作業量を制限しながら、アジャイルストーリーボード全体でストーリーをより簡単に移動できます。 [!DNL Kanban] アジャイル手法を使用する場合、開始日と終了日はありません。
...
[!DNL Workfront] のスクラムアジャイル手法を使用すると、アジャイル反復に一連のストーリーを追加し、その反復のストーリーボードを作成できます。 イテレーションは、定義した開始日と終了日に基づくものです。
...
1. 次の情報を指定します。
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     <tr> 
      ...
      <td>新しいアジャイル チームの名前を入力します。</td> 
     </tr> 
     <tr> 
      <td role="rowheader"><strong>[!UICONTROL This is an Agile Team]</strong> </td> 
      <td>この新しいチームをアジャイル チームに構成するには、このオプションを選択します。</td> 
     </tr>
   ...
   <tr data-mc-conditions="QuicksilverOrClassic.Quicksilver"> 
     ...
     <tr> 
      ...
      <td>チームに参加するユーザーの名前の入力を開始し、ドロップダウンリストに表示されたら、名前を選択します。<br>複数のユーザーをチームに追加するには、このプロセスを繰り返します。<br> ユーザーは複数のチームに参加できるので、アジャイルチームとアジャイル以外のチームの両方に参加できます。</td> 
     </tr> 
     <tr> 
...
既存のチームをアジャイルチームに変換するには、次の手順を実行します。
...
1. 「**[!UICONTROL 手法]**」セクションで、チームが **[!UICONTROL スクラム]** または **[!UICONTROL かんばん]** アジャイル手法を使用するかどうかを選択します。
