...
[!DNL Adobe Workfront] には、アジャイルワークフローを定義するのに役立つツールがいくつか用意されています。 ボードは、チームの共同作業を目的としたシンプルながら柔軟なツールです。従来のアジャイル計画ツールには、かんばんチームやスクラムチーム向けのバックログとストーリーボードが含まれています。
