...
[!DNL Adobe Workfront]には、アジャイルワークフローの定義に役立つツールがいくつか用意されています。 ボードは、チームの共同作業を目的としたシンプルながら柔軟なツールです。従来のアジャイル計画ツールには、バックログや、カンバンやスクラムのチーム向けのストーリーボードが含まれています。
...
* [ [!DNL Adobe Workfront]でアジャイルを始める](../agile/get-started-with-agile-in-workfront/get-started-with-agile.md)
