...
1. フィルターアイコンをクリックします。 ![フィルター](assets/filter-icon-spectrum-25x25.png)、を展開します。 [!UICONTROL メンバー] 」セクションに移動し、表示する 1 人または複数のカードを持つユーザーを選択します。 未割り当てのカードを表示することもできます。
...
1. ボードにアクセスします。
1. フィルターアイコンをクリックします。 ![フィルター](assets/filter-icon-spectrum-25x25.png)、を展開します。 [!UICONTROL タグ] 」セクションで、表示するタグを選択します。
...
1. ボードにアクセスします。
1. フィルターアイコンをクリックします。 ![フィルター](assets/filter-icon-spectrum-25x25.png)、を展開します。 [!UICONTROL ステータス] 」セクションで、表示するステータスのタイプを選択します。
...
1. ボードにアクセスします。
1. フィルターアイコンをクリックします。 ![フィルター](assets/filter-icon-spectrum-25x25.png)、を展開します。 [!UICONTROL 期限] 」セクションで、表示する日付オプションを選択します。
...
1. ボードにアクセスします。
1. フィルターアイコンをクリックします。 ![フィルター](assets/filter-icon-spectrum-25x25.png)、を展開します。 [!UICONTROL 接続] セクションで、 [!DNL Workfront] 表示する接続済みカードのプロジェクトです。
...
1. ボードにアクセスします。
1. 検索アイコンをクリックします。 ![検索](assets/search-icon.png) 検索語句を入力します。 次に、Enter キーを押します。
