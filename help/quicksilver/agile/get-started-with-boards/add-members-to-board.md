...
title: ボードに対するメンバーの追加または削除
description: ユーザーがボードを表示してカードに割り当てられる前に、メンバーとしてボードに追加される必要があります。
author: Lisa
feature: Agile
...
1. 内 **[!UICONTROL メンバーを追加]** ボックスに名前を入力し、リストに表示されたら選択します。
   ...
   個々のメンバーまたはチームを選択できます。 チームを選択すると、チーム自体がボードに追加されます。 その後、個々のチームメンバーを使用してカードに割り当てることができます。

   >[!NOTE]
   >
   >個々のユーザーは、 **[!UICONTROL 表示]** または **[!UICONTROL 編集]** オプションがチームのアクセスレベルに設定されている場合は、ボードを表示できません。


   ![ボードにメンバーを追加](assets/boards-add-members.png)
